...
(function ($) {
  ...
  window.getUserInfo = function (uid) {
    return new Promise(function (resolve, reject) {
      if (getUserInfoCache && typeof getUserInfoCache[uid] !== "undefined") {
        ...
        $.get("/lms/panel/users/".concat(uid, "/getInfo"), function (result) {
  ...
  $('body').on('click', '#leave', function (e) {
    ...
    var path = '/lms/panel/sessions/' + sessionId + '/endAgora';
  ...
  $('body').on('click', '#handleUsersJoin', function (e) {
    ...
    $.get("/lms/panel/sessions/".concat(sessionId, "/toggleUsersJoinToAgora"), function (result) {
      if (result) {
        $.toast({
