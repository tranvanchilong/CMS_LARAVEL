(function ($) {
  ...
  * */
  ...
  window.loadingSwl = function () {
    var loadingHtml = '<div class="d-flex align-items-center justify-content-center my-50 "><img src="/assets/lms/assets/default/img/loading.gif" width="80" height="80"></div>';
    Swal.fire({
      html: loadingHtml,
