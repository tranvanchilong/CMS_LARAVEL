...
(function ($) {
  ...
  $('body').on('click', '#editEducationSwlModal #editEducation', function (e) {
    ...
    if (val !== '' && val !== null) {
      ...
      $.post('/lms/panel/setting/metas/' + education_id + '/update', data, function (result) {
  ...
  $('body').on('click', '#editExperienceSwlModal #editExperience', function (e) {
    ...
    if (val !== '' && val !== null) {
      ...
      $.post('/lms/panel/setting/metas/' + experience_id + '/update', data, function (result) {
        if (result && result.code == 200) {
          Swal.fire({
            icon: 'success',
            html: '<h3 class="font-20 text-center text-dark-blue py-25">' + saveSuccessLang + '</h3>',
  ...
  function submitMetas($this, $input, name) {
    ...
    if (val !== '' && val !== null) {
      ...
      $.post('/lms/panel/setting/metas', data, function (result) {
        if (result && result.code == 200) {
          Swal.fire({
            icon: 'success',
            html: '<h3 class="font-20 text-center text-dark-blue py-25">' + saveSuccessLang + '</h3>',
