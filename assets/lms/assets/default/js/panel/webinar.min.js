...
(function ($) {
  ...
  $('body').on('change', '#categories', function (e) {
    ...
    $.get('/lms/panel/filters/get-by-category-id/' + category_id, function (result) {
  ...
  * */
    ...
    Swal.fire({
      ...
      onOpen: function onOpen() {
        ...
        if (itemId) {
          ...
          var path = '/lms/panel/chapters/' + itemId + '/update';
          modal.find('.chapter-form').attr('data-action', path);
          $.get('/lms/panel/chapters/' + itemId + '?locale=' + locale, function (result) {
  ...
  $(document).ready(function () {
    ...
    function updateToDatabase(table, idString) {
      $.post('/lms/panel/webinars/order-items', {
        table: table,
        items: idString
      }, function (result) {
