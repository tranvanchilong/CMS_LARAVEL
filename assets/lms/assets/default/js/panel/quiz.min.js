...
(function ($) {
  ...
  $('body').on('click', '.edit_question', function (e) {
    ...
    loadingSwl();
    $.get('/lms/panel/quizzes-questions/' + question_id + '/edit', function (result) {
  ...
  $('body').on('change', '.js-ajax-webinar_id', function (e) {
    ...
    var path = '/lms/panel/chapters/getAllByWebinarId/' + webinarId;
  ...
  $(document).ready(function () {
    ...
    function updateToDatabase(table, quizId, idString) {
      $.post('/lms/panel/quizzes/' + quizId + '/order-items', {
        table: table,
        items: idString
      }, function (result) {
