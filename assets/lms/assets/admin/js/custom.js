...
// inputtags
    ...
    $(document).ready(function () {
        ...
        handleSearchableSelect2('search-user-select2', '/lms/admin/users/search', 'name');

        handleSearchableSelect2('search-user-select22', '/lms/admin/users/search', 'name');

        handleSearchableSelect2('search-webinar-select2', '/lms/admin/webinars/search', 'title');

        handleSearchableSelect2('search-bundle-select2', '/lms/admin/bundles/search', 'title');

        handleSearchableSelect2('search-forum-topic-select2', '/lms/admin/forums/topics/search', 'title');

        handleSearchableSelect2('search-product-select2', '/lms/admin/store/products/search', 'title');

        handleSearchableSelect2('search-category-select2', '/lms/admin/categories/search', 'title');

        handleSearchableSelect2('search-blog-select2', '/lms/admin/blog/search', 'title');
    ...
    var LFMButton = function (context) {
        ...
        var button = ui.button({
            ...
            click: function () {
                ...
                lfm({type: 'file', prefix: '/lms/laravel-filemanager'}, function (lfmItems, path) {
