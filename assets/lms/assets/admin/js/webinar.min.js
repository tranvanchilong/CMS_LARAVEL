...
(function ($) {
  ...
  $('#partnerInstructorSwitch').on('change.bootstrapSwitch', function (e) {
    ...
    if (isChecked) {
      ...
      handleSearchableSelect2('js-search-partner-user', '/lms' + adminPanelPrefix + '/users/search', 'name');
    } else {
  ...
  $('body').on('change', '#categories', function (e) {
    ...
    $.get('/lms' + adminPanelPrefix + '/filters/get-by-category-id/' + category_id, function (result) {
  ...
  $(document).ready(function () {
    ...
    function updateToDatabase(table, idString) {
      $.post('/lms' + adminPanelPrefix + '/webinars/order-items', {
        table: table,
        items: idString
      }, function (result) {
    ...
    Swal.fire({
      ...
      onOpen: function onOpen() {
        ...
        if (itemId) {
          ...
          $.get('/lms' + adminPanelPrefix + '/chapters/' + itemId + '?locale=' + locale, function (result) {
  ...
  * */
  ...
  function editExtraDescription($this, locale) {
    ...
    $.post('/lms' + adminPanelPrefix + '/webinar-extra-description/' + item_id + '/edit', edit_data, function (result) {
      if (result && result.webinarExtraDescription) {
        ...
        html = html.replaceAll('/lms' + adminPanelPrefix + '/webinar-extra-description/store', '/lms' + adminPanelPrefix + '/webinar-extra-description/' + item_id + '/update');
        Swal.fire({
          html: html,
          showCancelButton: false,
          showConfirmButton: false,
  ...
  * */
  ...
  function editTicket($this) {
    ...
    $.post('/lms' + adminPanelPrefix + '/tickets/' + ticket_id + '/edit', edit_data, function (result) {
      if (result && result.ticket) {
        var ticket = result.ticket;
        var edit_ticket_modal = '<div id="addTicketModal">';
        edit_ticket_modal += $('#webinarTicketModal').html();
        edit_ticket_modal += '</div>';
        edit_ticket_modal = edit_ticket_modal.replaceAll('/lms' + adminPanelPrefix + '/tickets/store', '/lms' + adminPanelPrefix + '/tickets/' + ticket_id + '/update');
        Swal.fire({
  ...
  * */
  ...
  function editChapter($this) {
    ...
    $.post('/lms' + adminPanelPrefix + '/chapters/' + chapter_id + '/edit', edit_data, function (result) {
      if (result && result.chapter) {
        var chapter = result.chapter;
        var html = '<div id="editChapterModal">';
        html += $('#webinarChapterModal').html();
        html += '</div>';
        html = html.replaceAll('/lms' + adminPanelPrefix + '/chapters/store', '/lms' + adminPanelPrefix + '/chapters/' + chapter_id + '/update');
  ...
  * */
  ...
  function editSession($this) {
    ...
    $.post('/lms' + adminPanelPrefix + '/sessions/' + session_id + '/edit', edit_data, function (result) {
      if (result && result.session) {
        var session = result.session;
        var edit_session_modal = '<div id="addSessionModal">';
        edit_session_modal += $('#webinarSessionModal').html();
        edit_session_modal += '</div>';
        edit_session_modal = edit_session_modal.replaceAll('/lms' + adminPanelPrefix + '/sessions/store', '/lms' + adminPanelPrefix + '/sessions/' + session_id + '/update');
        var nameId = randomString();
  ...
  * */
  ...
  $('body').on('click', '.edit-prerequisite', function (e) {
    ...
    $.post('/lms' + adminPanelPrefix + '/prerequisites/' + prerequisite_id + '/edit', edit_data, function (result) {
      var _this3 = this;
      ...
      if (result && result.prerequisite) {
        ...
        edit_prerequisite_modal = edit_prerequisite_modal.replaceAll('/lms' + adminPanelPrefix + '/prerequisites/store', '/lms' + adminPanelPrefix + '/prerequisites/' + prerequisite_id + '/update');
  ...
  * */
  ...
  function editFaq($this) {
    ...
    $.post('/lms' + adminPanelPrefix + '/faqs/' + faq_id + '/edit', edit_data, function (result) {
      if (result && result.faq) {
        var faq = result.faq;
        var edit_faq_modal = '<div id="addFAQsModal">';
        edit_faq_modal += $('#webinarFaqModal').html();
        edit_faq_modal += '</div>';
        edit_faq_modal = edit_faq_modal.replaceAll('/lms' + adminPanelPrefix + '/faqs/store', '/lms' + adminPanelPrefix + '/faqs/' + faq_id + '/update');
        Swal.fire({
          html: edit_faq_modal,
          showCancelButton: false,
          showConfirmButton: false,
  ...
  * */
  ...
  $('body').on('click', '.edit-webinar-quiz', function (e) {
    ...
    $.post('/lms' + adminPanelPrefix + '/webinar-quiz/' + webinar_quiz_id + '/edit', edit_data, function (result) {
      var _this4 = this;
      ...
      if (result && result.webinarQuiz) {
        ...
        edit_webinar_quiz_modal = edit_webinar_quiz_modal.replaceAll('/lms' + adminPanelPrefix + '/webinar-quiz/store', '/lms' + adminPanelPrefix + '/webinar-quiz/' + webinar_quiz_id + '/update');
  ...
  * */
  ...
  $('body').on('click', '.edit-bundle-webinar', function (e) {
    ...
    $.post('/lms' + adminPanelPrefix + '/bundle-webinars/' + item_id + '/edit', edit_data, function (result) {
      if (result && result.bundleWebinar) {
        ...
        html += '</div>';
        html = html.replaceAll('bundleWebinars-select', 'bundleWebinars-select2');
        html = html.replaceAll('/lms' + adminPanelPrefix + '/bundle-webinars/store', '/lms' + adminPanelPrefix + '/bundle-webinars/' + item_id + '/update');
        html = html.replaceAll('str_', '');
        Swal.fire({
          html: html,
          showCancelButton: false,
