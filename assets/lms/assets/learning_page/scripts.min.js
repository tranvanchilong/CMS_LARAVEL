...
(function ($) {
  $('body').on('click', '.panel-file-manager', function (e) {
    ...
    $(this).filemanager('file', {
      prefix: '/lms/laravel-filemanager'
    });
  });
  ...
  function handleContent(itemId, itemType) {
    ...
    $.post('/lms/course/learning/itemInfo', data, function (result) {
      if (itemType === 'session') {
    ...
    if (file.online_viewer && file.online_viewer !== '0' || file.downloadable && file.downloadable !== '0') {
      if (file.online_viewer && file.online_viewer !== '0') {
        ...
        if (file.is_video) {
          ...
          var otherHtml = "<a href=\"/lms".concat(courseUrl, "/file/").concat(file.id, "/download\" class=\"btn btn-primary btn-sm mt-15\" target=\"_blank\">").concat(downloadLang, "</a>");
      ...
      switch (file.storage) {
        ...
        case 'upload_archive':
          ...
          var _otherHtml = "<a href=\"/lms".concat(courseUrl, "/file/").concat(file.id, "/showHtml\" target=\"_blank\" class=\"btn btn-primary btn-sm mt-15\">").concat(showLang, "</a>");
  ...
  $('body').on('change', '.js-passed-lesson-toggle', function (e) {
    ...
    $.post('/lms/course/' + course_id + '/learningStatus', data, function (result) {
      $.toast({
        heading: '',
