function MenuEditor(l, t) {
  ...
  function f() {
    var e = $("<div>").addClass("btn-group float-right"),
      ...
      l = p({
        classCss: "btn  btn-sm btnUp btnMove",
        text: '<i class="fas fa-angle-up clickable"></i>',
      }),
      n = p({
        classCss: "btn  btn-sm btnDown btnMove",
        text: '<i class="fas fa-angle-down clickable"></i>',
      }),
      o = p({
        classCss: "btn  btn-sm btnOut btnMove",
        text: '<i class="fas fa-level-down-alt clickable"></i>',
      }),
      i = p({
        classCss: "btn  btn-sm btnIn btnMove",
  ...
  i.sortableLists(r.listOptions),
    ...
    $(document).on("click", ".btnRemove", function (e) {
      if ((e.preventDefault(), confirm(r.textConfirmDelete))) {
        ...
        void 0 !== s.attr("id") && (t = s.attr("id").toString() === l),
          s.children().length ||
            t ||
            (s.prev("div").children(".sortableListsOpener").first().remove(),
            s.remove()),
    ...
    i.on("click", ".btnOut", function (e) {
      ...
      var s = $(this).closest("ul"),
        t = $(this).closest("li");
      t.closest("ul").closest("li").after(t),
        s.children().length <= 0 &&
          (s.prev("div").children(".sortableListsOpener").first().remove(),
          s.remove()),
        MenuEditor.updateButtons(i);
    ...
    (this.update = function () {
      ...
      if (null !== e) {
        ...
        a.find(".item-menu").each(function () {
          ...
          e.children().children("i").removeClass(s).addClass(e.data("icon")),
    ...
    (this.add = function () {
      ...
      var s = f(),
        ...
        n = $("<div>")
          ...
          .append(s),
        o = $("<li>").data(e);
      o.addClass("list-group-item pr-0").append(n),
        i.append(o),
        MenuEditor.updateButtons(i),
        d();
    }),
          ...
          return (
            $.each(e, function (e, s) {
              ...
              var i = $("<div>").css("overflow", "auto"),
                ...
                c = f();
              i.append(r).append("&nbsp;").append(a).append(c),
                o.append(i),
  ...
  (L.fn.sortableLists = function (e) {
            ...
            d.insertZonePlus
              ? n < 14
                ? (function (e, s, t) {
                    ...
                    if (!t && e.pageX - s.offset().left > d.insertZone) {
                      ...
                      if (n.children().first().is("#sortableListsPlaceholder"))
                ...
                : l - 14 < n &&
                  (function (e, s, t) {
                    ...
                    if (!t && e.pageX - s.offset().left > d.insertZone) {
                      ...
                      if (n.children().last().is("#sortableListsPlaceholder"))
                        return f.css("display", "none");
              ...
              ? (function (e, s) {
                  ...
                  if (e.pageX - s.offset().left < d.insertZone) {
                    ...
                    if (l.children().first().is("#sortableListsPlaceholder"))
                      return f.css("display", "none");
              ...
              : l - 5 < n &&
                (function (e, s) {
                  ...
                  if (e.pageX - s.offset().left < d.insertZone) {
                    ...
                    if (l.children().last().is("#sortableListsPlaceholder"))
                      return f.css("display", "none");
    ...
    (L.fn.updateButtons = function (e) {
      ...
      0 === s &&
        (t.push("Out"),
        l.push("Out"),
        L(this).children("li").hideButtons(["Out"])),
        L(this)
          .children("li")
          .each(function () {
        ...
        L(this).children("li:first").hideButtons(t),
        L(this).children("li:last").hideButtons(l);
    }),
