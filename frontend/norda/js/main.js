    ...
    function product_slider_active(){
    ...
    function product_slider_active_2(){
    ...
    function product_slider_active_3(){
    ...
    function product_slider_active_4(){
    ...
    function product_slider_active_5(){
    ...
    function product_categories_slider_1(){
    ...
    function product_categories_slider_3(){
    ...
    $(".qtybutton").click(function() {
        ...
        var key = $button.parent().attr('data-id');
        ...
        if ($button.text() === "-" && oldValue === "1") {
            ...
            // setTimeout(function(){
                ...
                $('#form-' + parent.attr("data-id")).submit();
            // }, 1000);
        }
    });

    // submit delete product from cart
    $(".modal-submit-delete").click(function() {
        var key = $(this).first().attr('data-id');
        $('div[data-id='+ key +']').find('input').val(0);
        $('#form-' + key).submit();
    });

    // prevent submit check-out if any product missing value of variant
    $("#submit-checkout").click(function(event) {
        const variant_without_value = $(".empty-variant").filter((key, value) => !$(value).val());

        if (variant_without_value.length) {
            alert('Bạn cần chọn tất cả các biến thể của sản phẩm!');
            event.preventDefault();
        }
    });

    // only submit save value of variant after fill for all variant when this added to cart by quick add
    $(".empty-variant").on('change', function() {
        const variant_without_value = $('.empty-variant[data-id="' + $(this).attr('data-id') + '"]').filter((key, value) => !$(value).val());
    ...
    // submit after change value of variant
    $(".variant").on('focusin', function() {
