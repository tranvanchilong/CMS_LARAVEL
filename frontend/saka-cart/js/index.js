(function ($) {
  ...
  function get_data() {
      $.ajax({
            ...
            data:{latest_product:1,random_product:1,best_selling_product:1,trending_products:1,sliders:1,bump_adds:1,banner_adds:1,banner_adds_2:1,brand_adds:1,featured_category:1,menu_category:1,get_offerable_products:20},
            dataType: 'json',            
            beforeSend: function() {
