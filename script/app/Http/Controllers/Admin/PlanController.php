...
class PlanController extends Controller
{
    ...
    public function index()
    {
       ...
       $posts=Plan::withCount('active_users')->orderBy('serial_number', 'asc')->get();
    ...
    public function store(Request $request)
    {
        ...
        $plan->trial_expiry_date =$request->trial_expiry_date;
        $plan->serial_number =$request->serial_number;
        $plan->save();
