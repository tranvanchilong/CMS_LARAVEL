...
use App\Models\LMS\UserSession;
...
class LoginController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = '/lms/panel';
    ...
    public function showLoginForm()
    {
        ...
        $pageTitle = !empty($seoSettings['title']) ? $seoSettings['title'] : trans('lms/site.login_page_title');
        $pageDescription = !empty($seoSettings['description']) ? $seoSettings['description'] : trans('lms/site.login_page_title');
        ...
        return view('lms.'. getTemplate() . '.auth.login', $data);
    }
    ...
    protected function attemptLogin(Request $request)
    {
        ...
        return auth()->guard('lms_user')->attempt($credentials, $remember);
    }

    public function sendFailedLoginResponse(Request $request)
    {
        throw ValidationException::withMessages([
            'username' => [trans('lms/validation.password_or_username')],
        ]);
    }
    ...
    {
        throw ValidationException::withMessages([
            'username' => [trans('lms/auth.ban_msg', ['date' => dateTimeFormat($user->ban_end_at, 'j M Y')])],
        ]);
    }
    ...
    protected function sendNotActiveResponse($user)
    {
        $toastData = [
            ...
            'msg' => trans('lms/auth.login_failed_your_account_is_not_verified'),
            'status' => 'error'
        ];
    ...
    {
        $toastData = [
            'title' => trans('lms/update.login_failed'),
            'msg' => trans('lms/update.device_limit_reached_please_try_again'),
            'status' => 'error'
        ];

        return redirect('/lms/login')->with(['login_failed_active_session' => $toastData]);
    }
