...
class ProductController extends Controller
{
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('lms/update.my_products'),
            'products' => $products,
        ...
        return view('lms.web.default.panel.store.products.lists', $data);
    }
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('lms/update.new_product_page_title'),
            'currentStep' => 1,
        ];

        return view('lms.web.default.panel.store.products.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $url = '/lms/panel/store/products';
        if ($data['get_next'] == 1) {
            $url = '/lms/panel/store/products/' . $product->id . '/step/2';
        }
    ...
    public function edit(Request $request, $id, $step = 1)
    {
        ...
        $data = [
            'pageTitle' => trans('lms/update.edit_product') . ' | ' . $product->title,
            'product' => $product,
            'currentStep' => $step,
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($getNextStep) {
            ...
            $url = '/lms/panel/store/products/' . $product->id . '/step/' . (($nextStep <= 5) ? $nextStep : 5);
        }

        if ($productRulesRequired) {
            $url = '/lms/panel/store/products/' . $product->id . '/step/5';
