...
class CertificateController extends Controller
{
    ...
    public function lists(Request $request)
    {
        ...
        if (!$user->isUser()) {
            ...
            $data = [
                'pageTitle' => trans('lms/quiz.certificates_lists'),
                'quizzes' => $quizzes,
            ...
            return view('lms.web.default.panel.certificates.list', $data);
        }
    ...
    public function achievements(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('lms/quiz.my_achievements_lists'),
            'quizzes' => $quizzes,
        ...
        return view('lms.'. getTemplate() . '.panel.certificates.achievements', $data);
    }
