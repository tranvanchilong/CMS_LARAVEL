...
class SupportsController extends Controller
{
    public function index(Request $request, $id = null)
    {
        ...
        $data = [
            'pageTitle' => trans('lms/panel.send_new_support'),
            'supports' => $supports,
        ...
        return view('lms.'. getTemplate() . '.panel.support.conversations', $data);
    }
    ...
    public function tickets(Request $request, $id = null)
    {
        ...
        return view('lms.'. getTemplate() . '.panel.support.ticket_conversations', $data);
    }
    ...
    public function create()
    {
        ...
        return view('lms.'. getTemplate() . '.panel.support.new', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $url = '/lms/panel/support';

        if (!empty($data['department_id'])) {
            $url = '/lms/panel/support/tickets';
        }
