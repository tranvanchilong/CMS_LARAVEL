...
class CourseNoticeboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('lms.'. getTemplate() . '.panel.noticeboard.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('lms.'. getTemplate() . '.panel.noticeboard.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (empty($webinar) or ($webinar->teacher_id != $user->id and $webinar->creator_id != $user->id)) {
            return response()->json([
                'code' => 422,
                'errors' => [
                    'webinar_id' => [trans('lms/cart.course_not_found')]
                ]
            ], 422);
        }
