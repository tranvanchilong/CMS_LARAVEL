...
class AssignmentController extends Controller
{
    public function myAssignments(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('lms/update.my_assignments'),
        ...
        return view('lms.web.default.panel.assignments.my-assignments', $data);
    }
    ...
    public function myCoursesAssignments(Request $request)
    {
        ...
        $data = [
            'pageTitle' => trans('lms/update.my_courses_assignments'),
            'assignments' => $assignments,
            'courseAssignmentsCount' => $courseAssignmentsCount,
            'pendingReviewCount' => $pendingReviewCount,
            'passedCount' => $passedCount,
        ...
        return view('lms.web.default.panel.assignments.my-courses-assignments', $data);
    }
    ...
    public function students(Request $request, $id)
    {
        ...
        if (!empty($assignment)) {
            ...
            return view('lms.web.default.panel.assignments.students', $data);
        }
