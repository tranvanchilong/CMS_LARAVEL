...
class InstallmentsController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            'pageTitle' => trans('lms/update.installments'),
        ...
        return view('lms.web.default.panel.financial.installments.lists', $data);
    }
    ...
    public function show($orderId)
    {
        ...
        if (!empty($order) and !in_array($order->status, ['refunded', 'canceled'])) {
            ...
            return view('lms.web.default.panel.financial.installments.details', $data);
        }
        ...
        if (getInstallmentsSettings("allow_cancel_verification")) {
            ...
            if (!empty($order)) {
                ...
                return response()->json([
                    ...
                    'text' => trans('lms/update.order_status_changes_to_canceled'),
                ]);
            }
        }
