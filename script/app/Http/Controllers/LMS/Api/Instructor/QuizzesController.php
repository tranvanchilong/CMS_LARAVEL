...
class QuizzesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return apiResponse2(1, 'created', trans('lms/public.stored'));
    ...
    public function update(Request $request, $id)
    {
        ...
        return apiResponse2(1, 'updated', trans('lms/public.updated'));
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $quiz->delete();
        return apiResponse2(1, 'deleted', trans('lms/public.deleted'));
    }
    ...
    public function start(Request $request, $id)
    {
        ...
        if ($quiz) {
            ...
            if (!isset($quiz->attempt) or ($userQuizDone->count() < $quiz->attempt and !$status_pass)) {
                ...
                return back()->with('msg', trans('lms/quiz.cant_start_quiz'));
            }
        }
        abort(404);
    }
