...
use App\Http\Controllers\LMS\Api\Objects\BlogObj;
...
class CommentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return apiResponse2(1, 'stored',
            trans('lms/product.comment_success_store_msg'),
            null,
            trans('lms/product.comment_success_store')
    ...
    public function report(Request $request, $id)
    {
        ...
        return apiResponse2(1, 'stored', trans('lms/panel.report_success'));
