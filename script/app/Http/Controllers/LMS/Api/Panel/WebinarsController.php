...
class WebinarsController extends Controller
{
    public function show($id)
    {
        ...
        $webinar = Webinar::where('id', $id)
            ...
            ->where('status', 'active')
            ->first();
        return apiResponse2(1, 'retrieved', trans('lms/api.public.retrieved'), [$webinar]);
    }
    ...
    public function free(Request $request, $id)
    {
        ...
        if (!empty($course->price) and $course->price > 0) {
            return apiResponse2(0, 'not_free', trans('lms/api.cart.not_free'));
        ...
        return apiResponse2(1, 'enrolled', trans('lms/api.webinar.enrolled'));
