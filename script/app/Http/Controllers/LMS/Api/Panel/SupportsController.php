...
use App\Http\Controllers\LMS\Api\Objects\SupportObj;
use App\Models\LMS\Sale;
use App\Models\LMS\Api\Support;
...
class SupportsController extends Controller
{
    ...
    public function show(Request $request ,$id){
        ...
        return apiResponse2(1, 'retrieved', trans('lms/api.public.retrieved'), $support->details );
    ...
    public function myClassSupport(Request $request)
    {
       ...
       ->WhereIn('webinar_id', $userWebinarsIds)
        ->handleFilters()->orderBy('created_at', 'desc')
            ...
            return apiResponse2(1, 'retrieved', trans('lms/api.public.retrieved'), $supports);
    ...
    public function store(Request $request)
    {
     ...
     //   unset($data['type']);
        ...
        return apiResponse2(1, 'stored', trans('lms/api.public.stored'),[
            'attach'=>url(get_path_lms().$attach)
        ]);
    }
    ...
    public function close($id)
    {
      //  dd('ff') ;
        ...
        return apiResponse2(1, 'closed', trans('lms/api.support.closed') );
