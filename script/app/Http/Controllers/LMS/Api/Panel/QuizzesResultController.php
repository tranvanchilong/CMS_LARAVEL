...
use App\Models\LMS\Api\QuizzesQuestion;
use App\Models\LMS\Api\QuizzesQuestionsAnswer;
...
class QuizzesResultController extends Controller
{
    ...
    {
        $quizResults = apiauth()->guard('lms_user')->quizResults()->handleFilters()
    ...
    public function start(Request $request, $id)
    {
        ...
        if ($auth_can_take_quiz_status != 'ok') {
            return apiResponse2(0, $auth_can_take_quiz_status, trans('lms/api.public.stored'));
        }
    ...
    public function updateResult(Request $request, $quizResultId)
    {
        ...
        if (!$quizResult->reviewable) {
            return apiResponse2(0, 'unreviewable', trans('lms/api.quiz.retrieved'));
        }
        $reviews = [];
