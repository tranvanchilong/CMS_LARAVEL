...
class SubscribesController extends Controller
{
    ...
    public function webPayGenerator(Request $request)
    {
        ...
        if ($activeSubscribe) {
            ...
            return apiResponse2(0, 'has_active_subscribe',
                trans('lms/site.you_have_active_subscribe'), null,
        ...
        return apiResponse2(1, 'generated', trans('lms/api.link.generated'),
            [
                'link' => URL::signedRoute('my_api.web.subscribe', [apiauth()->guard('lms_user')->id
    ...
    public function pay(Request $request)
    {
        ...
        if ($activeSubscribe) {
            ...
            return apiResponse2(0, 'has_active_subscribe', trans('lms/api.subscribe.has_active_subscribe'));
        }
    ...
    public function apply(Request $request)
    {
        ...
        if (!$webinar->subscribe) {
            return apiResponse2(0, 'not_subscribable', trans('lms/api.course.not_subscribable'));
        ...
        if (!$subscribe) {
            ...
            return apiResponse2(0, 'no_active_subscribe',
                trans('lms/site.you_dont_have_active_subscribe'), null,
                trans('lms/public.request_failed')
        ...
        return apiResponse2(1, 'subscribed',
            trans('lms/cart.success_pay_msg_subscribe'),
            null,
            trans('lms/cart.success_pay_title')
    ...
    public function generalApply(Request $request)
    {
        ...
        $subscribe = \App\Models\LMS\Subscribe::getActiveSubscribe($user->id);

        if (!$subscribe) {
            return apiResponse2(0, 'no_active_subscribe',
                trans('lms/site.you_dont_have_active_subscribe')
            );
        }
