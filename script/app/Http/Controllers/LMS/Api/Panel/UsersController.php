...
use App\Http\Controllers\LMS\Api\UploadFileManager;
...

{
    ...
    public function updateImages(Request $request)
    {
        ...
        return apiResponse2(1, 'updated', trans('lms/api.public.updated'));
    ...
    public function updatePassword(Request $request)
    {
        ...
        return apiResponse2(0, 'incorrect', trans('lms/api.public.profile_setting.incorrect'));
    ...
    public function followToggle(Request $request, $id)
    {
        ...
        if ($status) {
            ...
            return apiResponse2(1, 'followed', trans('lms/api.user.followed'));
        ...
        if (!empty($follow)) {
            ...
            $follow->delete();
            return apiResponse2(1, 'unfollowed', trans('lms/api.user.unfollowed'));

        }

        return apiResponse2(0, 'not_followed', trans('lms/api.user.not_followed'));
