...
class CartController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($checkCourseForSale != 'ok') {
            return apiResponse2(0, $checkCourseForSale, trans('lms/api.course.purchase.' . $checkCourseForSale));
        }
        ...
        return apiResponse2(1, 'stored', trans('lms/api.public.store'));
    ...
    public function validateCoupon(Request $request)
    {
        ...
        if (!$discountCoupon || !$discountCoupon->checkValidDiscount($user)) {
            return apiResponse2(0, 'invalid', trans('lms/api.cart.invalid_coupon'));
        ...
        if (!empty($carts) and !$carts->isEmpty()) {
            ...
            if (!empty($calculate)) {
                ...
                return apiResponse2(1, 'valid', trans('lms/api.cart.valid_coupon'), [
                    'amounts' => $calculate,
    ...
    {
        return apiResponse2(1, 'generated', trans('lms/api.link.generated'),
            [
                'link' => URL::signedRoute('my_api.web.checkout', [apiauth()->guard('lms_user')->id, 'discount_id' => $request->input('discount_id')])
                ,
            ]
        );
    }
    ...
    public function checkout(Request $request)
    {
        ...
        if (!empty($carts) and !$carts->isEmpty()) {
            ...
            if (!empty($order) and $order->total_amount > 0) {
                ...
                return apiResponse2(1, 'checkout', trans('lms/api.cart.checkout'), $data);
        ...
        return apiResponse2(0, 'empty_cart', trans('lms/api.payment.empty_cart'));
    ...
    private function handlePaymentOrderWithZeroTotalAmount($order)
    {
        ...
        return apiResponse2(1, 'paid', trans('lms/api.payment.paid'));
