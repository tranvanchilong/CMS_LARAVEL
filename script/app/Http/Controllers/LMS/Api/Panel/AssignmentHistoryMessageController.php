...
use App\Models\LMS\Api\WebinarAssignmentHistory;
use App\Models\LMS\Api\WebinarAssignmentHistoryMessage;
...
class AssignmentHistoryMessageController extends Controller
{
            ...
            if (!empty($assignmentHistory)) {
                ...
                if ($user->id != $assignment->creator_id) {
                    ...
                    if (!$deadline or (!empty($assignment->attempts) and $submissionTimes >= $assignment->attempts)) {
                        return apiResponse2(0, 401, trans('lms/update.assignment_deadline_error_desc'));
                    }
                }
    ...
    {
        $assignmentHistory = \App\Models\LMS\WebinarAssignmentHistory::where('instructor_id', $assignment->creator_id)
