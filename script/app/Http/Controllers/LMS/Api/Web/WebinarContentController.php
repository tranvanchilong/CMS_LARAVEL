...
class WebinarContentController extends Controller
{
    public function quizzes($webinar_id)
    {
        ...
        return apiResponse2(1, 'retrieved', trans('lms/api.public.retrieved'), QuizResource::collection($quizzes));
    }
    ...
    public function certificates($webinar_id)
    {
        ...
        return apiResponse2(1, 'retrieved', trans('lms/api.public.retrieved'), $certificates);
    }
}
