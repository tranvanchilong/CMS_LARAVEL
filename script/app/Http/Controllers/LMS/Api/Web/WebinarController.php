...
class WebinarController extends Controller
{
    ...
    public function content($id)
    {
        ...
        return apiResponse2(1, 'retrieved', trans('lms/api.public.retrieved'), $content);
    }
    ...
    public function learningStatus(Request $request, $webinar_id)
    {
        ...
        if (!$course->checkUserHasBought($user)) {
            ...
            return apiResponse2(0, 'not_purchased', trans('lms/api.webinar.not_purchased'));
        }
        ...
        if ($status) {
            ...
            return apiResponse2(1, 'read', trans('lms/api.learning_status.read'));

        }
        return apiResponse2(1, 'unread', trans('lms/api.learning_status.unread'));
    ...
    public function report(Request $request, $id)
    {
        ...
        return apiResponse2(1, 'reported', trans('lms/courses.reported'));
    }
    ...
    public function details($webinars)
    {
        ...
        $webinars = $webinars->map(function ($webinar) use ($user) {
            ...
            return [
                ...
                'quizzes_count' => $webinar->quizzes->where('status', \App\Models\LMS\Quiz::ACTIVE)->count(),
