...
use App\Models\LMS\FeatureWebinarTranslation;
...
class FeatureWebinarsControllers extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_feature_webinars');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/pages/webinars.feature_webinars'),
            'categories' => $categories,
            'features' => $features,
        ];

        return view('lms.admin.webinars.feature.lists', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_feature_webinars_create');

        removeContentLocale();

        $data = [
            'pageTitle' => trans('lms/public.create') . ' ' . trans('lms/admin/pages/webinars.feature_webinars'),
        ];

        return view('lms.admin.webinars.feature.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'webinar_id' => 'required|unique:lms_feature_webinars,webinar_id'
        ]);
        ...
        return redirect('/lms/admin/webinars/features');
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('lms/public.edit') . ' ' . trans('lms/admin/pages/webinars.feature_webinars'),
            'feature' => $feature
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        $this->validate($request, [
            'webinar_id' => 'required|unique:lms_feature_webinars,webinar_id,' . $id,
        ]);
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_feature_webinars_export_excel');
