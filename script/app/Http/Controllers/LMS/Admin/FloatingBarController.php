...
use App\Models\LMS\FloatingBarTranslation;
...
class FloatingBarController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_floating_bar_create');
        ...
        $data = [
            'pageTitle' => trans('lms/update.top_bottom_bar'),
            'floatingBar' => $floatingBar,
            'definedLanguage' => $definedLanguage,
        ];

        return view('lms.admin.floating_bar.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $toastData = [
            ...
            'msg' => trans('lms/update.floating_bar_successfully_updated'),
            'status' => 'success'
        ];
