...
use App\Models\LMS\ForumTranslation;
...
class ForumController extends Controller
{
    public function index(Request $request)
    {
        ...
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_forum_list');
        ...
        $data = [
            'pageTitle' => trans('lms/update.forums'),
            'forums' => $forums,
        ...
        return view('lms.admin.forums.lists', $data);
    }

    public function create()
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_forum_create');
        ...
        $data = [
            'pageTitle' => trans('lms/update.new_forum'),
            'userGroups' => $userGroups,
            'roles' => $roles
        ];

        return view('lms.admin.forums.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'group_id' => 'nullable|exists:lms_groups,id',
        ...
        return redirect('/lms/admin/forums');
    }

    public function edit(Request $request, $id)
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_forum_edit');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_forum_delete');
