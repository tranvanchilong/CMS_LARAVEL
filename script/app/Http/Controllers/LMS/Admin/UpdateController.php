...
class UpdateController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),"admin_settings_update_app");

        $data = [
            'pageTitle' => trans('lms/update.update_app')
        ];

        return view('lms.admin.settings.update_app.index', $data);
    }
    ...
    public function basicUpdate(Request $request)
    {
        ...
        return response()->json([
            'code' => 200,
            'msg' => trans('lms/update.app_updated_successful')
        ]);
    }
    ...
    public function customUpdate(Request $request)
    {
        ...
        return response()->json([
            'code' => 200,
            'msg' => trans('lms/update.app_updated_successful_json')
        ]);
    }
