...
use App\Models\LMS\CashbackRule;
use App\Models\LMS\CashbackRuleSpecificationItem;
use App\Models\LMS\CashbackRuleUserGroup;
use App\Models\LMS\Category;
use App\Models\LMS\Group;
use App\Models\LMS\RegistrationPackage;
use App\Models\LMS\Subscribe;
use App\Models\LMS\CashbackRuleTranslation;
...
class CashbackRuleController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_cashback_rules');
        ...
        $data = [
            'pageTitle' => trans('lms/update.cashback_rules'),
            'rules' => $rules,
        ...
        return view('lms.admin.cashback.rules.lists.index', $data);
    }
    ...
    public function create()
    {
        ...
        $data = [
            'pageTitle' => trans('lms/update.new_rule'),
        ...
        return view('lms.admin.cashback.rules.create.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($rule)) {
            ...
            $toastData = [
                ...
                'msg' => trans('lms/update.new_cashback_rule_were_successfully_created'),
                'status' => 'success'
            ];
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            'pageTitle' => trans('lms/update.edit_cashback_rule'),
            'userGroups' => $userGroups,
            'categories' => $categories,
            'subscriptionPackages' => $subscriptionPackages,
            'registrationPackages' => $registrationPackages,
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($rule)) {
            ...
            $toastData = [
                'title' => trans('lms/public.request_success'),
                'msg' => trans('lms/update.cashback_rule_were_successfully_updated'),
                'status' => 'success'
            ];
    ...
    public function delete($id)
    {
        ...
        $toastData = [
            'title' => trans('lms/public.request_success'),
            'msg' => trans('lms/update.cashback_rule_were_successfully_deleted'),
            'status' => 'success'
        ];
