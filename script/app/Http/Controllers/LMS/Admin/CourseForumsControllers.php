...
use App\Models\LMS\CourseForumAnswer;
...
class CourseForumsControllers extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_course_question_forum_list');
        ...
        $data = [
            'pageTitle' => trans('lms/update.course_forum'),
            'webinars' => $webinars
        ];

        return view('lms.admin.webinars.forum.course_lists', $data);
    }
    ...
    public function forums(Request $request, $webinar_id)
    {
        ...
        return view('lms.admin.webinars.forum.question_lists', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_course_question_forum_answers');
        ...
        $data = [
            'pageTitle' => trans('lms/public.answers'),
            'question' => $question,
            'answers' => $answers,
            'course' => $course,
        ];

        return view('lms.admin.webinars.forum.answers_lists', $data);
    }
    ...
    public function forumDelete($webinar_id, $forum_id)
    {
        ...
        return redirect("/lms/admin/webinars/$webinar_id/forums");
    }
