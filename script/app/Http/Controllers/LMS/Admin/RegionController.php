...
class RegionController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_regions_' . $pageType);
        ...
        $data = [
            'pageTitle' => trans('lms/update.' . $pageType),
            'regions' => $regions,
            'type' => $type
        ];

        return view('lms.admin.regions.index', $data);
    }

    public function create(Request $request)
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_regions_create');
        ...
        $data = [
            'pageTitle' => trans('lms/update.new_' . $type),
            'countries' => $countries,
            'latitude' => 42.67,
            'longitude' => 12.65,
        ];

        return view('lms.admin.regions.create', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_regions_edit');
        ...
        if ($region) {
            ...
            $data = [
                'pageTitle' => trans('lms/update.new_country'),
                'region' => $region,
                'countries' => $countries,
                'provinces' => $provinces,
                'cities' => $cities,
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_regions_delete');
