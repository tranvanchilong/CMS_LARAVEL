...
class UpcomingCoursesController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_upcoming_courses_list');
        ...
        $data = [
            'pageTitle' => trans('lms/update.upcoming_courses'),
        ...
        return view('lms.admin.upcoming_courses.lists', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_upcoming_courses_create');
        ...
        return view('lms.admin.upcoming_courses.create.index', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_upcoming_courses_edit');
        ...
        if (!empty($upcomingCourse)) {
            ...
            $data = [
                'pageTitle' => trans('lms/public.edit') . ' | ' . $upcomingCourse->title,
                'teachers' => $teachers,
                'categories' => $categories,
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_upcoming_courses_delete');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_upcoming_courses_export_excel');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_upcoming_courses_followers');
        ...
        $data = [
            'pageTitle' => $upcomingCourse->title . ' - ' . trans('lms/update.followers'),
            'upcomingCourse' => $upcomingCourse,
            'followers' => $followers,
        ...
        return view('lms.admin.upcoming_courses.followers', $data);
    }
    ...
    public function deleteFollow($upcomingId, $followId)
    {
        ...
        if (!empty($follow)) {
            ...
            $toastData = [
                'title' => trans('lms/public.request_success'),
                'msg' => trans('lms/update.items_deleted_successful'),
                'status' => 'success'
            ];
