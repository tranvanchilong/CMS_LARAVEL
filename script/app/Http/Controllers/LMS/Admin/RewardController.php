...
class RewardController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_rewards_history');
        ...
        $data = [
            'pageTitle' => trans('lms/update.rewards'),
            'rewards' => $rewards
        ];

        return view('lms.admin.rewards.history', $data);
    }

    public function create()
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_rewards_items');
        ...
        return view('lms.admin.rewards.create', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_rewards_item_delete');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_rewards_settings');
        ...
        $data = [
            'pageTitle' => trans('lms/update.rewards_settings'),
            'itemValue' => !empty($setting) ? $setting->value : null,
        ];

        return view('lms.admin.rewards.settings', $data);
    }
