...
class OfflinePaymentController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_offline_payments_list');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/main.offline_payments_title') . (($pageType == 'requests') ? 'Requests' : 'History'),
        ...
        return view('lms.admin.financial.offline_payments.lists', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_offline_payments_reject');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_offline_payments_approved');
        ...
        Accounting::create([
            ...
            'description' => trans('lms/admin/pages/setting.notification_offline_payment_approved'),
            'created_at' => time(),
        ]);
