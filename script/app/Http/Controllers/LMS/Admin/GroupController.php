...
use App\Models\LMS\GroupRegistrationPackage;
...
class GroupController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_group_list');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/pages/groups.group_list_page_title'),
            'groups' => $groups->paginate(10),
            'group_name' => $filters['group_name'] ?? '',
        ];

        return view('lms.admin.users.groups.lists', $data);
    }

    public function create()
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_group_create');

        $data = [
            'pageTitle' => trans('lms/admin/main.group_new_page_title'),
        ];

        return view('lms.admin.users.groups.new', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['creator_id'] = auth()->guard('lms_user')->user()->id;
        unset($data['_token']);
        ...
        return redirect('/lms/admin/users/groups');
    }

    public function edit($id)
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_group_edit');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/pages/groups.edit_page_title'),
            'group' => $group,
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_group_delete');
