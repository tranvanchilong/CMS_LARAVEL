...
class AppointmentsController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_appointments_lists');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/main.meetings_list_title'),
        ...
        return view('lms.admin.appointments.lists', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_appointments_join');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_appointments_send_reminder');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_appointments_cancel');
