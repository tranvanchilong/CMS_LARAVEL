...
use App\Http\Controllers\LMS\Admin\traits\InstallmentOrdersTrait;
use App\Http\Controllers\LMS\Admin\traits\InstallmentOverdueTrait;
use App\Http\Controllers\LMS\Admin\traits\InstallmentPurchasesTrait;
use App\Http\Controllers\LMS\Admin\traits\InstallmentSettingsTrait;
use App\Http\Controllers\LMS\Admin\traits\InstallmentVerificationRequestsTrait;
use App\Http\Controllers\LMS\Controller;
use App\Models\LMS\Category;
use App\Models\LMS\Group;
use App\Models\LMS\Installment;
use App\Models\LMS\InstallmentSpecificationItem;
use App\Models\LMS\InstallmentStep;
use App\Models\LMS\InstallmentUserGroup;
use App\Models\LMS\RegistrationPackage;
use App\Models\LMS\Subscribe;
use App\Models\LMS\InstallmentStepTranslation;
use App\Models\LMS\InstallmentTranslation;
...
class InstallmentsController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_installments_list');
        ...
        $data = [
            'pageTitle' => trans('lms/update.installment_plans'),
            'installments' => $installments,
        ];

        return view('lms.admin.financial.installments.lists.index', $data);
    }

    public function create()
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_installments_create');
        ...
        $data = [
            'pageTitle' => trans('lms/update.new_installment_plan'),
        ...
        return view('lms.admin.financial.installments.create.index', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!empty($installment)) {
            ...
            $toastData = [
                ...
                'msg' => trans('lms/update.new_installments_were_successfully_created'),
                'status' => 'success'
            ];
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_installments_edit');
        ...
        $data = [
            'pageTitle' => trans('lms/update.edit_installment_plan'),
            'userGroups' => $userGroups,
            'categories' => $categories,
            'subscriptionPackages' => $subscriptionPackages,
            'registrationPackages' => $registrationPackages,
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($installment)) {
            ...
            $toastData = [
                'title' => trans('lms/public.request_success'),
                'msg' => trans('lms/update.installment_were_successfully_updated'),
                'status' => 'success'
            ];
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_installments_delete');
        ...
        $toastData = [
            'title' => trans('lms/public.request_success'),
            'msg' => trans('lms/update.installment_were_successfully_deleted'),
            'status' => 'success'
        ];
