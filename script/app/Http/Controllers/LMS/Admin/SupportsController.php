...
use App\Models\LMS\SupportConversation;
...
class SupportsController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_supports_list');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/pages/users.supports'),
            'supports' => $supports,
        ...
        if (!empty($request->get('type')) and $request->get('type') == 'course_conversations') {
            $data['pageTitle'] = trans('lms/admin/main.classes_conversations');
            ...
            return view('lms.admin.supports.course_conversations_lists', $data);
        }

        return view('lms.admin.supports.lists', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_support_send');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/main.new_support_ticket_title'),
            'departments' => $departments,
            'toUser' => $toUser
        ];

        return view('lms.admin.supports.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'department_id' => 'required|exists:lms_support_departments,id',
        ...
        SupportConversation::create([
            ...
            'supporter_id' => auth()->guard('lms_user')->id(),
            'message' => $data['message'],
            'attach' => $data['attach'],
            'created_at' => time(),
        ]);

        return redirect('/lms/admin/supports/' . $support->id . '/conversation');
    }

    public function edit($id)
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_supports_reply');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/main.edit_support_ticket_title'),
            'departments' => $departments,
            'support' => $support,
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/lms/admin/supports');
    }

    public function delete($id)
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_supports_delete');
    ...
    public function conversation($id)
    {
        ...
        $data = [
            'pageTitle' => trans('lms/admin/pages/users.support_conversation'),
            'support' => $support
        ];

        return view('lms.admin.supports.conversation', $data);
    }
