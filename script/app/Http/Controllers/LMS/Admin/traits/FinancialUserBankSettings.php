...
use App\Models\LMS\UserBankSpecification;
use App\Models\LMS\UserBankSpecificationTranslation;
use App\Models\LMS\UserBankTranslation;
...
trait FinancialUserBankSettings
{
    ...
    public function financialUserBankForm()
    {
        ...
        $html = (string)view()->make("lms.admin.settings.financial.user_banks.modal", $data);
