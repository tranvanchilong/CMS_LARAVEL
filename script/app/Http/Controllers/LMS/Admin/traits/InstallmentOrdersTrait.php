...
trait InstallmentOrdersTrait
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_installments_orders');
        ...
        $data = [
            'pageTitle' => trans('lms/update.installment_verification') . ' - '.$order->user->full_name,
            'order' => $order,
        ...
        return view('lms.admin.financial.installments.verification_request_details', $data);
    }
    ...
    public function approve($orderId)
    {
        ...
        $toastData = [
            ...
            'msg' => trans('lms/update.order_status_changes_to_approved'),
            'status' => 'success'
        ];
    ...
    public function reject($orderId)
    {
        ...
        $toastData = [
            'title' => trans('lms/public.request_success'),
            'msg' => trans('lms/update.order_status_changes_to_rejected'),
            'status' => 'success'
        ];
    ...
    public function cancel($orderId)
    {
        ...
        $toastData = [
            'title' => trans('lms/public.request_success'),
            'msg' => trans('lms/update.order_status_changes_to_canceled'),
            'status' => 'success'
        ];
    ...
    public function refund($orderId)
    {
        ...
        $toastData = [
            'title' => trans('lms/public.request_success'),
            'msg' => trans('lms/update.installment_refunded_successful'),
            'status' => 'success'
        ];
    ...
    public function downloadAttachment($orderId, $attachmentId)
    {
        ...
        if (!empty($attachment)) {
            $filePath = get_public_path_lms($attachment->file);
            ...
            $toastData = [
                'title' => trans('lms/update.file_not_found'),
                'msg' => trans('lms/update.the_address_entered_for_the_file_is_invalid_or_the_file_has_been_deleted'),
                'status' => 'error'
            ];
            return back()->with(['toast' => $toastData]);
        }
