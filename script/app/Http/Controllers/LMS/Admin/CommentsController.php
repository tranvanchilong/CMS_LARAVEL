...
class CommentsController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_' . $this->item . '_comments');
        ...
        $data = [
            ...
            'page' => $this->page,
            'pageTitle' => trans("lms/update.admin_{$this->page}_comments_page_title"),
            'comments' => $comments,
        ...
        return view('lms.admin.comments.comments', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_comments_status');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_comments_edit');
        ...
        if (!empty($comment)) {
            $data = [
                'pageTitle' => trans('lms/admin/pages/comments.edit_comment'),
                'itemRelation' => $this->item,
                'page' => $this->page,
                'comment' => $comment,
            ];

            return view('lms.admin.comments.comment_edit', $data);
        }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_comments_reply');
        ...
        if (!empty($comment)) {
            ...
            return view('lms.admin.comments.comment_reply', $data);
        }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_comments_delete');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_comments_reports');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/pages/comments.comments_reports'),
            'itemRelation' => $this->item,
            'page' => $this->page,
            'reports' => $reports,
        ];

        return view('lms.admin.comments.reports', $data);
    }
    ...
    public function reportShow($page, $id)
    {
        ...
        if (!empty($report)) {
            ...
            return view('lms.admin.comments.report_show', $data);
        }
