...
class WebinarCertificateController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_course_certificate_list');
        ...
        $data = [
            'pageTitle' => trans('lms/update.competition_certificates'),
        ...
        return view('lms.admin.certificates.course_certificates', $data);
    }
