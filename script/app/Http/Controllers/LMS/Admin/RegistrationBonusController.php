...
class RegistrationBonusController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_registration_bonus_history');
        ...
        foreach ($users as $user) {
            ...
            $user->bonus_status = !empty($bonusAccounting) ? trans('lms/update.unlock') : trans('lms/update.lock');
        ...
        $data = [
            'pageTitle' => trans('lms/update.bonus_history'),
        ...
        return view('lms.admin.registration_bonus.history', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_registration_bonus_export_excel');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_registration_bonus_settings');
        ...
        $data = [
            'pageTitle' => trans('lms/update.registration_bonus_settings'),
            'settings' => $settings,
            'selectedLocale' => mb_strtolower($request->get('locale', Setting::$defaultSettingsLocale)),
        ];

        return view('lms.admin.registration_bonus.settings.index', $data);
    }
