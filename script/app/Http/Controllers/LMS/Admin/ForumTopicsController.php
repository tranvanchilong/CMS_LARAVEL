...
class ForumTopicsController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_forum_topics_lists');
        ...
        $data = [
            'pageTitle' => trans('lms/update.topics'),
            'topics' => $topics
        ];

        return view('lms.admin.forums.topics.lists', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_forum_topics_create');
        ...
        return view('lms.admin.forums.topics.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'forum_id' => 'required|exists:lms_forums,id',
        ...
        if (!empty($forum)) {
            ...
            $url = '/lms/admin/forums/' . $topic->forum_id . '/topics';
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_forum_topics_delete');
        ...
        if (!empty($topic)) {
            ...
            $toastData = [
                'title' => trans('lms/public.request_success'),
                'msg' => trans('lms/update.topic_successfully_delete'),
                'status' => 'success'
            ];
    ...
    public function close($forumId, $topicId)
    {
        ...
        $toastData = [
            'title' => trans('lms/public.request_success'),
            'msg' => trans('lms/update.topic_closed_successful'),
            'status' => 'success'
        ];
        return back()->with(['toast' => $toastData]);
    }
    ...
    public function open($forumId, $topicId)
    {
        ...
        $toastData = [
            'title' => trans('lms/public.request_success'),
            'msg' => trans('lms/update.topic_opened_successful'),
            'status' => 'success'
        ];
        return back()->with(['toast' => $toastData]);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_forum_topics_posts');
        ...
        if (!empty($topic)) {
            $data = [
                'pageTitle' => trans('lms/site.posts'),
                'topic' => $topic,
                'forum' => $forum
            ];

            return view('lms.admin.forums.topics.posts', $data);
        }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_forum_topics_create_posts');
    ...
    public function postDelete($forumId, $topicId, $postId)
    {
        ...
        if (!empty($topic)) {
            ...
            if (!empty($post)) {
                ...
                $toastData = [
                    'title' => trans('lms/public.request_success'),
                    'msg' => trans('lms/update.post_successfully_delete'),
                    'status' => 'success'
                ];
