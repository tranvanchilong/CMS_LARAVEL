...
class WaitlistController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_waitlists_lists');
        ...
        $data = [
            'pageTitle' => trans('lms/update.waitlists'),
            'waitlists' => $waitlists
        ];

        return view('lms.admin.waitlists.index', $data);
    }

    public function exportExcel(Request $request)
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_waitlists_exports');
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_waitlists_users');
        ...
        $data = [
            'pageTitle' => trans('lms/update.waitlists') . ' - ' . $webinar->title,
            'waitlists' => $waitlists,
            'waitlistId' => $webinarId,
            'webinarTitle' => $webinar->title,
        ];

        return view('lms.admin.waitlists.users_list', $data);
    }

    public function clearList(Request $request, $webinarId)
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_waitlists_clear_list');
        ...
        $toastData = [
            ...
            'msg' => trans('lms/update.waitlist_cleared_successful'),
            'status' => 'success'
        ];
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_waitlists_disable');
        ...
        $toastData = [
            'title' => trans('lms/public.request_success'),
            'msg' => trans('lms/update.waitlist_disabled_successful'),
            'status' => 'success'
        ];
        return back()->with(['toast' => $toastData]);
    }
    ...
    public function deleteWaitlistItems($waitlistId)
    {
        ...
        $toastData = [
            'title' => trans('lms/public.request_success'),
            'msg' => trans('lms/update.waitlist_item_deleted_successful'),
            'status' => 'success'
        ];
        return back()->with(['toast' => $toastData]);
    }
