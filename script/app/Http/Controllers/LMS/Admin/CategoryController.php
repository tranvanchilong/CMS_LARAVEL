...
class CategoryController extends Controller
{
    public function index()
    {
        ...
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_categories_list');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/pages/categories.categories_list_page_title'),
            'categories' => $categories
        ];

        return view('lms.admin.categories.lists', $data);
    }

    public function create()
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_categories_create');


        $data = [
            'pageTitle' => trans('lms/admin/main.category_new_page_title'),
        ];

        return view('lms.admin.categories.create', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/lms/admin/categories');
    }

    public function edit(Request $request, $id)
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_categories_edit');
        ...
        $data = [
            'pageTitle' => trans('lms/admin/pages/categories.edit_page_title'),
            'category' => $category,
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_categories_delete');
        ...
        $toastData = [
            ...
            'msg' => !empty($parent) ? trans('lms/update.sub_category_successfully_deleted') : trans('lms/update.category_successfully_deleted'),
            'status' => 'success'
        ];

        return !empty($parent) ? back()->with(['toast' => $toastData]) : redirect('/lms/admin/categories')->with(['toast' => $toastData]);
    }
