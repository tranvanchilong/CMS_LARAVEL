...
use App\Models\LMS\WebinarAssignmentTranslation;
use App\Models\LMS\Webinar;
use App\Models\LMS\WebinarAssignment;
use App\Models\LMS\WebinarAssignmentAttachment;
...
class AssignmentController extends Controller
{
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_webinar_assignments_lists');
        ...
        $data = [
            'pageTitle' => trans('lms/update.assignments'),
        ...
        return view('lms.admin.webinars.assignments.lists', $data);
    }
    ...
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_webinar_assignments_students');
        ...
        $data = [
            'pageTitle' => trans('lms/update.students_assignments'),
        ...
        return view('lms.admin.webinars.assignments.students', $data);
    }

    public function conversations($assignmentId, $historyId)
    {
        $this->authorizeForUser(auth()->guard('lms_user')->user(),'admin_webinar_assignments_conversations');
        ...
        if (!empty($history)) {
            $data = [
                'pageTitle' => trans('lms/update.assignment_conversations'),
                'assignment' => $assignment,
                'conversations' => $history->messages,
            ];

            return view('lms.admin.webinars.assignments.conversation', $data);
        }
