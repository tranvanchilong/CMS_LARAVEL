...
use App\Http\Controllers\LMS\Web\traits\RegionsDataByUser;
...
class CartController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!empty($carts) and !$carts->isEmpty()) {
            ...
            if (!empty($calculate)) {
                ...
                return view('lms.web.default.cart.cart', $data);
            }
        }
    ...
    public function couponValidate(Request $request)
    {
        ...
        return response()->json([
            'status' => 422,
            'msg' => trans('lms/cart.coupon_invalid')
        ]);
    }
    ...
    private function handlePaymentOrderWithZeroTotalAmount($order)
    {
        ...
        return redirect('/lms/payments/status?order_id=' . $order->id);
    }
