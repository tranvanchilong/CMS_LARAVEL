...
class CertificateValidationController extends Controller
{
    public function index()
    {
        ...
        $pageTitle = !empty($getSeoMetas['title']) ? $getSeoMetas['title'] : trans('lms/site.certificate_validation_page_title');
        $pageDescription = !empty($getSeoMetas['description']) ? $getSeoMetas['description'] : trans('lms/site.certificate_validation_page_title');
        ...
        return view('lms.'. getTemplate() . '.auth.certificate_validation', $data);
    }
