...
class ContactController extends Controller
{
    public function index()
    {
        ...
        $pageTitle = !empty($seoSettings['title']) ? $seoSettings['title'] : trans('lms/site.contact_page_title');
        $pageDescription = !empty($seoSettings['description']) ? $seoSettings['description'] : trans('lms/site.contact_page_title');
        ...
        return view('lms.web.default.pages.contact', $data);
    }
