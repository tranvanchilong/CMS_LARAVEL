...
class BlogController extends Controller
{
    public function index(Request $request, $category = null)
    {
        ...
        $pageTitle = !empty($seoSettings['title']) ? $seoSettings['title'] : trans('lms/home.blog');
        $pageDescription = !empty($seoSettings['description']) ? $seoSettings['description'] : trans('lms/home.blog');
        ...
        return view('lms.'. getTemplate() . '.blog.index', $data);
    }
    ...
    public function show($slug)
    {
        if (!empty($slug)) {
            ...
            if (!empty($post)) {
                ...
                return view('lms.'. getTemplate() . '.blog.show', $data);
            }
            if (!empty($translate)) {
