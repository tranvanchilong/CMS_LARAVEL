...
class Product extends Model implements TranslatableContract
{
    ...
    {
        return $this->hasMany('App\Models\LMS\ProductFile', 'product_id', 'id');
    }

    public function media()
    {
        return $this->hasMany('App\Models\LMS\ProductMedia', 'product_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\LMS\ProductSelectedFilterOption', 'product_id', 'id');
    }

    public function selectedSpecifications()
    {
        return $this->hasMany('App\Models\LMS\ProductSelectedSpecification', 'product_id', 'id');
    }

    public function faqs()
    {
        return $this->hasMany('App\Models\LMS\ProductFaq', 'product_id', 'id');
    }

    public function discounts()
    {
        return $this->hasMany('App\Models\LMS\ProductDiscount', 'product_id', 'id');
    }

    public function comments()
    {
        return $this->hasMany('App\Models\LMS\Comment', 'product_id', 'id');
    }

    public function reviews()
    {
        return $this->hasMany('App\Models\LMS\ProductReview', 'product_id', 'id');
    }

    public function productOrders()
    {
        return $this->hasMany('App\Models\LMS\ProductOrder', 'product_id', 'id');
    }
