...
use App\Models\LMS\Accounting as Model;
...
class Accounting extends Model
{
    ...
    {
        return $this->belongsTo('App\Models\LMS\Api\Promotion', 'promotion_id', 'id');
    }

    public function subscribe()
    {
        return $this->belongsTo('App\Models\LMS\Api\Subscribe', 'subscribe_id', 'id');
    }

    public function meetingTime()
    {
        return $this->belongsTo('App\Models\LMS\Api\MeetingTime', 'meeting_time_id', 'id');
    }
