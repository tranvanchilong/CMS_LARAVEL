...
use App\Models\LMS\WebinarChapterItem as Model;
...
class WebinarChapterItem extends Model
{
    ...
    {
        return $this->belongsTo('App\Models\LMS\Api\Session', 'item_id', 'id');
    }

    public function file()
    {
        return $this->belongsTo('App\Models\LMS\Api\File', 'item_id', 'id');
    }

    public function textLesson()
    {
        return $this->belongsTo('App\Models\LMS\Api\TextLesson', 'item_id', 'id');
    }

    public function assignment()
    {
        return $this->belongsTo('App\Models\LMS\Api\WebinarAssignment', 'item_id', 'id');
    }

    public function quiz()
    {
        return $this->belongsTo('App\Models\LMS\Api\Quiz', 'item_id', 'id');
    }
