...
use App\Models\LMS\WebinarChapter as Model;
...
class WebinarChapter extends Model
{
    ...
    {
        return $this->hasMany('App\Models\LMS\Api\Session', 'chapter_id', 'id');
    }

    public function files()
    {
        return $this->hasMany('App\Models\LMS\Api\File', 'chapter_id', 'id');
    }

    public function textLessons()
    {
        return $this->hasMany('App\Models\LMS\Api\TextLesson', 'chapter_id', 'id');
    }

    public function quizzes()
    {
        return $this->hasMany('App\Models\LMS\Api\Quiz', 'chapter_id', 'id');
    }
    public function chapterItems()
    {
        return $this->hasMany('App\Models\LMS\Api\WebinarChapterItem', 'chapter_id', 'id');
    }
