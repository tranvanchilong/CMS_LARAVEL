...
use App\Models\LMS\User as Model;
use App\Models\LMS\ReserveMeeting;
use App\Models\LMS\Api\Follow;
...
class User extends Model implements JWTSubject
{
    ...
    {
        return $this->hasMany('App\Models\LMS\Api\QuizzesResult', 'user_id');

    }

    public function meeting()
    {
        return $this->hasOne('App\Models\LMS\Api\Meeting', 'creator_id', 'id');
    }

    public function webinars()
    {
        return $this->hasMany('App\Models\LMS\Api\Webinar', 'creator_id', 'id')
            ->orWhere('teacher_id', $this->id);
    }

    public function userCreatedQuizzes()
    {
        return $this->hasMany('App\Models\LMS\Api\Quiz', 'creator_id');
    ...
    {
        return $this->belongsTo('App\Models\LMS\Api\GroupUser', 'id', 'user_id');
    }
