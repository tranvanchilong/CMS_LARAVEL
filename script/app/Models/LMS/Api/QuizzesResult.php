...
use App\Models\LMS\QuizzesResult as WebQuizzesResult;
...
class QuizzesResult extends WebQuizzesResult
{
    ...
    {
        return $this->belongsTo('App\Models\LMS\Api\Quiz', 'quiz_id', 'id');
    }
    ...
    {
        return $this->hasOne('App\Models\LMS\Api\Certificate', 'quiz_result_id', 'id');
    }
