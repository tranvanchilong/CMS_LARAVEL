...
use App\Models\LMS\Quiz as Model;
...
class Quiz extends Model
{
    ...
    public function getAuthCanDownloadCertificateAttribute()
    {
        ...
        $user_passed_quiz = apiauth()->guard('lms_user')->quizResults->where('quiz_id', $this->id)->where('status', 'passed');
    ...
    {
       // $quiz->avg_grade = $quizResults->where('status', \App\Models\LMS\QuizzesResult::$passed)->avg('user_grade');
    ...
    {
        return $this->belongsTo('App\Models\LMS\Api\WebinarChapter', 'webinar_id', 'id');
    }

    public function quizResults()
    {
        return $this->hasMany('App\Models\LMS\Api\QuizzesResult', 'quiz_id', 'id');
    }

    public function quizQuestions()
    {
        return $this->hasMany('App\Models\LMS\Api\QuizzesQuestion', 'quiz_id', 'id');
    }
