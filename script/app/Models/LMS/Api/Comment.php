...
use App\Models\LMS\Comment as Model;
...
class Comment extends Model
{
    ...
    {
        return $this->belongsTo('App\Models\LMS\Api\WebinarReview', 'review_id', 'id');
    }

    public function blog()
    {
        return $this->belongsTo('App\Models\LMS\Api\Blog', 'blog_id', 'id');
    }
