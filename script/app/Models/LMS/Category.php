...
class Category extends Model implements TranslatableContract
{
    ...
    {
        return $this->belongsTo('App\Models\LMS\Category', 'parent_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\LMS\Filter', 'category_id', 'id');
    }

    public function webinars()
    {
        return $this->hasMany('App\Models\LMS\Webinar', 'category_id', 'id');
    }

    public function userOccupations()
    {
        return $this->hasMany('App\Models\LMS\UserOccupation', 'category_id', 'id');
    }
    ...
    {
        $categories = cache()->remember(domain_info('user_id').self::$cacheKey, 24 * 60 * 60, function () {
