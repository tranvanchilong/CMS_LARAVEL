...
class User extends Authenticatable
{
    ...
    public function getAvatar($size = 40)
    {
        if (!empty($this->avatar)) {
            $avatarUrl = get_path_lms().$this->avatar;
        } else {
            ...
            if (!empty($settings) and !empty($settings['user_avatar_style']) and $settings['user_avatar_style'] == "ui_avatar") {
                $avatarUrl = "/lms/getDefaultAvatar?item={$this->id}&name={$this->full_name}&size=$size";
            } else {
                if (!empty($settings) and !empty($settings['default_user_avatar'])) {
                    $avatarUrl = $settings['default_user_avatar'];
                } else {
                    $avatarUrl = "/assets/lms/assets/default/img/default/avatar-1.png";
                }
            }
        }
    ...
    {
        return $this->hasOne('App\Models\LMS\Meeting', 'creator_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\LMS\ReserveMeeting', 'user_id', 'id');
    }

    public function affiliateCode()
    {
        return $this->hasOne('App\Models\LMS\AffiliateCode', 'user_id', 'id');
    }

    public function affiliates()
    {
        return $this->hasOne('App\Models\LMS\Affiliate', 'affiliate_user_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\LMS\Webinar', 'creator_id', 'id')
            ->orWhere('teacher_id', $this->id);
    }

    public function products()
    {
        return $this->hasMany('App\Models\LMS\Product', 'creator_id', 'id');
    }

    public function productOrdersAsBuyer()
    {
        return $this->hasMany('App\Models\LMS\ProductOrder', 'buyer_id', 'id');
    }

    public function productOrdersAsSeller()
    {
        return $this->hasMany('App\Models\LMS\ProductOrder', 'seller_id', 'id');
    }

    public function forumTopics()
    {
        return $this->hasMany('App\Models\LMS\ForumTopic', 'creator_id', 'id');
    }

    public function forumTopicPosts()
    {
        return $this->hasMany('App\Models\LMS\ForumTopicPost', 'user_id', 'id');
    }

    public function blog()
    {
        return $this->hasMany('App\Models\LMS\Blog', 'author_id', 'id');
    }

    public function selectedBank()
    {
        return $this->hasOne('App\Models\LMS\UserSelectedBank', 'user_id', 'id');
    }

    public function installmentOrders()
    {
        return $this->hasMany('App\Models\LMS\InstallmentOrder', 'user_id', 'id');
    }
    ...
    {
        return $this->hasMany('App\Models\LMS\UserMeta');
    }

    public function carts()
    {
        return $this->hasMany('App\Models\LMS\Cart', 'creator_id', 'id');
    }

    public function userGroup()
    {
        return $this->belongsTo('App\Models\LMS\GroupUser', 'id', 'user_id');
    }

    public function certificates()
    {
        return $this->hasMany('App\Models\LMS\Certificate', 'student_id', 'id');
    }

    public function customBadges()
    {
        return $this->hasMany('App\Models\LMS\UserBadge', 'user_id', 'id');
    }

    public function supports()
    {
        return $this->hasMany('App\Models\LMS\Support', 'user_id', 'id');
    }

    public function occupations()
    {
        return $this->hasMany('App\Models\LMS\UserOccupation', 'user_id', 'id');
    }

    public function userRegistrationPackage()
    {
        return $this->hasOne('App\Models\LMS\UserRegistrationPackage', 'user_id', 'id');
    }
    ...
    {
        return $this->hasOne('App\Models\LMS\UserZoomApi', 'user_id', 'id');
    }
