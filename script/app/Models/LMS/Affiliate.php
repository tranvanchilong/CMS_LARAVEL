...
class Affiliate extends Model
{
    ...
    protected static function boot()
    {
        ...
        Affiliate::creating(function($model) {
            $model->domain_id = domain_info('domain_id');
        });
    }

    protected $table = 'lms_affiliates';
    ...
    {
        return $this->belongsTo('App\Models\LMS\User', 'affiliate_user_id', 'id');
    }

    public function referredUser()
    {
        return $this->belongsTo('App\Models\LMS\User', 'referred_user_id', 'id');
    }
