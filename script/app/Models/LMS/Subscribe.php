...
class Subscribe extends Model implements TranslatableContract
{
    ...
    protected static function boot()
    {
        ...
        Subscribe::creating(function($model) {
    ...
    protected $table = 'lms_subscribes';
    ...
    {
        return $this->hasMany('App\Models\LMS\Sale', 'subscribe_id', 'id');
    }

    public function uses()
    {
        return $this->hasMany('App\Models\LMS\SubscribeUse', 'subscribe_id', 'id');
    }
