                        ...
                        <div class="mt-30 d-flex align-items-center justify-content-end">
                            ${
                                (result.shipping_tracking_url && result.shipping_tracking_url !== '' && result.shipping_tracking_url !== 'null') ?
                                    `
                                            <div class="mr-20">
                                                <a href="/lms${result.shipping_tracking_url}" class="btn btn-primary btn-sm">${shippingTrackingUrlLang}</a>
                                            </div>
                                           `
                                    : ''
                            }
    ...
    $('body').on('click', '.js-got-the-parcel', function () {
        ...
        const html = `
                    <div>
                        ...
                        <div class="mt-30 d-flex align-items-center justify-content-end">
                            <button type="button" id="saveGotTheParcel" data-action="/lms${path}" class="btn btn-sm btn-primary">${confirmLang}</button>
