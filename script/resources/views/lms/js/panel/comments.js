(function ($) {
    ...
    $('body').on('click', '.js-reply-comment', function (e) {
        ...
        var html = '<div class="">\n' +
            ...
            '        <form id="commentForm" action="/lms/panel/webinars/comments/' + comment_id + '/reply" method="post" class="mt-20">\n' +
    ...
    $('body').on('click', '.js-edit-comment', function (e) {
        ...
        var html = '<div class="">\n' +
            ...
            '        <form action="/lms/panel/webinars/comments/' + comment_id + '/update" method="post" class="mt-20">\n' +
    ...
    $('body').on('click', '.report-comment', function (e) {
        ...
        const html = '<div id="reportModal">\n' +
            ...
            '\n' +
            '    <form action="/lms/panel/webinars/comments/' + comment_id + '/report" method="post">\n' +
            '        <div class="form-group">\n' +
