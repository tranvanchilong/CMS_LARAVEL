(function ($) {
    ...
    function makeHtml(title, image, description, button1, button2) {
        ...
        <div class="d-flex align-items-center justify-content-center">
            <img src="{{get_path_lms()}}${image ?? ''}" class="img-fluid rounded-lg" alt="">
        </div>
        ...
        <div class="row align-items-center mt-20">
            ...
            (button1 && button1.link && button1.title) ?
                `<div class="col-6">
                    <a href="/lms${button1.link}" class="btn btn-primary btn-block">${button1.title}</a>
                    </div>` : ''
        }
            ...
            (button2 && button2.link && button2.title) ?
                `<div class="col-6">
                        <a href="/lms${button2.link}" class="btn btn-primary btn-block">${button2.title}</a>
                        </div>` : ''
        }
        </div>
    </div>`;
