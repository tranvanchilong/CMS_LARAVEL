        ...
        return `<div class="map-instructor-card p-10">
            <div class="d-flex align-items-center flex-column px-24 px-lg-32">
                <div class="map-instructor-card-avatar rounded-circle mt-10">
                    <img src="{{get_path_lms()}}${user.avatar ?? ''}" class="img-cover rounded-circle" alt="${user.full_name ?? ''}">
                </div>
            ...
            <a href="/lms${user.profileUrl}" class="btn btn-primary btn-sm btn-block mt-20 text-white" target="_blank">${profileLang}</a>
        </div>`;
    }
