(function ($) {
    ...
    * */
    window.loadingSwl = () => {
        const loadingHtml = '<div class="d-flex align-items-center justify-content-center my-50 "><img src="/assets/lms/assets/default/img/loading.gif" width="80" height="80"></div>';
        Swal.fire({
            html: loadingHtml,
    ...
    * */
    ...
    if (jQuery().summernote) {
        var lfm = function (options, cb) {
            var route_prefix = (options && options.prefix) ? options.prefix : '/lms/laravel-filemanager';
    ...
    $('body').on('click', '.btn-add-product-to-cart', function (e) {
        ...
        const html = `
            <form action="/lms/cart/store" method="post" class="" id="productAddToCartForm">
