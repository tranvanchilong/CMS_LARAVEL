<div class="row no-gutters">
  <div class="col-xl-8">
    <div class="crop-container">
      <img src="{{get_path_lms()}}{{ $img->url . '?timestamp=' . $img->time }}" class="img img-responsive">
    </div>
  </div>
  <div class="col-xl-4">
    <div class="text-center">
      ...
      <div class="btn-group clearfix">
        ...
        <label class="btn btn-info btn-aspectRatio" onclick="changeAspectRatio(this, null)">
          {{ trans('lms/laravel-filemanager::lfm.btn-crop-free') }}
        </label>
      </div>
      <br>
      <br>
      <div class="btn-group clearfix">
        <button class="btn btn-secondary" onclick="loadItems()">{{ trans('lms/laravel-filemanager::lfm.btn-cancel') }}</button>
        <button class="btn btn-warning" onclick="performCropNew()">{{ trans('lms/laravel-filemanager::lfm.btn-copy-crop') }}</button>
        <button class="btn btn-primary" onclick="performCrop()">{{ trans('lms/laravel-filemanager::lfm.btn-crop') }}</button>
      </div>
      <form id='cropForm'>
