<div class="wizard-step-1">
    <h3 class="font-20 text-dark font-weight-bold">{{ trans('lms/update.skill_topic') }}</h3>

    <span class="d-block mt-30 text-gray wizard-step-num">
        {{ trans('lms/update.step') }} 1/4
    </span>

    <div class="form-group mt-30">
        <label class="input-label font-weight-500">{{ trans('lms/update.which_category_are_you_interested') }}</label>
