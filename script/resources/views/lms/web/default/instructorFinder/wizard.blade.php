@extends('lms.web.default.layouts.app',['appFooter' => false])

@section('content')
    <div class="instructor-finder-wizard row">
        <div class="col-12 col-lg-4 wizard-left-side d-none d-md-block" style="background-image: url('{{get_path_lms()}}{{ getPageBackgroundSettings('instructor_finder_wizard') }}')">
            <div class="wizard-left-side-content position-relative w-100 h-100 d-flex align-items-end justify-content-center">
                <div class="">
                    <h1 class="font-36 font-weight-bold text-white">{{ trans('lms/update.looking_for_an_instructor') }}</h1>
                    <p class="text-white font-16">{{ trans('lms/update.looking_for_an_instructor_hint') }}</p>
                    ...
                    <div class="mt-30 d-flex align-items-center justify-content-between">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <span class="font-14 text-white">{{ trans('lms/home.instructors') }}</span>
                        </div>
                        ...
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <span class="font-14 text-white">{{ trans('lms/home.organizations') }}</span>
                        </div>
                        ...
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <span class="font-14 text-white">{{ trans('lms/update.cities') }}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-lg-8 bg-white">
            <div class="row wizard-content d-flex align-items-lg-center justify-content-lg-center">
                <div class="col-12 col-lg-5">
                    ...
                    <form action="/lms/instructor-finder/wizard?{{ http_build_query(request()->all()) }}" method="get">
                        ...
                        @include('lms.web.default.instructorFinder.wizard.step_'.$step)

                        <div class="mt-50 pt-20 border-top border-gray300 d-flex align-items-center justify-content-end">
                            <a href="/lms{{ url()->previous() }}" class="js-prev-btn btn btn-gray300 btn-sm text-gray {{ ($step == 1) ? 'disabled' : '' }}" >{{ trans('lms/update.prev') }}</a>

                            <button type="submit" class="btn btn-primary btn-sm ml-10">{{ trans('lms/webinars.next') }}</button>
                        </div>
                    </form>
