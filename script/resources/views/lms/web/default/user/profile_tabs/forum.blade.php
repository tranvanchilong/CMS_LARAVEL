                ...
                <div class="col-12 col-md-6">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-10 mw-100">
                            ...
                            <span class="d-block font-14 text-gray">{{ trans('lms/public.by') }} {{ $user->full_name }} {{ trans('lms/public.in') }} {{ dateTimeFormat($topic->created_at,'j M Y | H:i') }}</span>
                        </div>
                    </div>
                </div>
...
@else
    @include('lms.' . getTemplate() . '.includes.no-result',[
        ...
        'title' => trans('lms/update.instructor_not_have_topics'),
        'hint' => '',
    ])
@endif
