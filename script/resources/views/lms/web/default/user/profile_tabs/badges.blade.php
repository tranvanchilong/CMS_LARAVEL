        ...
        @foreach($userBadges as $userBadge)
            ...
            <div class="col-6 col-lg-3 mt-20 mt-lg-0">
                <div class="rounded-lg badges-item py-20 py-lg-40 shadow-sm px-10 px-lg-25 d-flex flex-column align-items-center">
                    <img src="{{get_path_lms()}}{{ !empty($userBadge->badge_id) ? $userBadge->badge->image : $userBadge->image }}" class="rounded-circle" alt="{{ !empty($userBadge->badge_id) ? $userBadge->badge->title : $userBadge->title }}">
...
@else
    @include('lms.' . getTemplate() . '.includes.no-result',[
        'file_name' => 'badge.png',
        'title' => trans('lms/site.instructor_not_have_badge'),
        'hint' => '',
    ])
