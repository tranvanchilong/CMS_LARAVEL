        ...
        <div class="row login-container">
            ...
            <div class="col-12 col-md-6">
                <div class="login-card">
                    ...
                    <form method="Post" action="/lms/become_instructor" class="mt-35">
                        {{ csrf_field() }}

                        <div class="form-group">
                            <label class="font-weight-500 text-dark-blue">{{ trans('lms/site.occupations') }}</label>
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ trans('lms/public.certificate_and_documents') }}</label>
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ trans('lms/financial.select_account_type') }}</label>
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ trans('lms/financial.iban') }}</label>
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ trans('lms/financial.account_id') }}</label>
                        ...
                        <div class="form-group">
                            <label class="input-label">{{ trans('lms/site.extra_information') }}</label>
                            <textarea name="description" rows="6" class="form-control">{{ !empty($lastRequest) ? $lastRequest->description : old('description') }}</textarea>
                        </div>

                        <button type="submit" class="btn btn-primary btn-block mt-20">{{ trans('lms/site.send_request') }}</button>
                    </form>
