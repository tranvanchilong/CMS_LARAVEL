<section class="mt-45">
    <h3 class="section-title">{{ trans('lms/update.shipping_and_delivery') }}</h3>
    <div class="rounded-sm shadow mt-20 py-25 px-20">
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                <div class="form-group">
                    <label class="input-label font-weight-500">{{ trans('lms/update.address') }}</label>
                ...
                <div class="form-group">
                    <label class="input-label font-weight-500">{{ trans('lms/update.message_to_seller') }}</label>
...
@if(!empty($deliveryEstimateTime))
    <div class="d-flex align-items-center mt-30 rounded-lg border px-10 py-5">
        ...
        <div class="ml-15">
            <div class="font-16 font-weight-bold text-dark-blue">{{ trans('lms/update.cart_order_estimated_delivery_time') }}</div>
            <p class="font-14 font-weight-500 text-gray">{{ trans('lms/update.cart_order_estimated_delivery_time_hint',['days' => $deliveryEstimateTime]) }}</p>
        </div>
    </div>
@endif
