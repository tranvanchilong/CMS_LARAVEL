                            ...
                            <div class="col-xs-12 col-md-6" style="background: lightgreen; border-radius: 5px; padding: 10px;">
                                <div class="panel panel-primary">
                                    <div class="creditCardForm">
                                        <div class="payment">
                                            <form id="payment-card-info" method="post" action="/lms/payments/payment-request">
                                                {{ csrf_field() }}
                                                ...
                                                <!--    <img src="{{get_path_lms()}}{{ asset('images/visa.jpg') }}" id="visa">-->
                                                <!--    <img src="{{get_path_lms()}}{{ asset('images/mastercard.jpg') }}" id="mastercard">-->
                                                <!--    <img src="{{get_path_lms()}}{{ asset('images/amex.jpg') }}" id="amex">-->
                                                    <!--</div>-->
                                                </div>
