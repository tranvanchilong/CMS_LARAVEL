...
@section('content')
    ...
    @if(!empty($overdueInstallments) and count($overdueInstallments))
        <div class="d-flex align-items-center mb-20 p-15 danger-transparent-alert">
            ...
            <div class="ml-10">
                ...
                <div class="font-12 ">{{ trans('lms/update.you_have_count_overdue_installments_please_pay_them_to_avoid_restrictions_and_negative_effects_on_your_account',['count' => count($overdueInstallments)]) }}</div>
            </div>
        </div>
    @endif
            ...
            <div class="row">
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/update.total_parts') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/update.remained_parts') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/update.remained_amount') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/update.overdue_amount') }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mt-25">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{ trans('lms/update.installments_list') }}</h2>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table text-center custom-table">
                            ...
                            <tr>
                                ...
                                <th class="text-center">{{ trans('lms/panel.amount') }}</th>
                                        ...
                                        @if(empty($stepPayment))
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu menu-lg">
                                                    ...
                                                    <a href="/lms/panel/financial/installments/{{ $order->id }}/steps/{{ $step->id }}/pay" target="_blank"
                                                       class="webinar-actions d-block mt-10 font-weight-normal">{{ trans('lms/panel.pay') }}</a>
                                                </div>
                                            </div>
                                        @endif
                                    </td>
