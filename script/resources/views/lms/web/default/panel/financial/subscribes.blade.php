...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-4 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <span class="font-16 text-gray font-weight-500">{{ trans('lms/financial.remained_downloads') }}</span>
                        </div>
                    </div>
    ...
    @else
        @include('lms.' . getTemplate() . '.includes.no-result',[
           ...
           'title' => trans('lms/financial.subcribe_no_result'),
           'hint' => nl2br(trans('lms/financial.subcribe_no_result_hint')),
       ])
    @endif

    <section class="mt-30">
        <h2 class="section-title">{{ trans('lms/financial.select_a_subscribe_plan') }}</h2>
            ...
            @foreach($subscribes as $subscribe)
                ...
                <div class="col-12 col-sm-6 col-lg-3 mt-15">
                    <div class="subscribe-plan position-relative bg-white d-flex flex-column align-items-center rounded-sm shadow pt-50 pb-20 px-20">
                        ...
                        <form action="/lms/panel/financial/pay-subscribes" method="post" class="btn-block">
                            {{ csrf_field() }}
