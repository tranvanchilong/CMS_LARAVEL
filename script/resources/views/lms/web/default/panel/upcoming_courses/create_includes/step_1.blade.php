    ...
    <div class="col-12 col-md-4 mt-15">
        ...
        <div class="form-group mt-15 ">
            ...
            <select name="type" class="custom-select @error('type')  is-invalid @enderror">
                <option value="webinar" @if(!empty($upcomingCourse) and $upcomingCourse->type == 'webinar') selected @endif>{{ trans('lms/webinars.webinar') }}</option>
                <option value="course" @if(!empty($upcomingCourse) and $upcomingCourse->type == 'course') selected @endif>{{ trans('lms/webinars.video_course') }}</option>
                <option value="text_lesson" @if(!empty($upcomingCourse) and $upcomingCourse->type == 'text_lesson') selected @endif>{{ trans('lms/webinars.text_lesson') }}</option>
            </select>
        ...
        @if($isOrganization)
            <div class="form-group mt-15 ">
                ...
                <select name="teacher_id" class="custom-select @error('teacher_id')  is-invalid @enderror">
                    <option value="" {{ (!empty($upcomingCourse) and !empty($upcomingCourse->teacher_id)) ? '' : 'selected' }}>{{ trans('lms/public.choose_instructor') }}</option>
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" name="seo_description" value="{{ (!empty($upcomingCourse) and !empty($upcomingCourse->translate($locale))) ? $upcomingCourse->translate($locale)->seo_description : old('seo_description') }}" class="form-control @error('seo_description')  is-invalid @enderror " placeholder="{{ trans('lms/forms.50_160_characters_preferred') }}"/>
        ...
        <div class="form-group mt-15">
            ...
            <div class="input-group">
                ...
                <input type="text" name="thumbnail" id="thumbnail" value="{{ !empty($upcomingCourse) ? $upcomingCourse->thumbnail : old('thumbnail') }}" class="form-control @error('thumbnail')  is-invalid @enderror" placeholder="{{ trans('lms/forms.course_thumbnail_size') }}"/>
                @error('thumbnail')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="form-group mt-15">
            ...
            <div class="input-group">
                ...
                <input type="text" name="image_cover" id="cover_image" value="{{ !empty($upcomingCourse) ? $upcomingCourse->image_cover : old('image_cover') }}" placeholder="{{ trans('lms/forms.course_cover_size') }}" class="form-control @error('image_cover')  is-invalid @enderror"/>
                @error('image_cover')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
...
<div class="row">
    <div class="col-12">
        <div class="form-group">
            ...
            <textarea id="summernote" name="description" class="form-control @error('description')  is-invalid @enderror" placeholder="{{ trans('lms/forms.webinar_description_placeholder') }}">{!! (!empty($upcomingCourse) and !empty($upcomingCourse->translate($locale))) ? $upcomingCourse->translate($locale)->description : old('description')  !!}</textarea>
            @error('description')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
