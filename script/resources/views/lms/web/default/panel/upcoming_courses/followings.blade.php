...
@section('content')
    ...
    <section>
        <div class="d-flex align-items-center justify-content-between">
            <h2 class="section-title">{{ trans('lms/update.following_courses') }}</h2>
        </div>
                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        ...
                                        <span class="stat-value">{{ (!empty($upcomingCourse->price) and $upcomingCourse->price > 0) ? handlePrice($upcomingCourse->price) : trans('lms/free') }}</span>
                                    </div>
        ...
        @else
            @include('lms.' . getTemplate() . '.includes.no-result',[
                ...
                'title' => trans('lms/update.no_result_following_course'),
                'hint' =>  trans('lms/update.no_result_following_course_hint') ,
            ])
        @endif
