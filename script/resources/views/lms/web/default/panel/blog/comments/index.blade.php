...
@section('content')
    <section class="mt-25">
        ...
        <div class="panel-section-card py-20 px-25 mt-20">
            <form action="/lms/panel/blog/comments" method="get" class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="form-group">
                        <label class="input-label">{{ trans('lms/admin/main.post') }}</label>
                        <select name="blog_id" class="form-control select2" data-placeholder="{{ trans('lms/update.select_post') }}">
                            <option {{ empty($selectedPost) ? 'selected' : '' }} value="">{{ trans('lms/public.all') }}</option>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{ trans('lms/update.blog_comments_list') }}</h2>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table text-center ">
                                ...
                                <tr>
                                    ...
                                    <th class="text-left">{{ trans('lms/admin/main.post') }}</th>
                                ...
                                @foreach($comments as $comment)
                                    <tr>
                                        ...
                                        <td class=" text-left align-middle" width="35%">
                                            <a href="/lms{{ $comment->blog->getUrl() }}" target="_blank" class="text-dark-blue font-weight-500">{{ $comment->blog->title }}</a>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            @else
                                                <span class="text-dark-blue font-weight-500">{{ trans('lms/public.pending') }}</span>
                                            @endif
                                        </td>
...
@push('scripts_bottom')
    ...
    <script src="/assets/lms/assets/default/js/panel/blog_comments.min.js"></script>
@endpush
