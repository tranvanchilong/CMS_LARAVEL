...
@section('content')
    <section>
        ...
        <div class="panel-section-card py-20 px-25 mt-20">
            <form action="/lms/panel/quizzes/opens" method="get" class="row">
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{ trans('lms/quiz.open_quizzes') }}</h2>
        </div>
                                        ...
                                        <td class="align-middle text-right font-weight-normal">
                                            <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="/lms/panel/quizzes/{{ $quiz->id }}/start" class="webinar-actions d-block mt-10">{{ trans('lms/public.start') }}</a>
                                                    <a href="/lms{{ $quiz->webinar->getUrl() }}" target="_blank" class="webinar-actions d-block mt-10">{{ trans('lms/webinars.webinar_page') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
