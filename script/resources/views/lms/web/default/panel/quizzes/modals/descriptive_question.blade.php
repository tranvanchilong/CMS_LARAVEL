<div class="@if(!empty($quiz)) descriptiveQuestionModal{{ $quiz->id }} @endif {{ empty($question_edit) ? 'd-none' : ''}}">
    <div class="custom-modal-body">
        <h2 class="section-title after-line">{{ trans('lms/quiz.new_descriptive_question') }}</h2>
        ...
        <div class="quiz-questions-form" data-action="/lms/panel/quizzes-questions/{{ empty($question_edit) ? 'store' : $question_edit->id.'/update' }}">
            ...
            <input type="hidden" name="ajax[type]" value="{{ \App\Models\LMS\QuizzesQuestion::$descriptive }}">
            <div class="row mt-25">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <label class="input-label">{{ trans('lms/quiz.correct_answer') }}</label>
