...
@section('content')
    ...
    <section class="mt-25">
        ...
        <div class="panel-section-card py-20 px-25 mt-20">
            <form action="/lms/panel/webinars/comments" method="get" class="row">
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{ trans('lms/panel.webinar_comments_list') }}</h2>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table text-center ">
                                ...
                                <tr>
                                    ...
                                    <th class="text-left">{{ trans('lms/panel.webinar') }}</th>
                                ...
                                @foreach($comments as $comment)
                                    <tr>
                                        ...
                                        <td class=" text-left align-middle" width="35%">
                                            <a href="/lms{{ $comment->webinar->getUrl() }}" target="_blank" class="text-dark-blue font-weight-500">{{ $comment->webinar->title }}</a>
                                        </td>
                                        ...
                                        <td class="align-middle text-right">
                                            ...
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <button type="button" data-item-id="{{ $comment->webinar_id }}" data-comment-id="{{ $comment->id }}" class="btn-transparent webinar-actions d-block mt-10 text-hover-primary report-comment">{{ trans('lms/panel.report') }}</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
