...
<div class="row">
    <div class="col-12 col-md-6 mt-15">
        ...
        <div class="form-group mt-15">
            ...
            <input type="number" name="capacity" value="{{ (!empty($webinar) and !empty($webinar->capacity)) ? $webinar->capacity : old('capacity') }}" class="form-control @error('capacity')  is-invalid @enderror" placeholder="{{ trans('lms/forms.capacity_placeholder') }}"/>
            @error('capacity')
        ...
        <div>
            <p class="font-12 text-gray">- {{ trans('lms/update.panel_course_forum_hint') }}</p>
        </div>
        ...
        <div>
            <p class="font-12 text-gray">- {{ trans('lms/update.certificate_completion_hint') }}</p>
        </div>
        ...
        <div class="form-group mt-30 d-flex align-items-center justify-content-between">
            <label class="cursor-pointer input-label" for="partnerInstructorSwitch">{{ trans('lms/public.partner_instructor') }}</label>
            <div class="custom-control custom-switch">
        ...
        <div id="partnerInstructorInput" class="form-group mt-15 {{ ((!empty($webinar) && $webinar->partner_instructor) or old('partner_instructor') == 'on') ? '' : 'd-none' }}">
            ...
            <select name="partners[]" class="form-control panel-search-user-select2 @error('partners')  is-invalid @enderror" multiple="" data-search-option="just_teachers" data-placeholder="{{ trans('lms/public.search_instructor') }}">
            ...
            <div class="text-gray font-12 mt-1">{{ trans('lms/admin/main.invited_instructor_hint') }}</div>
            @error('partners')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" name="tags" data-max-tag="5" value="{{ !empty($webinar) ? implode(',',$webinarTags) : '' }}" class="form-control inputtags" placeholder="{{ trans('lms/public.type_tag_name_and_press_enter') }} ({{ trans('lms/forms.max') }} : 5)"/>
        </div>
        ...
        <div class="form-group mt-15">
            ...
            <select id="categories" class="custom-select @error('category_id')  is-invalid @enderror" name="category_id" required>
                <option {{ (!empty($webinar) and !empty($webinar->category_id)) ? '' : 'selected' }} disabled>{{ trans('lms/public.choose_category') }}</option>
