<div class="d-none" id="webinarNextSessionModal">
    <form action="/lms/panel/sessions/store" method="post">
        {{ csrf_field() }}
        ...
        <h3 class="section-title after-line font-16 text-dark-blue mb-25">{{ trans('lms/webinars.next_session_info') }}</h3>
        ...
        <div class="row">
            <div class="col-6 js-local-link">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <button type="button" class="input-group-text js-copy" data-input="ajax[new][link]" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/public.copy') }}" data-copy-text="{{ trans('lms/public.copy') }}" data-done-text="{{ trans('lms/public.copied') }}">
            ...
            <div class="col-6">
                <div class="form-group">
                    <label class="input-label">{{ trans('lms/public.duration') }}</label>
                ...
                <div class="form-group">
                    ...
                    <select name="ajax[new][session_api]" class="js-ajax-session_api form-control">
                        @foreach(getFeaturesSettings("available_session_apis") as $sessionApi)
                            <option value="{{ $sessionApi }}">{{ trans('lms/update.session_api_'.$sessionApi) }}</option>
                        @endforeach
                    </select>
                    <div class="invalid-feedback"></div>
                </div>
        ...
        <div class="mt-30 d-flex align-items-center justify-content-end">
            <button type="button" class="js-save-next-session btn btn-sm btn-primary">{{ trans('lms/public.save') }}</button>
