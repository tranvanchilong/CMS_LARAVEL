...
@section('content')
            ...
            <div class="col-12 col-md-3 mt-20">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="d-flex align-items-center flex-column">
                        ...
                        @include('lms.web.default.includes.webinar.rate',['rate' => $courseRate, 'className' => 'mt-5', 'dontShowRate' => true, 'showRateStars' => true])
                    </div>
            ...
            <div class="col-12 col-md-3 mt-20">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="d-flex align-items-center flex-column">
                        ...
                        <span class="mt-5 font-16 font-weight-500 text-gray">{{ trans('lms/quiz.quizzes') }}</span>
                    </div>
            ...
            <div class="col-12 col-md-3 mt-20">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="d-flex align-items-center flex-column">
                        ...
                        <span class="mt-5 font-16 font-weight-500 text-gray">{{ trans('lms/update.assignments') }}</span>
                    </div>
            ...
            <div class="col-12 col-md-3 mt-20">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="d-flex align-items-center flex-column">
                        ...
                        <span class="mt-5 font-16 font-weight-500 text-gray">{{ trans('lms/update.forum_messages') }}</span>
                    </div>
    ...
    <section>
        <div class="row">
            @include('lms.web.default.panel.webinar.course_statistics.includes.pie_charts',[
    ...
    <section>
        <div class="row">
            <div class="col-12 col-md-6 mt-20">
                <div class="course-statistic-cards-shadow monthly-sales-card pt-15 px-15 pb-25 rounded-sm bg-white">
                    <div class="d-flex align-items-center justify-content-between">
                        <h3 class="font-16 text-dark-blue font-weight-bold">{{ trans('lms/panel.monthly_sales') }}</h3>
            ...
            <div class="col-12 col-md-6 mt-20">
                <div class="course-statistic-cards-shadow monthly-sales-card pt-15 px-15 pb-25 rounded-sm bg-white">
                    <div class="d-flex align-items-center justify-content-between">
                        <h3 class="font-16 text-dark-blue font-weight-bold">{{ trans('lms/update.course_progress') }} (%)</h3>
                    </div>
    ...
    <section class="mt-35">
        ...
        @if(!empty($students) and !$students->isEmpty())
            ...
            <div class="my-30">
                {{ $students->appends(request()->input())->links('lms.vendor.pagination.panel') }}
            </div>
        @else
