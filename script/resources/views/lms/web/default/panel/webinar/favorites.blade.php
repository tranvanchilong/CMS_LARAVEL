...
@section('content')
    ...
    <section>
        <div class="d-flex align-items-center justify-content-between">
            <h2 class="section-title">{{ trans('lms/panel.favorite_live_classes') }}</h2>
        </div>
                ...
                <div class="row mt-30">
                    <div class="col-12">
                        <div class="webinar-card webinar-list d-flex">
                            <div class="image-box">
                                <img src="{{get_path_lms()}}{{ $favorite->webinar->getImage() }}" class="img-cover" alt="">
                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                <div class="d-flex align-items-center justify-content-between">
                                    <a href="/lms{{ $favorite->webinar->getUrl() }}" target="_blank">
                                    ...
                                    <div class="btn-group dropdown table-actions">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="/lms/panel/webinars/favorites/{{ $favorite->id }}/delete" class="webinar-actions d-block delete-action">{{ trans('lms/public.remove') }}</a>
                                        </div>
                                    </div>
                                </div>

                                @include('lms.' . getTemplate() . '.includes.webinar.rate',['rate' => $favorite->webinar->getRate()])
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        ...
                                        <span class="stat-value">{{ convertMinutesToHourAndMinute($favorite->webinar->duration) }} {{ trans('lms/home.hours') }}</span>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        ...
                                        @else
                                            <span class="stat-title">{{ trans('lms/public.created_at') }}:</span>
                                        @endif
        ...
        @else
            @include('lms.' . getTemplate() . '.includes.no-result',[
                ...
                'title' => trans('lms/panel.no_result_favorites'),
                'hint' =>  trans('lms/panel.no_result_favorites_hint') ,
            ])
        @endif
    ...
    <div class="my-30">
        {{ $favorites->appends(request()->input())->links('lms.vendor.pagination.panel') }}
    </div>
@endsection
