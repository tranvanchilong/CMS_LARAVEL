<div class="panel-section-card py-20 px-25 mt-20">
    <form action="/lms/panel/manage/{{ $user_type }}" method="get" class="row">
                ...
                <div class="col-12 col-lg-3">
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control">
                            ...
                            <option value="active" @if(request()->get('type',null) == 'active') selected @endif>{{ trans('lms/public.active') }}</option>
                            <option value="inactive" @if(request()->get('type',null) == 'inactive') selected @endif>{{ trans('lms/public.inactive') }}</option>
                            <option value="verified" @if(request()->get('type',null) == 'verified') selected @endif>{{ trans('lms/public.verified') }}</option>
                        </select>
                    </div>
                </div>
            </div>
