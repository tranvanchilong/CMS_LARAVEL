...
@section('content')
    ...
    <section>
        <h2 class="section-title">{{ trans('lms/public.instructors') }}</h2>
            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/public.instructors') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/lms/assets/default/img/activity/89.svg" width="64" height="64" alt="">
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ $verifiedCount }}</strong>
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/public.verified') }}</span>
                    </div>
                </div>
    ...
    <section class="mt-35">
        <h2 class="section-title">{{ trans('lms/panel.filter_instructors') }}</h2>

        @include('lms.web.default.panel.manage.filters')
    </section>

    <section class="mt-35">
        <h2 class="section-title">{{ trans('lms/panel.instructors_list') }}</h2>
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table text-center ">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center text-gray">{{ trans('lms/panel.sales') }}</th>
                                    <th class="text-center text-gray">{{ trans('lms/panel.sales_amount') }}</th>
                                        ...
                                        <td class="text-left">
                                            <div class="user-inline-avatar d-flex align-items-center">
                                                ...
                                                <div class=" ml-5">
                                                    ...
                                                    <span class="mt-5 d-block font-12 {{ ($user->verified ? ' text-primary ' : ' text-warning ') }}">{{ trans('lms/public.'.($user->verified ? 'verified' : 'not_verified')) }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-left">
                                        ...
                                        <td class="text-right align-middle">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="/lms/panel/manage/instructors/{{ $user->id }}/edit" class="btn-transparent webinar-actions d-block mt-10">{{ trans('lms/public.edit') }}</a>
                                                    <a href="/lms/panel/manage/instructors/{{ $user->id }}/delete" class="webinar-actions d-block mt-10 delete-action">{{ trans('lms/public.delete') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        @else
            @include('lms.' . getTemplate() . '.includes.no-result',[
                ...
                'title' => trans('lms/panel.instructors_no_result'),
                'hint' =>  nl2br(trans('lms/panel.instructors_no_result_hint')),
                'btn' => ['url' => '/lms/panel/manage/instructors/new','text' => trans('lms/panel.add_an_instructor')]
            ])
        @endif
    </section>
