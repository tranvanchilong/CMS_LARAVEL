...
@section('content')
    <section>
        <h2 class="section-title">{{ trans('lms/quiz.certificates_statistics') }}</h2>

        <div class="activities-container mt-25 p-20 p-lg-35">
            <div class="row">
                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/lms/assets/default/img/activity/56.svg" width="64" height="64" alt="">
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ $activeQuizzes }}</strong>
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/quiz.active_certificates') }}</span>
                    </div>
                </div>

                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        <img src="/assets/lms/assets/default/img/activity/57.svg" width="64" height="64" alt="">
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5">{{ $achievementsCount }}</strong>
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/quiz.student_achievements') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-lg-3 d-flex align-items-center justify-content-center mt-5 mt-lg-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/quiz.failed_students') }}</span>
                    </div>
                </div>
    ...
    <section class="mt-25">
        <h2 class="section-title">{{ trans('lms/quiz.filter_certificates') }}</h2>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                ...
                                <select name="webinar_id" class="form-control">
                                    <option value="all">{{ trans('lms/webinars.all_courses') }}</option>
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        <label class="input-label">{{ trans('lms/quiz.quiz') }}</label>
                                        <select id="quizFilter" name="quiz_id" class="form-control" @if(empty(request()->get('quiz_id'))) disabled @endif>
                                            <option value="all">{{ trans('lms/quiz.all_quizzes') }}</option>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{ trans('lms/quiz.active_certificates') }}</h2>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">{{ trans('lms/quiz.generated_certificates') }}</th>
                                ...
                                @foreach($quizzes as $quiz)
                                    <tr>
                                        <td class="text-left">
                                            ...
                                            <span class="d-block mt-5 font-12 text-gray">{{ !empty($quiz->webinar) ? $quiz->webinar->title : trans('lms/update.delete_item') }}</span>
                                        </td>
        ...
        @else
            @include('lms.' . getTemplate() . '.includes.no-result',[
                ...
                'title' => trans('lms/quiz.certificates_no_result'),
                'hint' => nl2br(trans('lms/quiz.certificates_no_result_hint')),
            ])
        @endif
    </section>
...
@push('scripts_bottom')
    ...
    <script src="/assets/lms/assets/default/js/panel/certificates.min.js"></script>
@endpush
