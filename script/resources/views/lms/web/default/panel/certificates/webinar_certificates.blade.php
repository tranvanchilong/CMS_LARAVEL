...
@section('content')
                    ...
                    <div class="col-12 ">
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                <thead>
                                <tr>
                                    <th>{{ trans('lms/product.course') }}</th>
                                        ...
                                        <td class="align-middle font-weight-normal">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="/lms/panel/certificates/webinars/{{ $certificate->id }}/show" target="_blank" class="webinar-actions d-block">{{ trans('lms/public.open') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <div class="my-30">
        {{ $certificates->appends(request()->input())->links('lms.vendor.pagination.panel') }}
    </div>
