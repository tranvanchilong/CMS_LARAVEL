...
@section('content')
    <section>
        <h2 class="section-title">{{ trans('lms/quiz.my_certificates_statistics') }}</h2>
            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 font-weight-bold text-gray">{{ trans('lms/panel.certificates') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 font-weight-bold text-gray">{{ trans('lms/quiz.average_grade') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 font-weight-bold text-gray">{{ trans('lms/quiz.failed_quizzes') }}</span>
                    </div>
                </div>
    ...
    <section class="mt-35">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{ trans('lms/quiz.my_certificates') }}</h2>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">{{ trans('lms/public.certificate_id') }}</th>
                                    <th class="text-center">{{ trans('lms/quiz.minimum_grade') }}</th>
                                    <th class="text-center">{{ trans('lms/quiz.average_grade') }}</th>
                                            ...
                                            @if($quiz->can_download_certificate)
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="/lms/panel/quizzes/results/{{ $quiz->result->id }}/showCertificate" target="_blank" class="webinar-actions d-block">{{ trans('lms/public.open') }}</a>
                                                    </div>
                                                </div>
                                            @endif
                                        </td>
        ...
        @else
            @include('lms.' . getTemplate() . '.includes.no-result',[
                'file_name' => 'cert.png',
                'title' => trans('lms/quiz.my_certificates_no_result'),
                'hint' => nl2br(trans('lms/quiz.my_certificates_no_result_hint')),
            ])
        @endif
    </section>
