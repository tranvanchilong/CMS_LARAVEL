...
@section('content')
    ...
    <section class="mt-25">
        ...
        <div class="panel-section-card py-20 px-25 mt-20">
            <form action="/lms/panel/support/tickets" method="get">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label class="input-label d-block">{{ trans('lms/panel.department') }}</label>
                    ...
                    <div class="col-12 col-lg-2 d-flex align-items-center justify-content-end">
                        <button type="submit" class="btn btn-sm font-14 btn-primary w-100 mt-2">{{ trans('lms/public.show_results') }}</button>
                    </div>
                </div>
            </form>
        </div>
                    ...
                    <div id="conversationsList" class="col-12 col-lg-6 conversations-list">
                        <div class="table-responsive">
                            <table class="table table-md">
                                <tr>
                                    <th class="text-left font-14 text-gray font-weight-500">{{ trans('lms/navbar.title') }}</th>
                                    <th class="text-center font-14 text-gray font-weight-500">{{ trans('lms/public.updated_at') }}</th>
                                    <th class="text-center font-14 text-gray font-weight-500">{{ trans('lms/panel.department') }}</th>
                                    <th class="text-center font-14 text-gray font-weight-500">{{ trans('lms/public.status') }}</th>
                                </tr>
                                <tbody>
                                ...
                                @foreach($supports as $support)
                                    <tr class="@if(!empty($selectSupport) and $selectSupport->id == $support->id) selected-row @endif">
                                        <td class="text-left">
                                            <a href="/lms/panel/support/tickets/{{ $support->id }}/conversations" class="">
                                                <div class="user-inline-avatar d-flex align-items-center">
                                                    <div class="avatar bg-gray200">
                                                        <img src="/assets/lms/assets/default/img/support.png" class="img-cover" alt="">
                                                    </div>
                                                    <div class="ml-10">
                                        ...
                                        <td class="text-center align-middle">
                                            @if($support->status == 'close')
                                                <span class="text-danger font-14 font-weight-500">{{  trans('lms/panel.closed') }}</span>
                                            @elseif($support->status == 'supporter_replied')
                                                <span class="text-primary font-14 font-weight-500">{{  trans('lms/panel.replied') }}</span>
                                            @else
                                                <span class="text-warning font-14 font-weight-500">{{  trans('lms/public.waiting') }}</span>
                                            @endif
                                        </td>
                        ...
                        <div class="col-12 col-lg-6 border-left border-gray300">
                            <div class="conversation-box p-15 d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <span class="font-12 text-gray d-block mt-5">{{ trans('lms/public.created') }}: {{ dateTimeFormat($support->created_at,'j M Y | H:i') }}</span>
