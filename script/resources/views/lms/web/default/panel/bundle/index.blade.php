...
@section('content')
            ...
            <div class="row">
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/update.bundles') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/update.bundle_sales') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-30 mt-md-0 d-flex align-items-center justify-content-center mt-5 mt-md-0">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="font-16 text-gray font-weight-500">{{ trans('lms/update.bundle_sales_count') }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mt-25">
        <div class="d-flex align-items-start align-items-md-center justify-content-between flex-column flex-md-row">
            <h2 class="section-title">{{ trans('lms/update.my_bundles') }}</h2>
        </div>
        ...
        @if(!empty($bundles) and !$bundles->isEmpty())
                        ...
                        <div class="webinar-card webinar-list d-flex">
                            <div class="image-box">
                                ...
                                @switch($bundle->status)
                                    @case(\App\Models\LMS\Bundle::$active)
                                    <span class="badge badge-primary">{{  trans('lms/panel.active') }}</span>
                                    @break
                            ...
                            <div class="webinar-card-body w-100 d-flex flex-column">
                                <div class="d-flex align-items-center justify-content-between">
                                    <a href="/lms{{ $bundle->getUrl() }}" target="_blank">
                                    ...
                                    @if($authUser->id == $bundle->creator_id or $authUser->id == $bundle->teacher_id)
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu ">
                                                ...
                                                <a href="/lms/panel/bundles/{{ $bundle->id }}/edit" class="webinar-actions d-block mt-10">{{ trans('lms/public.edit') }}</a>

                                                <a href="/lms/panel/bundles/{{ $bundle->id }}/courses" class="webinar-actions d-block mt-10">{{ trans('lms/product.courses') }}</a>


                                                @if($authUser->id == $bundle->teacher_id or $authUser->id == $bundle->creator_id)
                                                    <a href="/lms/panel/bundles/{{ $bundle->id }}/export-students-list" class="webinar-actions d-block mt-10">{{ trans('lms/public.export_list') }}</a>
                                                @endif

                                                @if($bundle->creator_id == $authUser->id)
                                                    <a href="/lms/panel/bundles/{{ $bundle->id }}/delete" class="webinar-actions d-block mt-10 text-danger delete-action">{{ trans('lms/public.delete') }}</a>
                                                @endif
                                            </div>
                                        </div>
                                    @endif
                                ...
                                @include('lms.' . getTemplate() . '.includes.webinar.rate',['rate' => $bundle->getRate()])
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap mt-auto">
                                    ...
                                    <div class="d-flex align-items-start flex-column mt-20 mr-15">
                                        <span class="stat-title">{{ trans('lms/product.courses') }}:</span>
            ...
            <div class="my-30">
                {{ $bundles->appends(request()->input())->links('lms.vendor.pagination.panel') }}
            </div>

        @else
            @include('lms.' . getTemplate() . '.includes.no-result',[
                'file_name' => 'webinar.png',
                'title' => trans('lms/update.you_not_have_any_bundle'),
                'hint' =>  trans('lms/update.no_result_bundle_hint') ,
                'btn' => ['url' => '/lms/panel/bundles/new','text' => trans('lms/update.create_a_bundle') ]
            ])
        @endif
