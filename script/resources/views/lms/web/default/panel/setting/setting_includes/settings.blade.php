...
<section class="mt-30">
    <h2 class="section-title after-line">{{ trans('lms/update.settings') }}</h2>

    <div class="row mt-20">
        <div class="col-12 col-lg-4">

            <div class="form-group mb-30 mt-30">
                <label class="input-label">{{ trans('lms/update.gender') }}:</label>
                ...
                <div class="d-flex align-items-center">
                    <div class="custom-control custom-radio">
                        ...
                        <label class="custom-control-label font-14 cursor-pointer" for="man">{{ trans('lms/update.man') }}</label>
                    </div>
                    ...
                    <div class="custom-control custom-radio ml-15">
                        ...
                        <label class="custom-control-label font-14 cursor-pointer" for="woman">{{ trans('lms/update.woman') }}</label>
                    </div>
                </div>
            </div>

            <div class="form-group mb-30">
                <label class="input-label">{{ trans('lms/update.age') }}:</label>
            ...
            <div class="form-group mb-30">
                ...
                <div class="d-flex align-items-center">
                    <div class="custom-control custom-radio">
                        ...
                        <label class="custom-control-label font-14 cursor-pointer" for="in_person">{{ trans('lms/update.in_person') }}</label>
                    </div>
                    ...
                    <div class="custom-control custom-radio ml-10">
                        ...
                        <label class="custom-control-label font-14 cursor-pointer" for="online">{{ trans('lms/update.online') }}</label>
                    </div>
                    ...
                    <div class="custom-control custom-radio ml-10">
                        ...
                        <label class="custom-control-label font-14 cursor-pointer" for="all">{{ trans('lms/public.all') }}</label>
                    </div>
                </div>
            </div>

            <div class="form-group mb-30">
                <label class="input-label">{{ trans('lms/update.level_of_training') }}:</label>
                ...
                <div class="d-flex align-items-center">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label font-14 cursor-pointer" for="beginner">{{ trans('lms/update.beginner') }}</label>
                    </div>
                    ...
                    <div class="custom-control custom-checkbox ml-10">
                        ...
                        <label class="custom-control-label font-14 cursor-pointer" for="middle">{{ trans('lms/update.middle') }}</label>
                    </div>
                    ...
                    <div class="custom-control custom-checkbox ml-10">
                        ...
                        <label class="custom-control-label font-14 cursor-pointer" for="expert">{{ trans('lms/update.expert') }}</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <h2 class="section-title after-line">{{ trans('lms/update.region') }}</h2>

    <div class="row mt-30">
        <div class="col-12 col-lg-4">
            <div class="form-group ">
                <label class="input-label">{{ trans('lms/update.country') }}:</label>
            ...
            <div class="form-group mt-30">
                <label class="input-label">{{ trans('lms/update.province') }}:</label>
            ...
            <div class="form-group mt-30">
                <label class="input-label">{{ trans('lms/update.district') }}:</label>
            ...
            <div class="form-group mb-30">
                <label class="input-label">{{ trans('lms/update.address') }}:</label>
        ...
        <div class="col-12 col-lg-8">
            <div class="form-group">
                ...
                <div id="mapContainer" class="d-none">
                    ...
                    <span class="d-block font-12 text-gray">{{ trans('lms/update.select_location_hint') }}</span>
    ...
    @if(!$user->isUser() and !empty(getFeaturesSettings('show_live_chat_widget')))
        <h2 class="section-title after-line">{{ trans('lms/update.live_chat_widget') }}</h2>

        <div class="row mt-30">
            <div class="col-12 col-lg-4">

                <div class="form-group ">
                    <label class="input-label">{{ trans('lms/update.java_script_code') }}:</label>
    ...
    {{--<h2 class="section-title after-line">{{ trans('lms/panel.meeting_list') }}</h2>

    <div class="row mt-30">
        <div class="col-12">
            <a href="/lms/panel/meetings/settings" class="text-primary">{{ trans('lms/update.manage_meetings') }}</a>
...
@push('scripts_bottom')
    ...
    <script src="/assets/lms/assets/default/js/panel/user_settings_tab.min.js"></script>
@endpush
