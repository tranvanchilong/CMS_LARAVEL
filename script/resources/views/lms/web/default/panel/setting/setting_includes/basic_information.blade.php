<section>
    <h2 class="section-title after-line">{{ trans('lms/financial.account') }}</h2>
    ...
    <div class="row mt-20">
        <div class="col-12 col-lg-4">
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('lms/auth.password_repeat') }}</label>
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('lms/public.mobile') }}</label>
            ...
            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label" for="newsletterSwitch">{{ trans('lms/auth.join_newsletter') }}</label>
            ...
            <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label" for="publicMessagesSwitch">{{ trans('lms/auth.public_messages') }}</label>
                <div class="custom-control custom-switch">
