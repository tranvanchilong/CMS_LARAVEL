<section class="mt-30">
    <h2 class="section-title after-line">{{ trans('lms/site.occupations') }}</h2>
    ...
    <div class="mt-15">
        <p class="font-12 text-gray">- {{ trans('lms/panel.interests_hint_1') }}</p>
        <p class="font-12 text-gray">- {{ trans('lms/panel.interests_hint_2') }}</p>
    </div>
