<section class="mt-30">
    <h2 class="section-title after-line">{{ trans('lms/site.identity_and_financial') }}</h2>
    <div class="mt-15">
        @if($user->financial_approval)
            <p class="font-14 text-primary">{{ trans('lms/site.identity_and_financial_verified') }}</p>
        @else
            <p class="font-14 text-danger">{{ trans('lms/site.identity_and_financial_not_verified') }}</p>
        @endif
    </div>
    ...
    <div class="row mt-20">
        <div class="col-12 col-lg-4">
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('lms/financial.address') }}</label>
