...
<div class="row">
    ...
    @if($product->isVirtual())
        <div class="col-12 mb-40 mt-20">
            ...
            <button id="productAddFile" data-product-id="{{ $product->id }}" type="button" class="btn btn-primary btn-sm mt-15">{{ trans('lms/public.add_new_files') }}</button>
                ...
                @if(!empty($product->files) and count($product->files))
                    <ul class="draggable-lists" data-order-path="/panel/store/products/files/order-items">
                        @foreach($product->files as $fileInfo)
                            @include('lms.web.default.panel.store.products.create_includes.accordions.file',['file' => $fileInfo])
                        @endforeach
                    </ul>
                @else
            ...
            <div id="newFileForm" class="d-none">
                @include('lms.web.default.panel.store.products.create_includes.accordions.file')
            </div>
