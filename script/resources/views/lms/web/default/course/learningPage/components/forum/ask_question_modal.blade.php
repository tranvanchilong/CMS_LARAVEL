<div id="askNewQuestionModal" class="d-none">
    <div class="custom-modal-body">
        <h2 class="section-title after-line">{{ trans('lms/update.new_question') }}</h2>

        <form action="/lms{{ $course->getForumPageUrl() }}/store" class="mt-20">
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
                <button type="button" class="js-save-question btn btn-sm btn-primary">{{ trans('lms/admin/main.post') }}</button>
