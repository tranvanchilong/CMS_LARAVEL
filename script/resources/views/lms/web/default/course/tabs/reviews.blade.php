    ...
    <div class="course-reviews-box row align-items-center">
        <div class="col-3 text-center">
            ...
            <div class="text-center">
                ...
                <div class="mt-15">{{ $course->reviews->pluck('creator_id')->count() }}  {{ trans('lms/product.reviews') }}</div>
            </div>
        </div>
        ...
        <div class="col-9">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('lms/product.content_quality') }} ({{ $course->reviews->count() > 0 ? round($course->reviews->avg('content_quality'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('lms/product.instructor_skills') }} ({{ $course->reviews->count() > 0 ? round($course->reviews->avg('instructor_skills'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('lms/product.purchase_worth') }} ({{ $course->reviews->count() > 0 ? round($course->reviews->avg('purchase_worth'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('lms/product.support_quality') }} ({{ $course->reviews->count() > 0 ? round($course->reviews->avg('support_quality'), 1) : 0 }})</span>
            </div>
...
<section class="mt-40">
    <h2 class="section-title after-line">{{ trans('lms/product.reviews') }} ({{ $course->reviews->pluck('creator_id')->count() }})</h2>

    <form action="/lms/reviews/store" class="mt-20" method="post">
        {{ csrf_field() }}
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="btn-group dropdown table-actions">
                                ...
                                <div class="dropdown-menu">
                                    <a href="/lms/reviews/store-reply-comment" class="webinar-actions d-block text-hover-primary reply-comment">{{ trans('lms/panel.reply') }}</a>

                                    @if(!empty($user) and $user->id == $review->creator_id)
                                        <a href="/lms/reviews/{{ $review->id }}/delete" class="webinar-actions d-block mt-10 text-hover-primary">{{ trans('lms/public.delete') }}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
