                                ...
                                <div class="d-flex align-items-center justify-content-between mt-20">
                                    ...
                                    <div class="">
                                        @if(!empty($user) and $quiz->can_download_certificate and $hasBought)
                                            <a href="/lms/panel/quizzes/results/{{ $quiz->result->id }}/showCertificate" target="_blank" class="course-content-btns btn btn-sm btn-primary">{{ trans('lms/home.download') }}</a>
                                        @else
