<div class="d-none" id="courseShareModal">
    ...
    <div class="text-center">
        ...
        <div class="mt-32 mt-lg-40 row align-items-center font-14">
            <a href="/lms{{ $course->getShareLink('telegram') }}" target="_blank" class="col text-center">
            ...
            <a href="/lms{{ $course->getShareLink('whatsapp') }}" target="_blank" class="col text-center">
            ...
            <a href="/lms{{ $course->getShareLink('facebook') }}" target="_blank" class="col text-center">
            ...
            <a href="/lms{{ $course->getShareLink('twitter') }}" target="_blank" class="col text-center">
