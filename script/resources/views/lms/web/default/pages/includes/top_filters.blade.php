    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-6 d-block d-md-flex align-items-center justify-content-end my-25 my-lg-0">
            <div class="d-flex align-items-center justify-content-between justify-content-md-center mx-0 mx-md-20 my-20 my-md-0">
                <label class="mb-0 mr-10 cursor-pointer" for="upcoming">{{ trans('lms/panel.upcoming') }}</label>
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center">
                <label class="mb-0 mr-10 cursor-pointer" for="free">{{ trans('lms/public.free') }}</label>
                <div class="custom-control custom-switch">
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center">
                <label class="mb-0 mr-10 cursor-pointer" for="download">{{ trans('lms/home.download') }}</label>
                <div class="custom-control custom-switch">
