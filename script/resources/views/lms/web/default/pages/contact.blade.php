...
@section('content')
    <section class="site-top-banner search-top-banner opacity-04 position-relative">
        <img src="{{get_path_lms()}}{{ $contactSettings['background'] }}" class="img-cover" alt="{{ $pageTitle ?? '' }}"/>

        <div class="container h-100">
            <div class="row contact-us-head h-100 justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        <h1 class="text-white font-30 mb-15">{{ trans('lms/site.contact_us') }}</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="contact-items mt-30 rounded-lg py-20 py-md-40 px-15 px-md-30 text-center">
                        ...
                        <h3 class="mt-30 font-16 font-weight-bold text-dark-blue">{{ trans('lms/site.our_address') }}</h3>
                        @if(!empty($contactSettings['address']))
                            <p class="font-weight-500 font-14 text-gray mt-10">{!! nl2br($contactSettings['address']) !!}</p>
                        @else
                            <p class="font-weight-500 text-gray font-14 mt-10">{{ trans('lms/site.not_defined') }}</p>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="contact-items mt-30 rounded-lg py-20 py-md-40 px-15 px-md-30 text-center">
                        ...
                        <h3 class="mt-30 font-16 font-weight-bold text-dark-blue">{{ trans('lms/site.phone_number') }}</h3>
                ...
                <div class="col-12 col-md-4">
                    <div class="contact-items mt-30 rounded-lg py-20 py-md-40 px-15 px-md-30 text-center">
                        ...
                        <h3 class="mt-30 font-16 font-weight-bold text-dark-blue">{{ trans('lms/public.email') }}</h3>
        ...
        <section class="mt-30 mt-md-50">
            <h2 class="font-16 font-weight-bold text-secondary">{{ trans('lms/site.send_your_message_directly') }}</h2>
            ...
            <form action="/lms/contact/store" method="post" class="mt-20">
                {{ csrf_field() }}

                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label class="input-label font-weight-500">{{ trans('lms/site.your_name') }}</label>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label class="input-label font-weight-500">{{ trans('lms/public.email') }}</label>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label class="input-label font-weight-500">{{ trans('lms/site.phone_number') }}</label>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label class="input-label font-weight-500">{{ trans('lms/site.subject') }}</label>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label class="input-label font-weight-500">{{ trans('lms/site.message') }}</label>
                ...
                <button type="submit" class="btn btn-primary mt-20">{{ trans('lms/site.send_message') }}</button>
            </form>
        </section>
...
@push('scripts_bottom')
    ...
    <script src="/assets/lms/assets/default/js/parts/contact.min.js"></script>
@endpush
