<div class="d-none" id="blogShareModal">
    ...
    <div class="text-center">
        ...
        <p class="mt-20 font-14">{{ trans('lms/update.share_this_post_with_others') }}</p>
        ...
        <div class="position-relative d-flex align-items-center justify-content-between p-15 mt-15 border border-gray250 rounded-sm mt-5">
            ...
            <button type="button" class="js-blog-share-link-copy btn btn-primary btn-sm font-14 font-weight-500 flex-none" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/public.copy') }}">{{ trans('lms/public.copy') }}</button>
        </div>

        <div class="mt-32 mt-lg-40 row align-items-center font-14">
            <a href="/lms{{ $post->getShareLink('telegram') }}" target="_blank" class="col text-center">
            ...
            <a href="/lms{{ $post->getShareLink('whatsapp') }}" target="_blank" class="col text-center">
            ...
            <a href="/lms{{ $post->getShareLink('facebook') }}" target="_blank" class="col text-center">
            ...
            <a href="/lms{{ $post->getShareLink('twitter') }}" target="_blank" class="col text-center">
