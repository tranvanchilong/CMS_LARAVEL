        ...
        <figcaption class="webinar-card-body">
            ...
            <div class="d-flex justify-content-between mt-20">
                <div class="d-flex align-items-center">
                    ...
                    <span class="duration font-14 ml-5">{{ convertMinutesToHourAndMinute($webinar->duration) }} {{ trans('lms/home.hours') }}</span>
                </div>
            ...
            @if(!empty($isRewardCourses) and !empty($webinar->points))
                    <span class="text-warning real font-14">{{ $webinar->points }} {{ trans('lms/update.points') }}</span>
