...
<link rel='shortcut icon' type='image/x-icon' href="{{ get_path_lms().(!empty($generalSettings['fav_icon']) ? $generalSettings['fav_icon'] : '') }}">
...
<link rel="apple-touch-icon" href="{{ get_path_lms().(!empty($generalSettings['fav_icon']) ? $generalSettings['fav_icon'] : '') }}">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="default">
<!-- Android -->
<link rel='icon' href='{{ get_path_lms().(!empty($generalSettings['fav_icon']) ? $generalSettings['fav_icon'] : '') }}'>
...
<meta property='og:site_name' content='{{ (!empty($generalSettings['site_name']) ? $generalSettings['site_name'] : '') }}'>
<meta property='og:image' content='{{ get_path_lms().(!empty($generalSettings['fav_icon']) ? $generalSettings['fav_icon'] : '') }}'>
<meta name='twitter:image' content='{{ get_path_lms().(!empty($generalSettings['fav_icon']) ? $generalSettings['fav_icon'] : '') }}'>
