<div class="row">
    <div class="col-5">
        <div class="form-group">
            <label class="input-label" for="mobile">{{ trans('lms/auth.country') }}:</label>
    ...
    <div class="col-7">
        <div class="form-group">
            <label class="input-label" for="mobile">{{ trans('lms/auth.mobile') }} {{ !empty($optional) ? "(". trans('lms/public.optional') .")" : '' }}:</label>
