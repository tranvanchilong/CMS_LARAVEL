<div class="product-show-reviews-tab mt-20">
    <div class="course-reviews-box row align-items-center">
        <div class="col-3 col-lg-3 text-center">
            ...
            <div class="text-center">
                ...
                <div class="mt-15">{{ $product->reviews->pluck('creator_id')->count() }}  {{ trans('lms/product.reviews') }}</div>
            </div>
        </div>
        ...
        <div class="col-9 col-lg-6">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('lms/update.products') }} ({{ $product->reviews->count() > 0 ? round($product->reviews->avg('product_quality'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('lms/product.purchase_worth') }} ({{ $product->reviews->count() > 0 ? round($product->reviews->avg('purchase_worth'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('lms/update.delivery') }} ({{ $product->reviews->count() > 0 ? round($product->reviews->avg('delivery_quality'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('lms/update.seller') }} ({{ $product->reviews->count() > 0 ? round($product->reviews->avg('seller_quality'), 1) : 0 }})</span>
            </div>
    ...
    <section class="mt-40">
        <h2 class="section-title after-line">{{ trans('lms/product.reviews') }} ({{ $product->reviews->pluck('creator_id')->count() }})</h2>

        <form action="/lms/products/reviews/store" class="mt-20" method="post">
            {{ csrf_field() }}
            ...
            <div class="reviews-stars row align-items-center">
                ...
                <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                    <span class="font-14 text-gray">{{ trans('lms/update.products') }}</span>
                ...
                <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                    <span class="font-14 text-gray">{{ trans('lms/update.delivery') }}</span>
                ...
                <div class="col-6 col-md-3 d-flex flex-column align-items-center justify-content-center barrating-stars">
                    <span class="font-14 text-gray">{{ trans('lms/update.seller') }}</span>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="btn-group dropdown table-actions">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="/lms/products/reviews/store-reply-comment" class="webinar-actions d-block text-hover-primary reply-comment">{{ trans('lms/panel.reply') }}</a>

                                        @if(!empty($authUser) and $authUser->id == $review->creator_id)
                                            <a href="/lms/products/reviews/{{ $review->id }}/delete" class="delete-action d-block mt-10 text-hover-primary">{{ trans('lms/public.delete') }}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
