                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templatePreheader">
                                <tr>
                                    <td class="headerContent" width="100%">
                                        <a href="/lms"><img src="{{get_path_lms()}}{{ url($generalSettings['logo']) }}" style="max-width:128px;margin-bottom: 8px;margin-top: 24px" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowtext/></a>
                                    </td>
                                </tr>
                            </table>
                            <!-- // END PREHEADER -->
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                ...
                                {{--   <tr>
                                       <td valign="top" class="footerContent" mc:edit="footer_content00">
                                           <a href="/lms*|TWITTER:PROFILEURL|*">Follow on Twitter</a>&nbsp;&nbsp;&nbsp;<a href="/lms*|FACEBOOK:PROFILEURL|*">Friend on Facebook</a>&nbsp;&nbsp;&nbsp;<a href="/lms*|FORWARD|*">Forward to Friend</a>&nbsp;
                                       </td>
                                   </tr>--}}
                            </table>
                            <!-- // END FOOTER -->
