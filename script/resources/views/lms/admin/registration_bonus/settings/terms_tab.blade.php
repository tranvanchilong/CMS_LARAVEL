@php
    $termsSetting = $settings->where('name', \App\Models\LMS\Setting::$registrationBonusTermsSettingsName)->first();
...
<form action="/lms{{ getAdminPanelUrl('/registration_bonus/settings') }}" method="post">
    ...
    <input type="hidden" name="name" value="{{ \App\Models\LMS\Setting::$registrationBonusTermsSettingsName }}">
                            ...
                            <div class="form-group d-flex align-items-start">
                                <div class="px-2 py-1 border flex-grow-1">
                                    ...
                                    <div class="form-group mb-1">
                                        <label class="mb-1">{{ trans('lms/admin/main.icon') }}</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                    ...
                                    <div class="form-group mb-1">
                                        <label class="mb-1">{{ trans('lms/admin/main.title') }}</label>
                                    ...
                                    <div class="form-group mb-1">
                                        <label class="mb-1">{{ trans('lms/public.description') }}</label>
...
@push('scripts_bottom')
    <script src="/assets/lms/assets/default/js/admin/settings/site_bank_accounts.min.js"></script>
@endpush
