@php
    $basicSetting = $settings->where('name', \App\Models\LMS\Setting::$registrationBonusSettingsName)->first();
...
<div class="row">
    <div class="col-12 col-md-6">
        <form action="/lms{{ getAdminPanelUrl('/registration_bonus/settings') }}" method="post">
            {{ csrf_field() }}
            <input type="hidden" name="page" value="general">
            <input type="hidden" name="name" value="{{ \App\Models\LMS\Setting::$registrationBonusSettingsName }}">
            ...
            <div class="form-group custom-switches-stacked ">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <label class="custom-switch-description mb-0 cursor-pointer" for="statusSwitch">{{ trans('lms/admin/main.active') }}</label>
                </label>

                <div class="text-muted text-small">{{ trans('lms/update.registration_bonus_setting_active_hint') }}</div>
            </div>
            ...
            <div class="form-group custom-switches-stacked ">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <span class="custom-switch-indicator"></span>
                    <label class="custom-switch-description mb-0 cursor-pointer" for="unlock_registration_bonus_instantlySwitch">{{ trans('lms/update.unlock_registration_bonus_instantly') }}</label>
                </label>

                <div class="text-muted text-small">{{ trans('lms/update.unlock_registration_bonus_instantly_hint') }}</div>
            </div>
            ...
            <div class="js-unlock-registration-bonus-with-referral-field form-group custom-switches-stacked {{ (!empty($basicValue) and !empty($basicValue['unlock_registration_bonus_instantly'])) ? 'd-none' : '' }}">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <span class="custom-switch-indicator"></span>
                    <label class="custom-switch-description mb-0 cursor-pointer" for="unlock_registration_bonus_with_referralSwitch">{{ trans('lms/update.unlock_registration_bonus_with_referral') }}</label>
                </label>

                <div class="text-muted text-small">{{ trans('lms/update.unlock_registration_bonus_with_referral_hint') }}</div>
            </div>
            ...
            <div class="js-number-of-referred-users-field form-group {{ (!empty($basicValue) and !empty($basicValue['unlock_registration_bonus_with_referral'])) ? '' : 'd-none' }}">
                <label>{{ trans('lms/update.number_of_referred_users') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.number_of_referred_users_hint') }}</div>
            </div>
            ...
            <div class="js-enable-referred-users-purchase-field form-group custom-switches-stacked {{ (!empty($basicValue) and !empty($basicValue['unlock_registration_bonus_instantly'])) ? 'd-none' : ((!empty($basicValue) and !empty($basicValue['unlock_registration_bonus_with_referral'])) ? '' : 'd-none') }}">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <span class="custom-switch-indicator"></span>
                    <label class="custom-switch-description mb-0 cursor-pointer" for="enable_referred_users_purchaseSwitch">{{ trans('lms/update.enable_referred_users_purchase') }}</label>
                </label>

                <div class="text-muted text-small">{{ trans('lms/update.enable_referred_users_purchase_hint') }}</div>
            </div>
            ...
            <div class="js-purchase-amount-for-unlocking-bonus-field form-group {{ (!empty($basicValue) and !empty($basicValue['enable_referred_users_purchase'])) ? '' : 'd-none' }}">
                <label>{{ trans('lms/update.purchase_amount_for_unlocking_bonus') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.purchase_amount_for_unlocking_bonus_hint') }}</div>
            </div>

            <div class="form-group">
                <label>{{ trans('lms/update.registration_bonus_amount') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.registration_bonus_amount_hint') }}</div>
            </div>

            <div class="form-group">
                <label>{{ trans('lms/update.bonus_wallet') }}</label>
                <select name="value[bonus_wallet]" class="form-control">
                    <option value="income_wallet" {{ (!empty($basicValue) and !empty($basicValue['bonus_wallet']) and $basicValue['bonus_wallet'] == "income_wallet") ? 'selected' : '' }}>{{ trans('lms/update.income_wallet') }}</option>
                    <option value="balance_wallet" {{ (!empty($basicValue) and !empty($basicValue['bonus_wallet']) and $basicValue['bonus_wallet'] == "balance_wallet") ? 'selected' : '' }}>{{ trans('lms/update.balance_wallet') }}</option>
                </select>
                <div class="text-muted text-small mt-1">{{ trans('lms/update.bonus_wallet_hint') }}</div>
            </div>
