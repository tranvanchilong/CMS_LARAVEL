        ...
        <div class="row">
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('lms/admin/main.question_count')}}</h4>
                        </div>
                        <div class="card-body">
                            {{ $totalQuestions }}
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('lms/update.resolved')}}</h4>
                        </div>
                        <div class="card-body">
                            {{ $resolvedCount }}
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{trans('lms/update.not_resolved')}}</h4>
                        </div>
                        <div class="card-body">
                            {{ $notResolvedCount }}
                        </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" data-plugin-selectTwo class="form-control populate">
                                        ...
                                        <option value="resolved" @if(request()->get('status') == 'resolved') selected @endif>{{trans('lms/update.resolved')}}</option>
                                        <option value="not_resolved" @if(request()->get('status') == 'not_resolved') selected @endif>{{trans('lms/update.not_resolved')}}</option>
                                        <option value="pined" @if(request()->get('status') == 'pined') selected @endif>{{trans('lms/update.pined')}}</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped font-14 ">
                                    <tr>
                                        <th class="text-left">{{trans('lms/update.question_title')}}</th>
                                        <th class="">{{trans('lms/admin/main.created_at')}}</th>
                                        <th class="">{{trans('lms/admin/main.updated_at')}}</th>
                                        <th class="">{{trans('lms/admin/main.creator')}}</th>
                                        <th>{{trans('lms/public.answers')}}</th>
                                        <th>{{trans('lms/update.pined')}}</th>
                                        <th>{{trans('lms/update.resolved')}}</th>
                                    ...
                                    @foreach($forums as $forum)
                                        <tr class="text-center">
                                            ...
                                            <td width="200" class="btn-sm">
                                                @if($authUser->can('admin_course_question_forum_answers'))
                                                    <a href="/lms{{ getAdminPanelUrl() }}/webinars/{{ $forum->webinar_id }}/forums/{{ $forum->id }}/answers" target="_blank" class="btn-transparent btn-sm text-primary mt-1 mr-1" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/public.answers') }}">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                @endif
                                            </td>
