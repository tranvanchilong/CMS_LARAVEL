    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <div class="card-body">
                    <p class="">
                        <span class="font-weight-bold">{{ trans('lms/admin/main.course_title') }}</span>:
                        {{ $webinar->title }}
                    </p>

                    <form method="post" action="/lms{{ getAdminPanelUrl() }}/webinars/{{ $webinar->id }}/sendNotification" class="form-horizontal form-bordered mt-4">
                        {{ csrf_field() }}
