<div id="chapterModalHtml" class="d-none">
    <div class="custom-modal-body">
        <h2 class="section-title after-line">{{ trans('lms/public.new_chapter') }}</h2>

        <div class="js-content-form chapter-form mt-20" data-action="/lms{{ getAdminPanelUrl() }}/chapters/store">
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('lms/public.chapter_title') }}</label>
            ...
            <div class="form-group mt-2 d-flex align-items-center justify-content-between js-switch-parent">
                <label class="js-switch cursor-pointer" for="chapterStatus_record">{{ trans('lms/public.active') }}</label>
            ...
            @if(getFeaturesSettings('sequence_content_status'))
                <div class="form-group mt-2 d-flex align-items-center justify-content-between js-switch-parent">
                    <label class="js-switch cursor-pointer" for="checkAllContentsPassSwitch_record">{{ trans('lms/update.check_all_contents_pass') }}</label>
            ...
            <div class="d-flex align-items-center justify-content-end mt-3">
                <button type="button" class="save-chapter btn btn-sm btn-primary">{{ trans('lms/public.save') }}</button>
