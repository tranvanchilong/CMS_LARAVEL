                ...
                <div class="card-body">
                    <table class="table table-striped font-14" id="datatable-details">
                        ...
                        <tr>
                            ...
                            <th class="text-right">{{ trans('lms/admin/main.action') }}</th>
                        </tr>
                        ...
                        @foreach($histories as $history)
                            <tr>
                                ...
                                <td class="align-middle text-right">
                                    @if($authUser->can('admin_webinar_assignments_conversations'))
                                        <a href="/lms{{ getAdminPanelUrl() }}/assignments/{{ $assignment->id }}/history/{{ $history->id }}/conversations" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/admin/main.conversations') }}">
