    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="/lms{{ getAdminPanelUrl() }}/assignments">{{ trans('lms/update.assignments') }}</a></div>
                <div class="breadcrumb-item"><a href="/lms{{ getAdminPanelUrl() }}/assignments/{{ $assignment->id }}/students">{{ trans('lms/public.students') }}</a></div>
                                    ...
                                    <div class="chat-details">
                                        ...
                                        <div class="chat-time">
                                            ...
                                            @if(!empty($conversation->file_path))
                                                <a href="/lms{{ $conversation->getDownloadUrl($assignment->id) }}" target="_blank" class="text-success">
                                                    <i class="fa fa-paperclip"></i>
                                                    {{ trans('lms/admin/main.open_attach') }}
                                                </a>
                                            @endif
                                        </div>
                                    </div>
