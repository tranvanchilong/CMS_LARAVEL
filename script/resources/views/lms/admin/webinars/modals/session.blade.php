...
<div class="d-none" id="webinarSessionModal">
    <h3 class="section-title after-line font-20 text-dark-blue mb-25">{{ trans('lms/public.add_session') }}</h3>

    <form action="/lms{{ getAdminPanelUrl() }}/sessions/store" method="post" class="session-form">
        ...
        <div class="form-group">
            ...
            <div class="js-session-api">
                <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <label class="custom-control-label" for="localApi_record">{{ trans('lms/webinars.session_local_api') }}</label>
                </div>

                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="session_api" id="bigBlueButton_record" value="big_blue_button" class="js-api-input custom-control-input">
                    <label class="custom-control-label" for="bigBlueButton_record">{{ trans('lms/webinars.session_big_blue_button') }}</label>
                </div>

                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="session_api" id="zoomApi_record" value="zoom" class="js-api-input custom-control-input">
                    <label class="custom-control-label" for="zoomApi_record">{{ trans('lms/webinars.session_zoom') }}</label>
                </div>

                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" name="session_api" id="agoraApi_record" value="agora" class="js-api-input custom-control-input">
                    <label class="custom-control-label" for="agoraApi_record">{{ trans('lms/update.agora') }}</label>
                </div>
            </div>
            ...
            <div class="js-zoom-not-complete-alert mt-10 text-danger d-none">
                {{ trans('lms/admin/main.teacher_zoom_jwt_token_invalid') }}
            </div>
        </div>
        ...
        <div class="js-session-status form-group mt-3">
            <div class="d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label" for="sessionStatusSwitch_record">{{ trans('lms/admin/main.active') }}</label>
        ...
        <div class="js-agora-chat-and-rec d-none">
            @if(getFeaturesSettings('agora_chat'))
                <div class="form-group mt-20">
                    <div class="d-flex align-items-center justify-content-between">
                        <label class="cursor-pointer input-label" for="sessionAgoraChatSwitch_record">{{ trans('lms/update.chat') }}</label>
                        <div class="custom-control custom-switch">
            ...
            {{--
                <div class="form-group mt-20">
                    <div class="d-flex align-items-center justify-content-between">
                        <label class="cursor-pointer input-label" for="sessionAgoraRecordSwitch_record">{{ trans('lms/update.record') }}</label>
                        <div class="custom-control custom-switch">
        ...
        <div class="mt-3 d-flex align-items-center justify-content-end">
            <button type="button" id="saveSession" class="btn btn-primary">{{ trans('lms/public.save') }}</button>
