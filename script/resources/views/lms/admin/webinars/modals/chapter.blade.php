...
<div class="d-none" id="webinarChapterModal">
    <h3 class="section-title after-line font-20 text-dark-blue mb-25">{{ trans('lms/public.add_new_chapter') }}</h3>
    <form action="/lms{{ getAdminPanelUrl() }}/chapters/store" method="post">
        ...
        <div class="js-chapter-status form-group mt-3">
            <div class="d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label" for="chapterStatusSwitch_record">{{ trans('lms/admin/main.active') }}</label>
        ...
        <div class="mt-30 d-flex align-items-center justify-content-end">
            <button type="button" id="saveChapter" class="btn btn-primary">{{ trans('lms/public.save') }}</button>
