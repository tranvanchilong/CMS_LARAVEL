...
<div class="d-none" id="webinarAssignmentModal">
    <h3 class="section-title after-line font-20 text-dark-blue mb-25">{{ trans('lms/update.add_new_assignments') }}</h3>
    <form action="/lms{{ getAdminPanelUrl() }}/assignments/store" method="post">
        ...
        <div class="form-group">
            <label class="input-label">{{ trans('lms/admin/main.description') }}</label>
        ...
        <div class="js-assignment-attachments-items form-group mt-15">
            ...
            <div class="assignment-attachments-main-row js-ajax-attachments position-relative">
                <div class="mt-2 p-2 border rounded">
                    <div class="mb-2">
                        <label class="input-label">{{ trans('lms/public.title') }}</label>
                        <input type="text" name="attachments[assignmentTemp][title]" class="form-control" placeholder="{{ trans('lms/forms.maximum_255_characters') }}"/>
                    </div>
                    ...
                    <div class="input-group product-images-input-group">
                        ...
                        <input type="text" name="attachments[assignmentTemp][attach]" id="attachments_assignmentTemp" value="" class="form-control" placeholder="{{ trans('lms/update.assignment_attachments_placeholder') }}"/>
                    </div>
                </div>
        ...
        <div class="js-textLesson-status form-group mt-3">
            <div class="d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label" for="textLessonStatusSwitch_record">{{ trans('lms/admin/main.active') }}</label>
        ...
        <div class="mt-30 d-flex align-items-center justify-content-end">
            <button type="button" id="saveAssignment" class="btn btn-primary">{{ trans('lms/public.save') }}</button>
