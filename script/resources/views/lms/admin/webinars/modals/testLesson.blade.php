...
<div class="d-none" id="webinarTestLessonModal">
    <h3 class="section-title after-line font-20 text-dark-blue mb-25">{{ trans('lms/public.add_text_lesson') }}</h3>
    <form action="/lms{{ getAdminPanelUrl() }}/test-lesson/store" method="post">
        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group">
                    <label class="input-label">{{ trans('lms/public.study_time') }}</label>
        ...
        <div class="form-group">
            ...
            <select class="js-ajax-attachments form-control attachments-select2" name="attachments" data-placeholder="{{ trans('lms/public.choose_attachments') }}">
                <option></option>
        ...
        <div class="mt-30 d-flex align-items-center justify-content-end">
            <button type="button" id="saveTestLesson" class="btn btn-primary">{{ trans('lms/public.save') }}</button>
