...
<div class="d-none" id="interactiveFileModal">
    <h3 class="section-title after-line font-20 text-dark-blue mb-25">{{ trans('lms/update.new_interactive_file') }}</h3>
    <form action="/lms{{ getAdminPanelUrl() }}/files/store" method="post" enctype="multipart/form-data">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select name="interactive_type" class="js-interactive-type form-control">
                        <option value="adobe_captivate">{{ trans('lms/update.adobe_captivate') }}</option>
                        <option value="i_spring">{{ trans('lms/update.i_spring') }}</option>
                        <option value="custom">{{ trans('lms/update.custom') }}</option>
                    </select>
                    <div class="invalid-feedback"></div>
                </div>
            </div>
        ...
        <div class="js-interactive-file-name-input form-group d-none">
            ...
            <input type="text" name="interactive_file_name" class="js-ajax-interactive_file_name form-control" value="" placeholder="{{ trans('lms/update.interactive_file_name_placeholder') }}"/>
            <div class="invalid-feedback"></div>
        </div>
        ...
        <div class="form-group js-file-path-input">
            <div class="local-input input-group">
                ...
                <input type="text" name="file_path" id="file_path_record" value="" class="js-ajax-file_path form-control" placeholder="{{ trans('lms/update.choose_zip_file') }}"/>
                <div class="invalid-feedback"></div>
            </div>
        </div>
        ...
        <div class="mt-30 d-flex align-items-center justify-content-end">
            <button type="button" id="saveInteractiveFile" class="btn btn-primary">{{ trans('lms/public.save') }}</button>
