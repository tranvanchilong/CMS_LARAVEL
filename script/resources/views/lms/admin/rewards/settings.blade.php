                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <form action="/lms{{ getAdminPanelUrl() }}/rewards/settings" method="post">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="rewardsStatusSwitch">{{ trans('lms/admin/main.active') }}</label>
                                            </label>
                                            <div class="text-muted text-small">{{ trans('lms/update.admin_reward_setting_active_hint') }}</div>
                                        </div>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <span class="custom-switch-indicator"></span>
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="exchangeableSwitch">{{ trans('lms/update.exchangeable') }}                       </label>
                                            </label>
                                            <div class="text-muted text-small">{{ trans('lms/update.admin_reward_setting_exchangeable_hint') }}</div>
                                        </div>
                                        ...
                                        <div id="exchangeableUnitInput" class="form-group {{ ((!empty($itemValue) and !empty($itemValue['exchangeable']) and $itemValue['exchangeable']) or (!empty($errors) and $errors->has('exchangeable_unit'))) ? '' : 'd-none' }}">
                                            <label>{{ trans('lms/update.exchangeable_unit') }}</label>
                                            ...
                                            <div class="text-muted text-small mt-1">{{ trans('lms/update.exchangeable_unit_hint') }}</div>
                                        </div>

                                        <div class="form-group">
                                            <label>{{ trans('lms/update.want_more_points_link') }}</label>
                                            ...
                                            <div class="text-muted text-small mt-1">{{ trans('lms/update.want_more_points_link_hint') }}</div>
                                        </div>
...
@push('scripts_bottom')
    <script src="/assets/lms/assets/default/js/admin/rewards_settings.min.js"></script>
@endpush
