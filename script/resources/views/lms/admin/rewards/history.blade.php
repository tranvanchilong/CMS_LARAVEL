                    ...
                    <div class="table-responsive">
                        <table class="table table-striped text-center font-14">
                            ...
                            <tr>
                                ...
                                <th class="text-center">{{ trans('lms/update.total_points') }}</th>
                                <th class="text-center">{{ trans('lms/update.spent_points') }}</th>
                                <th class="text-center">{{ trans('lms/update.available_points') }}</th>
                            </tr>
