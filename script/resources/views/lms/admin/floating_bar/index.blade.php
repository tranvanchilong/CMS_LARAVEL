                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/lms{{ getAdminPanelUrl('/floating_bars') }}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="form-group mt-15">
                                            <label class="input-label">{{ trans('lms/update.icon') }}</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                        ...
                                        <div class="form-group mt-15">
                                            <label class="input-label">{{ trans('lms/update.background_image') }}</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/update.title_color') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/update.description_color') }}</label>
                                            <div class="input-group colorpickerinput">
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/update.background_color') }}</label>
                                            <div class="input-group colorpickerinput">
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/update.btn_color') }}</label>
                                            <div class="input-group colorpickerinput">
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/update.bar_height') }} (px)</label>
                                            <input type="number" name="bar_height" value="{{ !empty($floatingBar) ? $floatingBar->bar_height : old('bar_height') }}" min="0" class="form-control "/>
                                        </div>

                                        <div class="form-group">
                                            <label>{{ trans('lms/update.bar_position') }}</label>
                                            <select name="position" class="form-control">
                                                <option value="top" {{ (!empty($floatingBar) and $floatingBar->position == 'top') ? 'selected' : '' }}>{{ trans('lms/update.top') }}</option>
                                                <option value="bottom" {{ (!empty($floatingBar) and $floatingBar->position == 'bottom') ? 'selected' : '' }}>{{ trans('lms/update.bottom') }}</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="fixedSwitch">{{ trans('lms/update.fixed') }}</label>
                                            </label>
                                            <div class="text-muted text-small mt-1">{{ trans('lms/update.top_bottom_bar_fixed_hint') }}</div>
                                        </div>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <span class="custom-switch-indicator"></span>
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="enableSwitch">{{ trans('lms/update.enable') }}</label>
                                            </label>
                                        </div>
                                ...
                                <div class="">
                                    <button type="button" class="js-submit-form btn btn-primary">{{ trans('lms/admin/main.save_change') }}</button>
                                    <button type="button" class="js-preview-bar btn btn-warning ml-2">{{ trans('lms/update.preview') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@push('scripts_bottom')
    ...
    <script src="/assets/lms/assets/default/js/admin/floating_bar.min.js"></script>
@endpush
