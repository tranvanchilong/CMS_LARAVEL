            ...
            <div class="row">
                    ...
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('lms/update.total_bundles')}}</h4>
                            </div>
                            <div class="card-body">
                                {{ $totalBundles }}
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('lms/admin/main.pending_review')}}</h4>
                            </div>
                            <div class="card-body">
                                {{ $totalPendingBundles }}
                            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                {{ !empty($totalSales) ? handlePrice($totalSales->total_amount ?? 0) : 0 }}
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            @if($authUser->can('admin_webinars_export_excel'))
                                <div class="text-right">
                                    <a href="/lms{{ getAdminPanelUrl() }}/bundles/excel?{{ http_build_query(request()->all()) }}" class="btn btn-primary">{{ trans('lms/admin/main.export_xls') }}</a>
                                </div>
                            @endif
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14 ">
                                    <tr>
                                        ...
                                        <th>{{trans('lms/admin/main.course_count')}}</th>
                                            ...
                                            <td>
                                                @if(!empty($bundle->price) and $bundle->price > 0)
                                                    ...
                                                    @if($bundle->getDiscountPercent() > 0)
                                                        <div class="text-danger text-small font-600-bold">{{ $bundle->getDiscountPercent() }}% {{trans('lms/admin/main.off')}}</div>
                                                    @endif
                                                @else
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        @if($authUser->can('admin_webinar_notification_to_students'))
                                                            <a href="/lms{{ getAdminPanelUrl() }}/bundles/{{ $bundle->id }}/sendNotification" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 ">
                                                        ...
                                                        @if($authUser->can('admin_webinar_students_lists'))
                                                            <a href="/lms{{ getAdminPanelUrl() }}/bundles/{{ $bundle->id }}/students" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 " title="{{ trans('lms/admin/main.students') }}">
                                                        ...
                                                        @if($authUser->can('admin_support_send'))
                                                            <a href="/lms{{ getAdminPanelUrl() }}/supports/create?user_id={{ $bundle->teacher->id }}" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1" title="{{ trans('lms/admin/main.send_message_to_teacher') }}">
                                                        ...
                                                        @if($authUser->can('admin_webinars_edit'))
                                                            <a href="/lms{{ getAdminPanelUrl() }}/bundles/{{ $bundle->id }}/edit" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 " title="{{ trans('lms/admin/main.edit') }}">
