...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{!empty($forum) ?trans('lms//admin/main.edit'): trans('lms/admin/main.new') }} {{ trans('lms/update.forum') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/lms{{ getAdminPanelUrl() }}">{{ trans('lms/admin/main.dashboard') }}</a>
                </div>
                <div class="breadcrumb-item active">
                    <a href="/lms{{ getAdminPanelUrl() }}/forums">{{ trans('lms/update.forum') }}</a>
                </div>
                <div class="breadcrumb-item">{{!empty($forum) ?trans('lms//admin/main.edit'): trans('lms/admin/main.new') }}</div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form action="/lms{{ getAdminPanelUrl() }}/forums/{{ !empty($forum) ? $forum->id.'/update' : 'store' }}"
                                  method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label class="input-label d-block">{{ trans('lms/admin/main.group') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="input-label d-block">{{ trans('lms/admin/main.role') }}</label>
                                    ...
                                    <div class="text-muted text-small mt-1">{{ trans('lms/update.forum_group_role_hint') }}</div>
                                ...
                                <div class="form-group custom-switches-stacked">
                                    <label class="custom-switch pl-0 d-flex align-items-center">
                                        ...
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="forumCloseSwitch">{{ trans('lms/admin/main.closed') }}</label>
                                    </label>
                                    <div class="text-muted text-small mt-1">{{ trans('lms/update.closed_forum_hint') }}</div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label"
                                               for="hasSubCategory">{{ trans('lms/update.include_sub_forums') }}</label>
                                    </div>
                                </div>

                                <div id="subCategories" class="ml-0 {{ (!empty($subForums) and !$subForums->isEmpty()) ? '' : ' d-none' }}">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <strong class="d-block">{{ trans('lms/update.new_sub_forums') }}</strong>
                                                ...
                                                <li class="form-group list-group  border rounded-lg p-2">
                                                    ...
                                                    <div class="form-group mb-0 mt-1">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="sub_forums[{{ $subForum->id }}][icon]" id="icon_{{ $subForum->id }}" class="form-control" value="{{ $subForum->icon }}" placeholder="{{ trans('lms/admin/main.icon') }}"/>
                                                        </div>
                                                    </div>

                                                    <textarea name="sub_forums[{{ $subForum->id }}][description]"
                                                              class="form-control w-auto flex-grow-1 mt-1" placeholder="{{ trans('lms/update.forum_description') }}">{{ $subForum->description }}</textarea>

                                                    <div class="form-group mb-0 mt-1">
                                                        <label class="input-label d-block mb-0">{{ trans('lms/admin/main.group') }}</label>
                                                    ...
                                                    <div class="form-group mb-0 mt-1">
                                                        <label class="input-label d-block mb-0">{{ trans('lms/admin/main.role') }}</label>
                                                    ...
                                                    <div class="form-group mb-0 mt-1 custom-switches-stacked">
                                                        <label class="custom-switch pl-0 d-flex align-items-center mb-0">
                                                            ...
                                                            <span class="custom-switch-indicator"></span>
                                                            <label class="custom-switch-description mb-0 cursor-pointer" for="forumStatusSwitch_{{ $subForum->id }}">{{ trans('lms/admin/main.active') }}</label>
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="form-group mb-0 mt-1 custom-switches-stacked">
                                                        <label class="custom-switch pl-0 d-flex align-items-center mb-0">
                                                            ...
                                                            <span class="custom-switch-indicator"></span>
                                                            <label class="custom-switch-description mb-0 cursor-pointer" for="forumCloseSwitch_{{ $subForum->id }}">{{ trans('lms/admin/main.close') }}</label>
                                                        </label>
                                                    </div>
                                                </li>
                                            @endforeach
                            ...
                            <li class="form-group main-row list-group d-none border rounded-lg p-2">
                                ...
                                <div class="form-group mb-0 mt-1">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="sub_forums[record][icon]" id="icon_record" class="form-control" placeholder="{{ trans('lms/admin/main.icon') }}"/>
                                    </div>
                                </div>

                                <textarea name="sub_forums[record][description]"
                                          class="form-control w-auto flex-grow-1 mt-1" placeholder="{{ trans('lms/update.category_description') }}"></textarea>

                                <div class="form-group mb-0 mt-1">
                                    <label class="input-label d-block mb-0">{{ trans('lms/admin/main.group') }}</label>
                                    <select name="sub_forums[record][group_id]" class="form-control">
                                        <option value="" selected disabled>{{ trans('lms/admin/main.select_users_group') }}</option>
                                ...
                                <div class="form-group mb-0 mt-1 custom-switches-stacked">
                                    <label class="custom-switch pl-0 d-flex align-items-center mb-0">
                                        ...
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="forumStatusSwitch_record">{{ trans('lms/admin/main.active') }}</label>
                                    </label>
                                </div>
                                ...
                                <div class="form-group mb-0 mt-1 custom-switches-stacked">
                                    <label class="custom-switch pl-0 d-flex align-items-center mb-0">
                                        ...
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="forumCloseSwitch_record">{{ trans('lms/admin/main.close') }}</label>
                                    </label>
                                </div>
                            </li>
