                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-left">{{ trans('lms/admin/main.type') }}</th>
                                        <th class="text-center">{{ trans('lms/admin/main.message') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left" width="30%">
                                                @if(!empty($report->topic_id))
                                                    {{ trans('lms/public.topic') }}
                                                @else
                                                    {{ trans('lms/admin/main.post') }}
                                                @endif
                                            </td>
                                            ...
                                            <td width="150px" class="text-center">
                                                @if($authUser->can('admin_webinar_reports_delete'))
                                                    @include('lms.admin.includes.delete_button',['url' => '/lms'.getAdminPanelUrl().'/reports/forum-topics/'.$report->id.'/delete','btnClass' => 'btn-sm'])
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
