                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($featuredTopics as $feature)
                                        ...
                                        <tr>
                                            <td>
                                                <img src="{{get_path_lms()}}{{ $feature->icon }}" alt="" width="48" height="48" class="">
                                            </td>
                                            ...
                                            <td width="150">
                                                ...
                                                @if($authUser->can('admin_featured_topics_edit'))
                                                    <a href="/lms{{ getAdminPanelUrl() }}/featured-topics/{{ $feature->id }}/edit" class="btn-sm" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/admin/main.edit') }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endif

                                                @if($authUser->can('admin_featured_topics_delete'))
                                                    @include('lms.admin.includes.delete_button',['url' => '/lms'.getAdminPanelUrl().'/featured-topics/'. $feature->id .'/delete','btnClass' => 'btn-sm','icon' => true])
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
