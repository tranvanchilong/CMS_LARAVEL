                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <form action="/lms{{ getAdminPanelUrl() }}/recommended-topics/{{ !empty($recommended) ? $recommended->id.'/update' : 'store'  }}" method="post">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            <label class="input-label d-block">{{ trans('lms/update.topics') }}</label>
                                            <select name="topic_ids[]" multiple="multiple" class="form-control search-forum-topic-select2 @error('topic_id') is-invalid @enderror" data-placeholder="{{ trans('lms/update.search_topic') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{trans('lms/update.recommended_topics_hint_title1')}}</div>
                        <div class=" text-small font-600-bold mb-2">{{trans('lms/update.recommended_topics_hint_description1')}}</div>
                    </div>
                </div>

                <div class="col-md-6">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{trans('lms/update.recommended_topics_hint_title2')}}</div>
                        <div class=" text-small font-600-bold mb-2">{{trans('lms/update.recommended_topics_hint_description1')}}</div>
                    </div>
                </div>
            </div>
