                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-4">
                                    <form action="/lms{{ getAdminPanelUrl() }}/store/settings" method="post">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="page" value="general">
                                        <input type="hidden" name="name" value="{{ \App\Models\LMS\Setting::$storeSettingsName }}">
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="storeStatusSwitch">{{ trans('lms/admin/main.active') }}</label>
                                            </label>
                                            <div class="text-muted text-small">{{ trans('lms/update.admin_store_setting_active_hint') }}</div>
                                        </div>

                                        <div class="form-group">
                                            <label>{{ trans('lms/update.virtual_product_commission') }}</label>
                                            ...
                                            <div class="text-muted text-small mt-1">{{ trans('lms/update.virtual_product_commission_setting_hint') }}</div>
                                        </div>

                                        <div class="form-group">
                                            <label>{{ trans('lms/update.physical_product_commission') }}</label>
                                            ...
                                            <div class="text-muted text-small mt-1">{{ trans('lms/update.physical_product_commission_setting_hint') }}</div>
                                        </div>

                                        <div class="form-group">
                                            <label>{{ trans('lms/admin/main.tax') }}</label>
                                            ...
                                            <div class="text-muted text-small mt-1">{{ trans('lms/update.admin_store_setting_tax_hint') }}</div>
                                        </div>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <span class="custom-switch-indicator"></span>
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="possibilityCreateVirtualProductSwitch">{{ trans('lms/update.possibility_create_virtual_product') }}</label>
                                            </label>
                                            <div class="text-muted text-small">{{ trans('lms/update.possibility_create_virtual_product_hint') }}</div>
                                        </div>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <span class="custom-switch-indicator"></span>
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="possibilityCreatePhysicalProductSwitch">{{ trans('lms/update.possibility_create_physical_product') }}</label>
                                            </label>
                                            <div class="text-muted text-small">{{ trans('lms/update.possibility_create_physical_product_hint') }}</div>
                                        </div>

                                        <div class="form-group">
                                            <label>{{ trans('lms/update.shipping_tracking_url') }}</label>
                                            ...
                                            <div class="text-muted text-small mt-1">{{ trans('lms/update.shipping_tracking_url_hint') }}</div>
                                        </div>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <span class="custom-switch-indicator"></span>
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="activateCommentsSwitch">{{ trans('lms/update.admin_store_setting_activate_comments') }}</label>
                                            </label>
                                            <div class="text-muted text-small">{{ trans('lms/update.admin_store_setting_activate_comments_hint') }}</div>
                                        </div>
