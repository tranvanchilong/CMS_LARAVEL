                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-8 col-lg-6">
                            <form action="/lms{{ getAdminPanelUrl() }}/store/discounts/{{ !empty($discount) ? $discount->id.'/update' : 'store' }}"
                                  method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label>{{ trans('lms/update.product') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="input-label">{{ trans('lms/admin/main.usable_times') }}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control custom-select @error('status')  is-invalid @enderror">
                                        <option value="active" {{ !empty($discount) and $discount->status == 'active' ? 'selected' : '' }}>{{ trans('lms/panel.active') }}</option>
                                        <option value="inactive" {{ !empty($discount) and $discount->status == 'inactive' ? 'selected' : '' }}>{{ trans('lms/panel.inactive') }}</option>
                                    </select>
                                    @error('status')
                                    <div class="invalid-feedback">
                                        {{ $message }}
