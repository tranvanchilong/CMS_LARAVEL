        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <a href="/lms{{ getAdminPanelUrl() }}/store/specifications">{{ trans('lms/update.specifications') }}</a>
                </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="/lms{{ getAdminPanelUrl() }}/store/specifications/{{ !empty($specification) ? $specification->id.'/update' : 'store' }}"
                                  method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group mb-0">
                                    <label class="">{{ trans('lms/admin/main.categories') }}</label>
                                    @error('category')
                                ...
                                <div class="form-group mt-4">
                                    <label class="input-label">{{ trans('lms/update.input_type') }}:</label>
                                    ...
                                    <div class="d-flex align-items-center" id="inputTypes">
                                        <div class="custom-control mr-2 custom-radio">
                                            ...
                                            <label class="custom-control-label cursor-pointer" for="textarea">{{ trans('lms/update.textarea') }}</label>
                                        </div>
                                        ...
                                        <div class="custom-control mr-2 custom-radio ml-15">
                                            ...
                                            <label class="custom-control-label cursor-pointer" for="multi_value">{{ trans('lms/update.multi_value') }}</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6">
                                        <div id="multiValues" class="ml-0 {{ (!empty($multiValues) and !$multiValues->isEmpty()) ? '' : ' d-none' }}">
                                            <div class="d-flex align-items-center justify-content-between mb-4">
                                                <strong class="d-block">{{ trans('lms/update.multi_value') }}</strong>
...
@push('scripts_bottom')
    <script src="/assets/lms/assets/default/js/admin/store/specification.min.js"></script>
@endpush
