<div class="d-none" id="productFileModal">
    ...
    <form action="/lms{{ getAdminPanelUrl() }}/store/products/files/store" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group js-file-path-input">
            <div class="local-input input-group">
                ...
                <input type="text" name="path" id="file_path_record" value="" class="js-file_path form-control" placeholder="{{ trans('lms/webinars.file_upload_placeholder') }}"/>
                <div class="invalid-feedback"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="description" rows="4" class="js-description form-control" placeholder="{{ trans('lms/public.description') }}"></textarea>
            <div class="invalid-feedback"></div>
        </div>
        ...
        <div class="form-group mt-20">
            <div class="d-flex align-items-center justify-content-between">
                <label class="cursor-pointer input-label mr-2" for="fileStatusSwitch_record">{{ trans('lms/public.active') }}</label>
                <div class="custom-control custom-switch">
