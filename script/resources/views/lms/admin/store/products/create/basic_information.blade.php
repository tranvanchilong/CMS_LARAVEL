    ...
    <div class="row">
        <div class="col-12 col-md-5">
            ...
            <div class="form-group mt-15 ">
                <label class="input-label d-block">{{ trans('lms/update.select_a_creator') }}</label>
            ...
            <div class="form-group ">
                <label class="input-label d-block">{{ trans('lms/public.type') }}</label>

                <select name="type" class="custom-select @error('type')  is-invalid @enderror">
                    <option value="physical" @if(!empty($product) and $product->isPhysical()) selected @endif>{{ trans('lms/update.physical') }}</option>
                    <option value="virtual" @if(!empty($product) and $product->isVirtual()) selected @endif>{{ trans('lms/update.virtual') }}</option>
                </select>
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('lms/update.product_url') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.product_url_hint') }}</div>
                @error('slug')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('lms/admin/main.tax') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.product_tax_hint') }}</div>
                @error('tax')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                <label class="input-label">{{ trans('lms/admin/main.commission') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.product_commission_hint') }}</div>
                @error('commission')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="seo_description" value="{{ (!empty($product) and !empty($product->translate($locale))) ? $product->translate($locale)->seo_description : old('seo_description') }}" class="form-control @error('seo_description')  is-invalid @enderror " placeholder="{{ trans('lms/forms.50_160_characters_preferred') }}"/>
            ...
            <div class="form-group">
                ...
                <textarea name="summary" rows="6" class="form-control @error('summary')  is-invalid @enderror " placeholder="{{ trans('lms/update.product_summary_placeholder') }}">{{ (!empty($product) and !empty($product->translate($locale))) ? $product->translate($locale)->summary : old('summary') }}</textarea>
                @error('summary')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <textarea id="summernote" name="description" class="form-control @error('description')  is-invalid @enderror" placeholder="{{ trans('lms/forms.webinar_description_placeholder') }}">{!! (!empty($product) and !empty($product->translate($locale))) ? $product->translate($locale)->description : old('description')  !!}</textarea>
                @error('description')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="form-group mb-1 d-flex align-items-center">
                <label class="cursor-pointer mb-0 input-label mr-2" for="orderingSwitch">{{ trans('lms/update.enable_ordering') }}</label>
            ...
            <p class="text-gray font-12">{{ trans('lms/update.create_product_enable_ordering_hint') }}</p>
        </div>
    </div>
</section>
