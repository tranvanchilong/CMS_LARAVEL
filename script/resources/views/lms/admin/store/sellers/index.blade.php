                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="role_name" class="form-control">
                                        ...
                                        <option value="{{ \App\Models\LMS\Role::$teacher }}" @if(request()->get('role_name') == \App\Models\LMS\Role::$teacher) selected @endif>{{ trans('lms/home.instructors') }}</option>
                                        <option value="{{ \App\Models\LMS\Role::$organization }}" @if(request()->get('role_name') == \App\Models\LMS\Role::$organization) selected @endif>{{ trans('lms/home.organizations') }}</option>
                                        <option value="{{ \App\Models\LMS\Role::$admin }}" @if(request()->get('role_name') == \App\Models\LMS\Role::$admin) selected @endif>{{ trans('lms/admin/main.admin') }}</option>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th>{{ trans('lms/admin/main.total_sales') }}</th>
                                        <th>{{ trans('lms/update.pending_orders') }}</th>
