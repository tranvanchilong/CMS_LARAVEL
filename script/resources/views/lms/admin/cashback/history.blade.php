            ...
            <div class="row">
                    ...
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('lms/update.cashback_users')}}</h4>
                            </div>
                            <div class="card-body">
                                {{ $totalUsers }}
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('lms/update.total_purchase')}}</h4>
                            </div>
                            <div class="card-body">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h4>{{trans('lms/update.total_cashback')}}</h4>
                            </div>
                            <div class="card-body">
                ...
                <div class="card-body">
                    <form method="get" class="mb-0">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="input-label">{{trans('lms/update.min_purchase_amount')}}</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="input-label">{{trans('lms/update.min_cashback_amount')}}</label>
                        ...
                        <div class="card-header">
                            @if($authUser->can('admin_cashback_transactions'))
                                <div class="text-right">
                                    <a href="/lms{{ getAdminPanelUrl('/cashback/history/excel?'. http_build_query(request()->all())) }}" class="btn btn-primary">{{ trans('lms/admin/main.export_xls') }}</a>
                                </div>
                            @endif
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14 ">
                                    <tr>
                                        ...
                                        <th>{{trans('lms/update.total_purchase')}}</th>
                                        <th>{{trans('lms/update.total_cashback')}}</th>
                                        <th>{{trans('lms/update.last_cashback')}}</th>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center mb-2" width="120">
                                                @if($authUser->can('admin_users_impersonate'))
                                                    <a href="/lms{{ getAdminPanelUrl() }}/users/{{ $transaction->user_id }}/impersonate" target="_blank" class="btn-transparent  text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/admin/main.login') }}">
                                                        <i class="fa fa-user-shield"></i>
                                                    </a>
                                                @endif

                                                @if($authUser->can('admin_users_edit'))
                                                    <a href="/lms{{ getAdminPanelUrl() }}/users/{{ $transaction->user_id }}/edit" class="btn-transparent  text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/admin/main.edit') }}">
                                                ...
                                                @if($authUser->can('admin_cashback_transactions'))
                                                    @include('lms.admin.includes.delete_button',[
                                                            'url' => '/lms'.getAdminPanelUrl("/users/{$transaction->user_id}/disable_cashback_toggle"),
                                                            'tooltip' => $transaction->user->disable_cashback ? trans('lms/update.enable_cashback') : trans('lms/update.disable_cashback'),
