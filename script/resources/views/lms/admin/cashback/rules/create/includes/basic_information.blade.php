<div class="row">
    <div class="col-12 col-md-5">
        ...
        <div class="form-group ">
            <label class="input-label">{{ trans('lms/admin/main.users') }}</label>

            <select name="users_ids[]" class="custom-select search-user-select2" multiple data-placeholder="{{ trans('lms/public.search_user') }}">
            ...
            <div class="text-muted text-small mt-1">{{ trans('lms/update.cashback_users_hint') }}</div>
            @error('users_ids')
        ...
        <div class="form-group ">
            ...
            <div class="text-muted text-small mt-1">{{ trans('lms/update.cashback_user_groups_hint') }}</div>
            @error('group_ids')
            <div class="invalid-feedback d-block">
                {{ $message }}
            </div>
        ...
        <div class="form-group">
            ...
            <div class="text-muted text-small mt-1">{{ trans('lms/update.cashback_start_date_hint') }}</div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="text-muted text-small mt-1">{{ trans('lms/update.cashback_end_date_hint') }}</div>
        </div>
