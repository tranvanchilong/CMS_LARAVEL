    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="/lms{{ getAdminPanelUrl('/upcoming_courses') }}">{{ trans('lms/update.upcoming_courses') }}</a></div>
                <div class="breadcrumb-item"><span>{{ trans('lms/update.followers') }}</span></div>
            </div>
        </div>
    </section>
            ...
            <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                    <div class="card-header">
                        <h4>{{ trans('lms/update.total_followers') }}</h4>
                    </div>
                    <div class="card-body">
                        {{ $totalFollowers }}
                    </div>
            ...
            <div class="table-responsive text-center">
                <table class="table table-striped font-14">
                    <tr>
                        ...
                        <th class="">{{ trans('lms/admin/main.role') }}</th>
                        <th>{{ trans('lms/update.followed_at') }}</th>
                            ...
                            <td class="text-center mb-2" width="120">
                                ...
                                @if($authUser->can('admin_upcoming_courses_followers'))
                                    @include('lms.admin.includes.delete_button',[
                                                'url' => '/lms'.getAdminPanelUrl('/upcoming_courses/'. $upcomingCourse->id .'/followers/'. $follower->id .'/delete'),
                                                'tooltip' => trans('lms/update.unfollow_course'),
                                            ])
                                @endif
                            </td>
