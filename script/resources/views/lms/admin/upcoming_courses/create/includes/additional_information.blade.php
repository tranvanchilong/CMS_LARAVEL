<div class="row">
    <div class="col-12 col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="text-muted text-small mt-1">{{ trans('lms/update.upcoming_sections_hint') }}</div>
            @error('sections')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="form-group">
            ...
            <div class="text-muted text-small mt-1">{{ trans('lms/update.upcoming_parts_hint') }}</div>
            @error('parts')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="form-group">
            ...
            <input type="number" min="0" name="course_progress" value="{{ (!empty($upcomingCourse) and !empty($upcomingCourse->course_progress)) ? $upcomingCourse->course_progress : old('course_progress') }}" class="form-control @error('course_progress')  is-invalid @enderror" placeholder="{{ trans('lms/update.progress_placeholder') }}"/>
            <div class="text-muted text-small mt-1">{{ trans('lms/update.upcoming_progress_hint') }}</div>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                    <label class="cursor-pointer input-label" for="certificateSwitch">{{ trans('lms/update.include_certificate') }}</label>
                    <div class="custom-control custom-switch">
                ...
                <div class="form-group mt-30 d-flex align-items-center justify-content-between">
                    <label class="cursor-pointer input-label" for="quizzesSwitch">{{ trans('lms/update.certificate_included') }}</label>
                    <div class="custom-control custom-switch">
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" name="tags" data-max-tag="5" value="{{ !empty($upcomingCourse) ? implode(',', $upcomingCourseTags) : '' }}" class="form-control inputtags" placeholder="{{ trans('lms/public.type_tag_name_and_press_enter') }} ({{ trans('lms/admin/main.max') }} : 5)"/>
        </div>
        ...
        <div class="form-group mt-15">
            ...
            <select id="categories" class="custom-select @error('category_id')  is-invalid @enderror" name="category_id" required>
                <option {{ !empty($upcomingCourse) ? '' : 'selected' }} disabled>{{ trans('lms/public.choose_category') }}</option>
