...
@section('content')
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <a href="/lms{{ getAdminPanelUrl('/upcoming_courses') }}">{{ trans('lms/update.upcoming_courses') }}</a>
                </div>
                <div class="breadcrumb-item">{{!empty($upcomingCourse) ?trans('lms//admin/main.edit'): trans('lms/admin/main.new') }}</div>
            </div>
        </div>
                ...
                <div class="col-12 ">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="/lms{{ getAdminPanelUrl('/upcoming_courses/'. (!empty($upcomingCourse) ? $upcomingCourse->id.'/update' : 'store')) }}" id="upcomingCourseForm" class="webinar-form">
                                {{ csrf_field() }}
                                ...
                                <section>
                                    ...
                                    {{-- Basic Information --}}
                                    @include('lms.admin.upcoming_courses.create.includes.basic_information')
                                </section>
                                ...
                                <section class="mt-3">
                                    ...
                                    @include('lms.admin.upcoming_courses.create.includes.additional_information')
                                </section>

                                @if(!empty($upcomingCourse))

                                    {{-- FAQ --}}
                                    @include('lms.admin.upcoming_courses.create.includes.faq')

                                    {{-- Extra Description --}}
                                    @include('lms.admin.upcoming_courses.create.includes.extraDescription')
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="button" id="saveAndPublish" class="btn btn-success">{{ !empty($upcomingCourse) ? trans('lms/admin/main.save_and_publish') : trans('lms/admin/main.save_and_continue') }}</button>
    ...
    @include('lms.admin.upcoming_courses.create.includes.modals.faq')
    @include('lms.admin.upcoming_courses.create.includes.modals.extra_description')
...
@push('scripts_bottom')
    ...
    <script src="/assets/lms/assets/admin/js/create_upcoming_course.min.js"></script>
@endpush
