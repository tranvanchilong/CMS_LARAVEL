    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ trans('lms/admin/main.additional_pages_title') }}</div>
            </div>
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="/lms{{ getAdminPanelUrl() }}/pages/{{ !empty($page) ? $page->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/admin/main.link') }}</label>
                                            ...
                                            @enderror
                                            <div class="text-muted text-small mt-1">{{ trans('lms/admin/main.new_page_link_hint') }}</div>
                                        </div>

                                        <div class="form-group">
                                            <label>{{ trans('lms/admin/main.title') }}</label>
                                            <input type="text" name="title" class="form-control  @error('title') is-invalid @enderror"
                                                   value="{{ !empty($page) ? $page->title : old('title') }}" placeholder="{{ trans('lms/admin/main.pages_title_placeholder') }}"/>
                                            @error('title')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/admin/main.seo_description') }}</label>
                                ...
                                <div class="form-group custom-switches-stacked">
                                    ...
                                    <label class="custom-switch pl-0">
                                        <label class="custom-switch-description mb-0 mr-2">{{ trans('lms/admin/main.draft') }}</label>
                                        ...
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="pageStatus">{{ trans('lms/admin/main.publish') }}</label>
                                    </label>
                                </div>

                                <div class="form-group custom-switches-stacked">
                                    <label class="input-label">{{ trans('lms/admin/main.robot') }}:</label>
                                    <label class="custom-switch pl-0">
                                        <label class="custom-switch-description mb-0 mr-2">{{ trans('lms/admin/main.no_follow') }}</label>
                                        ...
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="pageRobot">{{ trans('lms/admin/main.follow') }}</label>
                                    </label>
                                </div>
