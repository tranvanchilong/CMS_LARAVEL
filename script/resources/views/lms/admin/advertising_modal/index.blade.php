...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('lms/update.advertising_modal') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/lms{{ getAdminPanelUrl() }}">{{ trans('lms/admin/main.dashboard') }}</a></div>
                <div class="breadcrumb-item">{{ trans('lms/update.advertising_modal') }}</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/lms{{ getAdminPanelUrl() }}/advertising_modal" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/update.button') }} 1</label>
                                            <div class="row">
                                                <div class="col-6">
                                                    <label>{{ trans('lms/admin/main.title') }}</label>
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/update.button') }} 2</label>
                                            <div class="row">
                                                <div class="col-6">
                                                    <label>{{ trans('lms/admin/main.title') }}</label>
                                        ...
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0 d-flex align-items-center">
                                                ...
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="advertiseModalStatusSwitch">{{ trans('lms/admin/main.active') }}</label>
                                            </label>
                                            <div class="text-muted text-small mt-1">{{ trans('lms/update.advertising_modal_status_hint') }}</div>
                                        </div>
                                ...
                                <div class="">
                                    ...
                                    <button type="button" class="js-preview-modal btn btn-warning ml-2">{{ trans('lms/update.preview') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@push('scripts_bottom')
    ...
    <script src="/assets/lms/assets/default/js/admin/advertising_modal.min.js"></script>
@endpush
