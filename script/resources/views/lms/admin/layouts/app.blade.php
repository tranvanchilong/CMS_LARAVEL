...
<head>
    ...
    @if($isRtl)
        <link rel="stylesheet" href="/assets/lms/assets/admin/css/rtl.css">
    @endif
...
<div id="app">
    <div class="main-wrapper">
        @include('lms.admin.includes.navbar')

        @include('lms.admin.includes.sidebar')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ trans('lms/public.close') }}</button>
                </div>
            </div>
        </div>
    </div>
