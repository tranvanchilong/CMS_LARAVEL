        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    {{ trans('lms/update.installment_purchases') }}
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="/lms{{ getAdminPanelUrl("/financial/installments/purchases/export") }}" class="btn btn-primary">{{ trans('lms/admin/main.export_xls') }}</a>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th>{{ trans('lms/update.installment_plan') }}</th>
                                        ...
                                        <th class="text-center">{{ trans('lms/update.overdue') }}</th>
                                        <th class="text-center">{{ trans('lms/update.overdue_amount') }}</th>
                                        <th class="text-center">{{ trans('lms/update.first_unpaid_installment_date') }}</th>
                                        <th class="text-center">{{ trans('lms/update.days_left') }}</th>
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        ...
                                                        @if($authUser->can('admin_installments_orders'))
                                                            @include('lms.admin.includes.delete_button',[
                                                                    'url' => '/lms'.getAdminPanelUrl("/financial/installments/orders/{$order->id}/cancel"),
                                                                    'btnClass' => 'd-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm mt-1',
                                                                    'btnText' => '<i class="fa fa-times"></i><span class="ml-2">'. trans("lms/admin/main.cancel") .'</span>'
                                                                    ])


                                                            @include('lms.admin.includes.delete_button',[
                                                                    'url' => '/lms'.getAdminPanelUrl("/financial/installments/orders/{$order->id}/refund"),
                                                                    'btnClass' => 'd-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm mt-1',
                                                                    'btnText' => '<i class="fa fa-times-circle"></i><span class="ml-2">'. trans("lms/admin/main.refund") .'</span>'
                                                                    ])
                                                        @endif
                                                    </div>
                                                </div>
