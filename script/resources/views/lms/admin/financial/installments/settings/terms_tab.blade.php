@php
    $termsSetting = $settings->where('name', \App\Models\LMS\Setting::$installmentsTermsSettingsName)->first();
...
<form action="/lms{{ getAdminPanelUrl('/financial/installments/settings') }}" method="post">
    ...
    <input type="hidden" name="name" value="{{ \App\Models\LMS\Setting::$installmentsTermsSettingsName }}">
