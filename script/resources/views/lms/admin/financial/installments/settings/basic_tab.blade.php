@php
    $basicSetting = $settings->where('name', \App\Models\LMS\Setting::$installmentsSettingsName)->first();
...
<div class="row">
    <div class="col-12 col-md-6">
        <form action="/lms{{ getAdminPanelUrl('/financial/installments/settings') }}" method="post">
            {{ csrf_field() }}
            <input type="hidden" name="page" value="general">
            <input type="hidden" name="name" value="{{ \App\Models\LMS\Setting::$installmentsSettingsName }}">
            <input type="hidden" name="locale" value="{{ \App\Models\LMS\Setting::$defaultSettingsLocale }}">
            ...
            <div class="form-group custom-switches-stacked">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <label class="custom-switch-description mb-0 cursor-pointer" for="installmentStatusSwitch">{{ trans('lms/admin/main.active') }}</label>
                </label>
                <div class="text-muted text-small">{{ trans('lms/update.installment_setting_active_hint') }}</div>
            </div>
            ...
            <div class="form-group custom-switches-stacked">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <span class="custom-switch-indicator"></span>
                    <label class="custom-switch-description mb-0 cursor-pointer" for="disableCourseSwitch">{{ trans('lms/update.disable_course_access_when_user_have_an_overdue_installment') }}</label>
                </label>
                <div class="text-muted text-small">{{ trans('lms/update.disable_course_access_when_user_have_an_overdue_installment_hint') }}</div>
            </div>
            ...
            <div class="form-group custom-switches-stacked">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <span class="custom-switch-indicator"></span>
                    <label class="custom-switch-description mb-0 cursor-pointer" for="disableAllCourseSwitch">{{ trans('lms/update.disable_all_courses_access_when_user_have_an_overdue_installment') }}</label>
                </label>
                <div class="text-muted text-small">{{ trans('lms/update.disable_all_courses_access_when_user_have_an_overdue_installment_hint') }}</div>
            </div>
            ...
            <div class="form-group custom-switches-stacked">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <span class="custom-switch-indicator"></span>
                    <label class="custom-switch-description mb-0 cursor-pointer" for="disableWhenOverdueSwitch">{{ trans('lms/update.disable_instalments_when_the_user_have_an_overdue_installment') }}</label>
                </label>
                <div class="text-muted text-small">{{ trans('lms/update.disable_instalments_when_the_user_have_an_overdue_installment_hint') }}</div>
            </div>
            ...
            <div class="form-group custom-switches-stacked">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <span class="custom-switch-indicator"></span>
                    <label class="custom-switch-description mb-0 cursor-pointer" for="allowCancelVerificationSwitch">{{ trans('lms/update.allow_cancel_verification') }}</label>
                </label>
                <div class="text-muted text-small">{{ trans('lms/update.allow_cancel_verification_hint') }}</div>
            </div>
            ...
            <div class="form-group custom-switches-stacked">
                <label class="custom-switch pl-0 d-flex align-items-center">
                    ...
                    <span class="custom-switch-indicator"></span>
                    <label class="custom-switch-description mb-0 cursor-pointer" for="displayInstallmentButtonSwitch">{{ trans('lms/update.display_installment_button') }}</label>
                </label>
                <div class="text-muted text-small">{{ trans('lms/update.display_installment_button_hint') }}</div>
            </div>

            <div class="form-group">
                <label>{{ trans('lms/update.overdue_interval_days') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.overdue_interval_days_hint') }}</div>
            </div>

            <div class="form-group">
                <label>{{ trans('lms/update.installment_plans_position') }}</label>
                <select name="value[installment_plans_position]" class="form-control">
                    <option value="top_of_page" {{ (!empty($basicValue) and !empty($basicValue['installment_plans_position']) and $basicValue['installment_plans_position'] == "top_of_page") ? 'selected' : '' }}>{{ trans('lms/update.top_of_page') }}</option>
                    <option value="bottom_of_page" {{ (!empty($basicValue) and !empty($basicValue['installment_plans_position']) and $basicValue['installment_plans_position'] == "bottom_of_page") ? 'selected' : '' }}>{{ trans('lms/update.bottom_of_page') }}</option>
                </select>
                <div class="text-muted text-small mt-1">{{ trans('lms/update.installment_plans_position_hint') }}</div>
            </div>

            <div class="form-group">
                <label>{{ trans('lms/update.reminder_before_overdue_days') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.reminder_before_overdue_days_hint') }}</div>
            </div>

            <div class="form-group">
                <label>{{ trans('lms/update.reminder_after_overdue_days') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.reminder_after_overdue_days_hint') }}</div>
            </div>

            <button type="submit" class="btn btn-primary mt-1">{{ trans('lms/admin/main.submit') }}</button>
        </form>
    </div>
</div>
