        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    {{ trans('lms/update.overdue_history') }}
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="/lms{{ getAdminPanelUrl("/financial/installments/overdue_history/export") }}" class="btn btn-primary">{{ trans('lms/admin/main.export_xls') }}</a>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('lms/update.overdue_date') }}</th>
                                        <th class="text-center">{{ trans('lms/admin/main.status') }}</th>
                                        <th class="text-center">{{ trans('lms/update.paid_date') }}</th>
                                        <th class="text-center">{{ trans('lms/update.late_days') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if(!empty($order->paid_at))
                                                    <span class="text-success">{{ trans('lms/public.paid') }}</span>
                                                @else
                                                    <span class="text-danger">{{ trans('lms/update.unpaid') }}</span>
                                                @endif
                                            </td>
