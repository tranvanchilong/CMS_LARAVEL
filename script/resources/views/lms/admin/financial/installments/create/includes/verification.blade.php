    ...
    <div class="col-12 col-md-8">
        ...
        <div class="mb-20">
            <div class="form-group mt-30 mb-0 d-flex align-items-center">
                <label class="" for="verificationSwitch">{{ trans('lms/update.verification') }}</label>
            ...
            <p class="text-muted font-12">{{ trans('lms/update.installment_verification_hint') }}</p>
        </div>

        <div class="js-verification-fields {{ (!empty($installment) && $installment->verification) ? '' : 'd-none' }}">

            <div class="form-group ">
                <label class="control-label">{{ trans('lms/update.verification_description') }}</label>
                ...
                <div class="text-muted text-small mt-1">{{ trans('lms/update.installment_verification_description_hint') }}</div>
                <div class="invalid-feedback">@error('verification_description') {{ $message }} @enderror</div>
            </div>
            
            <div class="form-group mt-15">
                <label class="input-label">{{ trans('lms/update.verification_banner') }}</label>
                <div class="input-group">
                    ...
                    @enderror
                    <p class="text-muted font-12">{{ trans('lms/update.installment_verification_banner_hint') }}</p>
                </div>
            </div>

            <div class="form-group mt-15">
                <label class="input-label">{{ trans('lms/update.verification_video') }}</label>
                <div class="input-group">
                    <div class="input-group-prepend">
                    ...
                    @enderror
                    <p class="text-muted font-12">{{ trans('lms/update.installment_verification_video_hint') }}</p>
                </div>
            </div>
        ...
        <div class="mb-20">
            <div class="form-group mt-30 mb-0 d-flex align-items-center">
                <label class="" for="request_uploadsSwitch">{{ trans('lms/update.request_uploads') }}</label>
                <div class="custom-control custom-switch ml-3">
            ...
            <p class="text-muted font-12">{{ trans('lms/update.installment_request_uploads_hint') }}</p>
        </div>

        <div class="mb-20">
            <div class="form-group mt-30 mb-0 d-flex align-items-center">
                <label class="" for="bypassSwitch">{{ trans('lms/update.bypass_verification_for_verified_users') }}</label>
                <div class="custom-control custom-switch ml-3">
            ...
            <p class="text-muted font-12">{{ trans('lms/update.installment_bypass_verification_for_verified_users_hint') }}</p>
        </div>
