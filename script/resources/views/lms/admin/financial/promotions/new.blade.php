    ...
    <section class="section">
        ...
        <div class="section-body card">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="section-title ml-4">{{ !empty($promotion) ? trans('lms/admin/main.edit') : trans('lms/admin/main.create') }}</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                        <div class="card-body">
                            <form action="/lms{{ getAdminPanelUrl() }}/financial/promotions/{{ !empty($promotion) ? $promotion->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label>{{ trans('lms/public.days') }}</label>
                                ...
                                <div class="form-group custom-switches-stacked">
                                    <label class="custom-switch pl-0">
                                        ...
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="isPopular">{{ trans('lms/admin/main.is_popular') }}</label>
                                    </label>
                                    <div class="text-muted text-small mt-1">{{ trans('lms/admin/main.is_popular_hint') }}</div>
                                </div>
