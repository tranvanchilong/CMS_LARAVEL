...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('lms/admin/main.new_subscribe') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/lms{{ getAdminPanelUrl() }}">{{trans('lms/admin/main.dashboard')}}</a>
                </div>
                <div class="breadcrumb-item">{{ trans('lms/admin/main.subscribes') }}</div>
            </div>
        </div>
        ...
        <div class="section-body card">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="">
                    <h2 class="section-title ml-4">{{ !empty($subscribe) ? trans('lms/admin/main.edit') : trans('lms/admin/main.create') }}</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                        <div class="card-body">
                            <form action="/lms{{ getAdminPanelUrl() }}/financial/subscribes/{{ !empty($subscribe) ? $subscribe->id.'/update' : 'store' }}" method="Post">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label>{{ trans('lms/admin/main.short_description') }} ({{ trans('lms/admin/main.optional') }})</label>
                                ...
                                <div class="form-group">
                                    <label>{{ trans('lms/admin/main.usable_count') }}</label>
                                ...
                                <div class="form-group custom-switches-stacked">
                                    <label class="custom-switch pl-0">
                                        ...
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="isPopular">{{ trans('lms/admin/pages/financial.is_popular') }}</label>
                                    </label>
                                </div>
                                ...
                                <div class="form-group custom-switches-stacked">
                                    <label class="custom-switch pl-0">
                                        ...
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="infiniteUseSwitch">{{ trans('lms/update.infinite_use') }}</label>
                                    </label>
                                </div>
