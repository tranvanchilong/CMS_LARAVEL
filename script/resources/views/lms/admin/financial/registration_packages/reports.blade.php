        ...
        <div class="row">
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('lms/update.total_buy_instructors_packages') }}</h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('lms/update.total_buy_organization_packages') }}</h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('lms/financial.total_amount') }}</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('lms/public.user_role') }}</th>
                                        ...
                                        <th class="text-center">{{ trans('lms/update.activation_date') }}</th>
                                        <th class="text-center">{{ trans('lms/admin/main.ext_date') }}</th>
                                    </tr>
