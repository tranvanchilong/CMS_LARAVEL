...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('lms/admin/main.seo_metas') }}</h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ trans('lms/admin/main.seo_metas') }}</div>
            </div>
        </div>
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active"
                                       ...
                                       aria-selected="true">{{ trans('lms/update.extra_meta_tags') }}</a>
                                </li>

                                @foreach(\App\Models\LMS\Setting::$pagesSeoMetas as $page)
                                    <li class="nav-item">
                                        <a class="nav-link"
                                           id="{{ $page }}-tab" data-toggle="tab" href="#{{ $page }}"
                                           role="tab" aria-controls="{{ $page }}"
                                           aria-selected="true">{{ trans('lms/admin/main.seo_metas_'.$page) }}</a>
                                    </li>
                                @endforeach
                            </ul>
                                ...
                                <div class="tab-pane mt-3 fade show active" id="extra_meta_tags" role="tabpanel" aria-labelledby="extra_meta_tags-tab">
                                    <div class="row">
                                        <div class="col-12 col-md-8">
                                            <form action="/lms{{ getAdminPanelUrl() }}/settings/seo_metas/store" method="post">
                                            {{ csrf_field() }}

                                                <div class="form-group">
                                                    <label>{{ trans('lms/update.extra_meta_tags') }}</label>
                                                    ...
                                                    <p class="mb-0">- {{ trans('lms/update.extra_meta_tags_hint1') }}</p>
                                                    <p class="mb-0">- {{ trans('lms/update.extra_meta_tags_hint2') }}</p>
                                                    <p class="mb-0">- {{ trans('lms/update.extra_meta_tags_hint3') }}</p>
                                                    <p class="mb-0">- {{ trans('lms/update.extra_meta_tags_hint4') }}</p>
                                                </div>
                                                ...
                                                <form action="/lms{{ getAdminPanelUrl() }}/settings/seo_metas/store" method="post">
                                                    ...
                                                    <div class="form-group custom-switches-stacked">
                                                        <label class="custom-switch pl-0 d-flex align-items-center">
                                                            <label class="custom-switch-description mb-0 mr-2">{{ trans('lms/admin/main.no_index') }}</label>
                                                            ...
                                                            <label class="custom-switch-description mb-0 cursor-pointer" for="{{ $page }}Robot">{{ trans('lms/admin/main.index') }}</label>
                                                        </label>
                                                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{ trans('lms/admin/main.seo_metas_hint_title_1') }}</div>
                        <div class=" text-small font-600-bold mb-2">{{ trans('lms/admin/main.seo_metas_hint_description_1') }}</div>
                    </div>
                </div>

                <div class="col-md-6">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{ trans('lms/admin/main.seo_metas_hint_title_2') }}</div>
                        <div class=" text-small font-600-bold mb-2">{{ trans('lms/admin/main.seo_metas_hint_description_2') }}</div>
                    </div>
                </div>
