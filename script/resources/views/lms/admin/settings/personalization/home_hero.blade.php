            ...
            <form action="/lms{{ getAdminPanelUrl() }}/settings/main" method="post">
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer" for="isVideoBackground">{{ trans('lms/update.is_video_background') }}</label>
                    </label>
                    <div class="text-muted text-small mt-1">{{ trans('lms/update.is_video_background_hint') }}</div>
