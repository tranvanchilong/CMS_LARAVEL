        ...
        <div class="col-12 col-md-6">
            <form action="/lms{{ getAdminPanelUrl() }}/settings/main" method="post">
                ...
                @foreach(['main','rtl'] as $fontType)
                    ...
                    <div class="mt-2">
                        <strong class="font-16 mb-2 text-dark d-block">{{ trans('lms/update.'.$fontType.'_font') }}</strong>

                        <div class="pl-3">
                            <div class="form-group">
                                <label class="input-label">{{ trans('lms/update.regular') }}</label>
                            ...
                            <div class="form-group">
                                <label class="input-label">{{ trans('lms/update.bold') }}</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                            ...
                            <div class="form-group">
                                <label class="input-label">{{ trans('lms/update.medium') }}</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
