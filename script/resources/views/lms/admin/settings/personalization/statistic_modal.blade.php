<div id="addStatisticItemForm"
     data-action="/lms{{ getAdminPanelUrl("/settings/personalization/statistics/". (!empty($editStatistic) ? $editStatistic->id."/updateItem" : 'storeItem')) }}">
    ...
    <div class="form-group">
        <label>{{ trans('lms/admin/main.background') }}</label>
    ...
    <div class="form-group">
        <label>{{ trans('lms/admin/main.count') }}</label>
    ...
    <div class="d-flex align-items-center justify-content-end">
        <button type="button" class="js-save-statistic btn btn-primary">{{ trans('lms/admin/main.save') }}</button>
