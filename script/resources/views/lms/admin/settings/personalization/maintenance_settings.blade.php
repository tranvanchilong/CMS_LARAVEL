...
<div class="mt-3" id="mobile_app">
    ...
    <form action="/lms{{ getAdminPanelUrl() }}/settings/maintenance_settings" method="post">
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    <label class="input-label mb-0">{{ trans('lms/admin/main.title') }}</label>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="value[image]" required id="image" value="{{ (!empty($itemValue) and !empty($itemValue['image'])) ? $itemValue['image'] : '' }}" class="form-control" placeholder="{{ trans('lms/update.maintenance_settings_image_placeholder') }}"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-6">
                            <label class="input-label mb-0">{{ trans('lms/update.button_title') }}</label>
                        ...
                        <div class="col-6">
                            <label class="input-label mb-0">{{ trans('lms/update.button_link') }}</label>
