...
<div class="mt-3" id="mobile_app">
    ...
    <form action="/lms{{ getAdminPanelUrl() }}/settings/mobile_app" method="post">
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    <label class="input-label mb-0">{{ trans('lms/admin/main.image') }}</label>
                    <div class="input-group">
                        ...
                        <input type="text" name="value[mobile_app_hero_image]" required id="mobile_app_hero_image" value="{{ (!empty($itemValue) and !empty($itemValue['mobile_app_hero_image'])) ? $itemValue['mobile_app_hero_image'] : '' }}" class="form-control" placeholder="{{ trans('lms/update.mobile_app_hero_image_placeholder') }}"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group ">
                    <label class="control-label">{{ trans('lms/admin/main.description') }}</label>
            ...
            <div class="col-12 col-md-6">
                ...
                <div id="mobile_app_buttons" class="ml-0">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <strong class="d-block">{{ trans('lms/update.buttons') }}</strong>

                        <button type="button" data-parent="mobile_app_buttons" data-main-row="mobileAppMainRow" class="btn btn-success add-btn"><i class="fa fa-plus"></i> {{ trans('lms/admin/main.add') }}</button>
                    </div>
                    ...
                    @if(!empty($itemValue) and !empty($itemValue['mobile_app_buttons']))
                        @foreach($itemValue['mobile_app_buttons'] as $mobileAppButtonsKey => $mobileAppButtonsValue)
                           ...
                           <label class="input-label mb-0">{{ trans('lms/update.button_label') }}</label>
                                <div class="input-group">
                                ...
                                <div class="form-group mb-0 mt-1">
                                    <label class="input-label mb-0">{{ trans('lms/admin/main.link') }}</label>
                                    <input type="text" required name="value[mobile_app_buttons][{{ $mobileAppButtonsKey }}][link]"
                                           class="form-control w-100 flex-grow-1"
                                           placeholder="{{ trans('lms/admin/main.link') }}"
                                           value="{{ $mobileAppButtonsValue['link'] ?? '' }}"
                                    />
                                </div>

                                <div class="form-group mb-0 mt-1">
                                    <label class="input-label mb-0">{{ trans('lms/admin/main.icon') }}</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" required
                                               ...
                                               class="form-control" placeholder="{{ trans('lms/update.mobile_app_button_icon_placeholder') }}"
                                ...
                                <div class="form-group mb-0 mt-1">
                                    <label class="input-label mb-0">{{ trans('lms/update.color') }}</label>
  ...
  <div class="input-group">
    ...
    <div class="form-group mb-0 mt-1">
        ...
        <div class="input-group">
            ...
            <input type="text" name="value[mobile_app_buttons][record][icon]" required id="mobile_app_button_icon_record" class="form-control" placeholder="{{ trans('lms/update.mobile_app_button_icon_placeholder') }}"/>
        </div>
    </div>
...
@push('scripts_bottom')
    ...
    <script src="/assets/lms/assets/default/js/admin/settings/cookie_settings.min.js"></script>
@endpush
