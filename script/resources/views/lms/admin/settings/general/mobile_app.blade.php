            ...
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="value[mobile_app_hero_image]" id="mobile_app_hero_image" value="{{ (!empty($itemValue) and !empty($itemValue['mobile_app_hero_image'])) ? $itemValue['mobile_app_hero_image'] : '' }}" class="form-control" placeholder="{{ trans('lms/update.mobile_app_hero_image_placeholder') }}"/>
                    </div>
                </div>
            </div>
        </div>
...
<div id="mobileAppMainRow" class="form-group p-2 border rounded-lg d-none">
    ...
    <div class="form-group mb-0 mt-1">
        ...
        <div class="input-group">
            ...
            <input type="text" name="value[mobile_app_buttons][record][icon]" id="mobile_app_button_icon_record" class="form-control" placeholder="{{ trans('lms/update.mobile_app_button_icon_placeholder') }}"/>
        </div>
    </div>
