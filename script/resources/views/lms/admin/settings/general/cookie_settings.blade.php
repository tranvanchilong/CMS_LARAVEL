...
<div class="tab-pane mt-3 fade" id="cookie_settings" role="tabpanel" aria-labelledby="cookie_settings-tab">
    ...
    <form action="/lms{{ getAdminPanelUrl() }}/settings/cookie_settings" method="post">
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-12">
                <h5 class="mb-3">{{ trans('lms/update.cookie_settings_modal') }}</h5>
            ...
            <div class="col-12 col-md-6">
                <div id="cookie_settings_modal_items" class="ml-0">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <strong class="d-block">{{ trans('lms/admin/main.items') }}</strong>

                        <button type="button" data-parent="cookie_settings_modal_items" data-main-row="cookieSettingsItemsMainRow" class="btn btn-success add-btn"><i class="fa fa-plus"></i> {{ trans('lms/admin/main.add') }}</button>
                    </div>
                        ...
                        @foreach($itemValue['cookie_settings_modal_items'] as $modalItemKey => $modalItemValue)
                            <div class="form-group list-group p-2 border rounded-lg">
                                ...
                                <textarea name="value[cookie_settings_modal_items][{{ $modalItemKey }}][description]"
                                          ...
                                          placeholder="{{ trans('lms/admin/main.description') }}"
                                ...
                                <div class="form-group mb-0 mt-1 custom-switches-stacked">
                                    <label class="custom-switch pl-0">
                                        ...
                                        <span class="custom-switch-indicator"></span>
                                        <label class="custom-switch-description mb-0 cursor-pointer" for="requiredSwitch_{{ $modalItemKey }}">{{ trans('lms/public.required') }}</label>
                                    </label>
                                </div>
                            </div>
                        @endforeach
...
<div id="cookieSettingsItemsMainRow" class="form-group p-2 border rounded-lg d-none">
    ...
    <textarea name="value[cookie_settings_modal_items][record][description]"
              class="form-control w-100 flex-grow-1 mt-1" rows="4" placeholder="{{ trans('lms/admin/main.description') }}"></textarea>
    ...
    <div class="form-group mb-0 mt-1 custom-switches-stacked">
        <label class="custom-switch pl-0">
            ...
            <span class="custom-switch-indicator"></span>
            <label class="custom-switch-description mb-0 cursor-pointer" for="requiredSwitch_record">{{ trans('lms/public.required') }}</label>
        </label>
    </div>
</div>
