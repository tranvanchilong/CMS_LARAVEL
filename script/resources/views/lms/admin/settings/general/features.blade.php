...
<div class="tab-pane mt-3 fade" id="features" role="tabpanel" aria-labelledby="features-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/lms{{ getAdminPanelUrl() }}/settings/features" method="post">
                {{ csrf_field() }}
                <input type="hidden" name="page" value="general">
                <input type="hidden" name="features" value="features">

                <div class="mb-5">
                    <h5>{{ trans('lms/update.agora') }} {{ trans('lms/admin/main.settings') }}</h5>

                    <div class="form-group">
                        <label>{{ trans('lms/update.agora') }} {{ trans('lms/update.resolution') }}</label>

                        <select class="form-control" name="value[agora_resolution]">
                            <option value="">{{ trans('lms/admin/main.select') }} {{ trans('lms/update.resolution') }}</option>
                    ...
                    <div class="form-group">
                        <label>{{ trans('lms/update.max_bitrate') }}</label>
                    ...
                    <div class="form-group">
                        <label>{{ trans('lms/update.min_bitrate') }}</label>
                    ...
                    <div class="form-group">
                        <label>{{ trans('lms/update.frame_rate') }}</label>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <label class="custom-switch-description mb-0 cursor-pointer" for="agoraStreamSwitch">{{ trans('lms/update.agora_live_streaming') }}</label>
                        </label>
                    </div>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="agoraChatSwitch">{{ trans('lms/update.agora_chat') }}</label>
                        </label>
                    </div>
                    {{--
                                        <div class="form-group custom-switches-stacked">
                                            <label class="custom-switch pl-0">
                                                ...
                                                <span class="custom-switch-indicator"></span>
                                                <label class="custom-switch-description mb-0 cursor-pointer" for="agoraRecordingSwitch">{{ trans('lms/update.agora_recording') }}</label>
                                            </label>
                                        </div>
                    --}}
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="agoraInFreeCoursesSwitch">{{ trans('lms/update.agora_in_free_courses') }}</label>
                        </label>
                    </div>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="agoraForMeetingSwitch">{{ trans('lms/update.agora_for_meeting') }}</label>
                        </label>
                        <div class="text-muted text-small mt-1">{{ trans('lms/update.agora_meeting_hint') }}</div>
                    </div>

                    <div class="form-group">
                        <label class="input-label">{{ trans('lms/update.meeting_live_stream_type') }}</label>
                        <select name="value[meeting_live_stream_type]" class="form-control">
                            <option value="single" {{ (!empty($itemValue) and !empty($itemValue['meeting_live_stream_type']) and $itemValue['meeting_live_stream_type'] == 'single') ? 'selected="selected"' : '' }}>{{ trans('lms/update.meeting_single') }}</option>
                            <option value="multiple" {{ (!empty($itemValue) and !empty($itemValue['meeting_live_stream_type']) and $itemValue['meeting_live_stream_type'] == 'multiple') ? 'selected="selected"' : '' }}>{{ trans('lms/update.meeting_multiple') }}</option>
                        </select><label class="label"></label>
                    </div>

                    <div class="form-group">
                        <label class="input-label">{{ trans('lms/update.course_live_stream_type') }}</label>
                        <select name="value[course_live_stream_type]" class="form-control">
                            <option value="single" {{ (!empty($itemValue) and !empty($itemValue['course_live_stream_type']) and $itemValue['course_live_stream_type'] == 'single') ? 'selected="selected"' : '' }}>{{ trans('lms/update.meeting_single') }}</option>
                            <option value="multiple" {{ (!empty($itemValue) and !empty($itemValue['course_live_stream_type']) and $itemValue['course_live_stream_type'] == 'multiple') ? 'selected="selected"' : '' }}>{{ trans('lms/update.meeting_multiple') }}</option>
                        </select><label class="label"></label>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.new_interactive_file') }} {{ trans('lms/admin/main.settings') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="newInteractiveFileSwitch">{{ trans('lms/update.interactive_feature_toggle') }}</label>
                        </label>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.timezone') }} {{ trans('lms/admin/main.settings') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="timezoneInRegisterSwitch">{{ trans('lms/update.timezone_in_register') }}</label>
                        </label>
                    </div>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="timezoneInCreateWebinarSwitch">{{ trans('lms/update.timezone_in_create_webinar') }}</label>
                        </label>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.sequence_content_settings') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="sequenceContentSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    <h5>{{ trans('lms/update.assignment_settings') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="webinarAssignmentSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.private_content_settings') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="webinarPrivateContentSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>

                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.private_content_settings_hint') }}</p>
                    </div>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="disableViewContentAfterUserRegisterSwitch">{{ trans('lms/update.disable_view_content_after_user_register') }}</label>
                        </label>

                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.disable_view_content_after_user_register_hint') }}</p>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.course_forum_settings') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="courseForumSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>

                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.course_forum_settings_status_hint') }}</p>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.forum_settings') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="forumStatusSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>

                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.forum_settings_status_hint') }}</p>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.direct_classes_payment_button_settings') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="directClassesPaymentButtonStatusSwitch">{{ trans('lms/admin/main.classes') }}</label>
                        </label>

                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.direct_classes_payment_button_status_hint') }}</p>
                    </div>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="directBundlesPaymentButtonStatusSwitch">{{ trans('lms/update.bundles') }}</label>
                        </label>

                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.direct_bundles_payment_button_status_hint') }}</p>
                    </div>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="directProductsPaymentButtonStatusSwitch">{{ trans('lms/update.products') }}</label>
                        </label>

                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.direct_products_payment_button_status_hint') }}</p>
                    </div>

                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.cookie_settings_status') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="cookieSettingsSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.mobile_app_status') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="mobileAppSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>
                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.mobile_app_only_hint') }}</p>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.maintenance_status') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="maintenance_statusSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>
                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.maintenance_status_hint') }}</p>
                    </div>

                    <div class="form-group">
                        <label>{{ trans('lms/update.maintenance_access_key') }}</label>
                        ...
                        <p class="text-muted font-12 mt-1">{{ trans('lms/update.maintenance_access_key_hint') }}</p>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.extra_time_to_join') }}</h5>
                    ...
                    <div class="form-group mt-3 mb-0 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="extraTimeToJoinSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>
                    </div>

                    <div class="form-group">
                        <label class="input-label" for="">{{ trans('lms/update.default_time') }}</label>
                        ...
                        <p class="text-muted font-12 mt-1">{{ trans('lms/update.extra_time_hint') }}</p>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.registration_form_options') }}</h5>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="showOtherRegisterMethodSwitch">{{ trans('lms/update.show_other_register_method') }}</label>
                        </label>
                        <p class="font-14">{{ trans('lms/update.show_other_register_method_hint') }}</p>
                    </div>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="showCertificateAdditionalInRegister">{{ trans('lms/update.show_certificate_additional_in_register') }}</label>
                        </label>
                        <p class="font-14">{{ trans('lms/update.show_certificate_additional_in_register_hint') }}</p>
                    </div>
                </div>


                <div class="mb-5">
                    <h5>{{ trans('lms/update.social_login_settings') }}</h5>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="showGoogleLoginButtonSwitch">{{ trans('lms/update.show_google_login_button') }}</label>
                        </label>
                        <p class="font-14">{{ trans('lms/update.show_google_login_button_hint') }}</p>
                    </div>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="showFacebookLoginButton">{{ trans('lms/update.show_facebook_login_button') }}</label>
                        </label>
                        <p class="font-14">{{ trans('lms/update.show_facebook_login_button_hint') }}</p>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.live_chat_widget') }}</h5>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="show_live_chat_widgetSwitch">{{ trans('lms/update.show_live_chat_widget') }}</label>
                        </label>
                        <p class="font-14">{{ trans('lms/update.show_live_chat_widget_hint') }}</p>
                    </div>
                </div>


                <div class="mb-5">
                    <h5>{{ trans('lms/update.cashback') }}</h5>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="cashback_activeSwitch">{{ trans('lms/update.cashback_active') }}</label>
                        </label>
                        <p class="font-14">{{ trans('lms/update.cashback_active_hint') }}</p>
                    </div>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="display_cashback_notice_in_the_product_pageSwitch">{{ trans('lms/update.display_cashback_notice_in_the_product_page') }}</label>
                        </label>
                        <p class="font-14">{{ trans('lms/update.display_cashback_notice_in_the_product_page_hint') }}</p>
                    </div>
                    ...
                    <div class="form-group custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="display_minimum_amount_cashback_noticesSwitch">{{ trans('lms/update.display_minimum_amount_cashback_notices') }}</label>
                        </label>
                        <p class="font-14">{{ trans('lms/update.display_minimum_amount_cashback_notices_hint') }}</p>
                    </div>
                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.session_api') }}</h5>
                    ...
                    @endphp
                    <div class="form-group">
                        <label class="input-label">{{ trans('lms/update.available_session_apis') }}</label>
                        <select name="value[available_session_apis][]" class="form-control select2" multiple>
                            @foreach(\App\Models\LMS\Session::$sessionApis as $sessionApi)
                                <option value="{{ $sessionApi }}" @if(in_array($sessionApi, $selectedApi)) selected @endif>{{ trans('lms/update.session_api_'.$sessionApi) }}</option>
                            @endforeach
                        </select>
                        <p class="text-muted font-12 mt-1">{{ trans('lms/update.session_api_hint') }}</p>
                    </div>
                </div>


                <div class="mb-5">
                    <h5>{{ trans('lms/update.upload_sources') }}</h5>
                    ...
                    <div class="form-group">
                        ...
                        <select name="value[available_sources][]" class="form-control select2" multiple>
                            @foreach(\App\Models\LMS\File::$fileSources as $source)
                                <option value="{{ $source }}" @if(in_array($source, $selectedSources)) selected @endif>{{ trans('lms/update.file_source_'.$source) }}</option>
                            @endforeach
                        </select>
                        <p class="text-muted font-12 mt-1">{{ trans('lms/update.upload_sources_hint') }}</p>
                    </div>
                </div>


                <div class="mb-5">
                    <h5>{{ trans('lms/update.bunny_stream_settings') }} ({{ trans('lms/update.secure_host') }})</h5>
                    ...
                    @foreach($bunnyConfs as $bunnyConf)
                        <div class="form-group">
                            <label class="input-label">{{ trans('lms/update.'.$bunnyConf) }}</label>
                ...
                <div class="mb-5">
                    <h5>{{ trans('lms/update.select_the_role_during_registration') }}</h5>

                    @php
                        $roleItems = [\App\Models\LMS\Role::$teacher, \App\Models\LMS\Role::$organization];
                    ...
                    <div class="form-group">
                        <label class="">{{ trans('lms/update.select_roles') }}</label>
                        <select name="value[select_the_role_during_registration][]" class="form-control select2" multiple>
                            @foreach($roleItems as $roleItem)
                                <option value="{{ $roleItem }}" @if(in_array($roleItem, $selectedRoleItems)) selected @endif>{{ trans('lms/update.role_'.$roleItem) }}</option>
                            @endforeach
                        </select>
                        <p class="text-muted font-12 mt-1">{{ trans('lms/update.select_rules_hint') }}</p>
                    </div>

                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.enable_waitlist') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="waitlist_statusSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>
                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.waitlist_status_hint') }}</p>
                    </div>

                </div>

                <div class="mb-5">
                    <h5>{{ trans('lms/update.enable_upcoming_courses') }}</h5>
                    ...
                    <div class="form-group mt-3 custom-switches-stacked">
                        <label class="custom-switch pl-0">
                            ...
                            <span class="custom-switch-indicator"></span>
                            <label class="custom-switch-description mb-0 cursor-pointer" for="upcoming_courses_statusSwitch">{{ trans('lms/admin/main.active') }}</label>
                        </label>
                        <p class="font-12 text-gray mb-0">{{ trans('lms/update.upcoming_courses_status_hint') }}</p>
                    </div>

                </div>

                <button type="submit" class="btn btn-primary">{{ trans('lms/admin/main.save_change') }}</button>
            </form>
        </div>
    </div>
</div>
