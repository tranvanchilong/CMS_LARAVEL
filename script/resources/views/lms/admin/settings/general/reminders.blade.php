...
<div class="tab-pane mt-3 fade" id="reminders" role="tabpanel" aria-labelledby="reminders-tab">
    ...
    <form action="/lms{{ getAdminPanelUrl() }}/settings/reminders" method="post">
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                    <label class="input-label">{{ trans('lms/admin/main.webinar_reminder_schedule') }}</label>
                    ...
                    <p class="font-12 text-gray mt-1 mb-0">{{ trans('lms/update.webinar_reminder_hint') }}</p>
                </div>

                <div class="form-group">
                    <label class="input-label">{{ trans('lms/update.meeting_reminder_schedule') }}</label>
                    ...
                    <p class="font-12 text-gray mt-1 mb-0">{{ trans('lms/update.meeting_reminder_hint') }}</p>
                </div>

                <div class="form-group">
                    <label class="input-label">{{ trans('lms/update.subscribe_reminder_schedule') }}</label>
                    ...
                    <p class="font-12 text-gray mt-1 mb-0">{{ trans('lms/update.subscribe_reminder_hint') }}</p>
                </div>
            </div>
        </div>
