<div id="addOfflineBankForm"
     data-action="/lms{{ getAdminPanelUrl("/settings/financial/offline_banks/". (!empty($editBank) ? $editBank->id."/update" : 'store')) }}">
    ...
    <div class="d-flex justify-content-between align-items-center pb-2">
        ...
        <button type="button" class="js-add-specification btn btn-primary btn-sm ml-2">{{ trans('lms/update.add_specification') }}</button>
    </div>
                ...
                <div class="js-specification-card row align-items-center">
                    <div class="col-10">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label>{{ trans('lms/update.specification') }}</label>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label>{{ trans('lms/update.value') }}</label>
    ...
    <div class="d-flex align-items-center justify-content-end">
        <button type="button" class="js-save-bank btn btn-primary">{{ trans('lms/admin/main.save') }}</button>
        <button type="button" class="close-swl btn btn-danger ml-2">{{ trans('lms/admin/main.cancel') }}</button>
    </div>
</div>
