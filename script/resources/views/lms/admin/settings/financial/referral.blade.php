            ...
            <form action="/lms{{ getAdminPanelUrl() }}/settings/main" method="post">
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0 d-flex align-items-center">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer" for="referralStatusSwitch">{{ trans('lms/admin/main.active') }}</label>
                    </label>
                    <div class="text-muted text-small mt-1">{{ trans('lms/admin/main.multi_language_content_hint') }}</div>
                </div>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0 d-flex align-items-center">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="userReferralStatusSwitch">{{ trans('lms/admin/main.active_users_affiliate_when_registration') }}                       </label>
                    </label>
                    <div class="text-muted text-small mt-1">{{ trans('lms/admin/main.active_referral_new_users_hint') }}</div>
                </div>


                <div class="form-group">
                    <label>{{ trans('lms/admin/main.affiliate_user_commission') }}</label>
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('lms/admin/main.affiliate_user_commission_hint') }}</div>
                </div>

                <div class="form-group">
                    <label>{{ trans('lms/admin/main.store_affiliate_user_commission') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="fas fa-percentage"></i>
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('lms/admin/main.store_affiliate_user_commission_hint') }}</div>
                </div>

                <div class="form-group">
                    <label>{{ trans('lms/admin/main.affiliate_user_amount') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('lms/admin/main.affiliate_user_amount_hint') }}</div>
                </div>


                <div class="form-group">
                    <label>{{ trans('lms/admin/main.referred_user_amount') }}</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <i class="fas fa-dollar-sign"></i>
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('lms/admin/main.referred_user_amount_hint') }}</div>
                </div>

                <div class="form-group">
                    <label>{{ trans('lms/admin/main.referral_description') }}</label>
                    ...
                    <div class="text-muted text-small mt-1">{{ trans('lms/admin/main.referral_description_hint') }}</div>
                </div>
