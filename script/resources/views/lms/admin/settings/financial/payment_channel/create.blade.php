                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/lms{{ getAdminPanelUrl() }}/settings/payment_channels/{{ (!empty($paymentChannel) ? $paymentChannel->id.'/update':'store') }}" method="post">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label>{{trans('lms/update.class_dev')}}</label>
                                        ...
                                        @if(!empty($currencies) and count($currencies))
                                            <div class="form-group">
                                                <label class="input-label">{{ trans('lms/update.supported_currencies') }}</label>
                                ...
                                <button type="submit" class="btn btn-primary mt-4">{{ trans('lms/admin/main.save_change') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
