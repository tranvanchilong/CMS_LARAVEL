        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/lms{{ getAdminPanelUrl() }}/settings/site_bank_accounts" method="post">
                        {{ csrf_field() }}
                                    ...
                                    <div class="form-group d-flex align-items-start main-row">
                                        <div class="px-2 py-1 border flex-grow-1">
                                            ...
                                            <div class="form-group">
                                                <label>{{ trans('lms/admin/main.logo') }}</label>
                                            ...
                                            <div class="form-group">
                                                <label>{{ trans('lms/financial.card_id') }}</label>
                                            ...
                                            <div class="form-group">
                                                <label>{{ trans('lms/financial.account_id') }}</label>
                                            ...
                                            <div class="form-group">
                                                <label>{{ trans('lms/financial.iban') }}</label>
