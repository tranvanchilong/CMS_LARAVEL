...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('lms/admin/main.organizations_list') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/lms#">{{ trans('lms/admin/main.organizations_list') }}</a></div>
        ...
        <div class="row">
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('lms/admin/main.total_organizations') }}</h4>
                        </div>
                        <div class="card-body">
                            {{ $totalOrganizations }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('lms/admin/main.verified_organizations') }}</h4>
                        </div>
                        <div class="card-body">
    ...
    <div class="card">
        <div class="card-header">
            @if($authUser->can('admin_users_export_excel'))
                <a href="/lms{{ getAdminPanelUrl() }}/organizations/excel?{{ http_build_query(request()->all()) }}" class="btn btn-primary">{{ trans('lms/admin/main.export_xls') }}</a>
            @endif
            <div class="h-10"></div>
        </div>
            ...
            <div class="table-responsive text-center">
                <table class="table table-striped font-14">
                    <tr>
                        ...
                        <th>{{ trans('lms/admin/main.instructors') }}</th>
                        <th>{{ trans('lms/admin/main.students') }}</th>
    ...
    <section class="card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{trans('lms/admin/main.organizations_hint_title_1')}}</div>
                        <div class=" text-small font-600-bold">{{trans('lms/admin/main.organizations_hint_description_1')}}</div>
                    </div>
                </div>

                <div class="col-md-4">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{trans('lms/admin/main.organizations_hint_title_2')}}</div>
                        <div class=" text-small font-600-bold">{{trans('lms/admin/main.organizations_hint_description_2')}}</div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="media-body">
                        <div class="text-primary mt-0 mb-1 font-weight-bold">{{trans('lms/admin/main.organizations_hint_title_3')}}</div>
                        <div class="text-small font-600-bold">{{trans('lms/admin/main.organizations_hint_description_3')}}</div>
                    </div>
                </div>
