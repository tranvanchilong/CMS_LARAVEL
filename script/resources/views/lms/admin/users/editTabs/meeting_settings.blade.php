...
<div class="tab-pane mt-3 fade" id="meetingSettings" role="tabpanel" aria-labelledby="meetingSettings-tab">
    <div class="row">
        <div class="col-12">
            <form action="/lms{{ getAdminPanelUrl() }}/users/{{ $user->id }}/meetingSettings" method="Post">
                {{ csrf_field() }}
                        ...
                        <div class="form-group mb-30 mt-30">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="custom-control mr-2 custom-radio">
                                    ...
                                    <label class="custom-control-label cursor-pointer" for="man">{{ trans('lms/update.man') }}</label>
                                </div>
                                ...
                                <div class="custom-control mr-2 custom-radio ml-15">
                                    ...
                                    <label class="custom-control-label cursor-pointer" for="woman">{{ trans('lms/update.woman') }}</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-30">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="custom-control mr-2 custom-radio">
                                    ...
                                    <label class="custom-control-label cursor-pointer" for="in_person">{{ trans('lms/update.in_person') }}</label>
                                </div>
                                ...
                                <div class="custom-control mr-2 custom-radio ml-10">
                                    ...
                                    <label class="custom-control-label cursor-pointer" for="online">{{ trans('lms/update.online') }}</label>
                                </div>
                                ...
                                <div class="custom-control mr-2 custom-radio ml-10">
                                    ...
                                    <label class="custom-control-label cursor-pointer" for="all">{{ trans('lms/public.all') }}</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-30">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="custom-control mr-2 custom-checkbox">
                                    ...
                                    <label class="custom-control-label cursor-pointer" for="beginner">{{ trans('lms/update.beginner') }}</label>
                                </div>
                                ...
                                <div class="custom-control mr-2 custom-checkbox ml-10">
                                    ...
                                    <label class="custom-control-label cursor-pointer" for="middle">{{ trans('lms/update.middle') }}</label>
                                </div>
                                ...
                                <div class="custom-control mr-2 custom-checkbox ml-10">
                                    ...
                                    <label class="custom-control-label cursor-pointer" for="expert">{{ trans('lms/update.expert') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
