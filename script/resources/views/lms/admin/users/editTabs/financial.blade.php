<div class="tab-pane mt-3 fade" id="financial" role="tabpanel" aria-labelledby="financial-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/lms{{ getAdminPanelUrl() }}/users/{{ $user->id .'/financialUpdate' }}" method="Post">
                {{ csrf_field() }}

                <div class="form-group">
                    <label>{{ trans('lms/financial.account_type') }}</label>
                ...
                <div class="form-group mt-15">
                    <label class="input-label">{{ trans('lms/financial.identity_scan') }}</label>
                ...
                <div class="form-group">
                    <label>{{ trans('lms/financial.address') }}</label>
                    <input type="text" name="address"
                           class="form-control "
                           value="{{ !empty($user) ? $user->address : old('address') }}"
                           placeholder="{{ trans('lms/financial.address') }}"/>
                </div>

                @if(!$user->isUser())
                    <div class="form-group">
                        <label>{{ trans('lms/admin/main.user_commission') }} (%)</label>
                        <input type="text" name="commission"
                               class="form-control "
                               value="{{ !empty($user) ? $user->commission : old('commission') }}"
                               placeholder="{{ trans('lms/admin/main.user_commission_placeholder') }}"/>
                    </div>
                @endif
                ...
                <div class="form-group mb-0 d-flex align-items-center">
                    ...
                    <label for="verifySwitch">{{ trans('lms/admin/main.financial_approval') }}</label>
                </div>
                ...
                <div class="form-group mb-0 d-flex align-items-center">
                    ...
                    <label for="enableInstallmentsSwitch">{{ trans('lms/update.enable_installments') }}</label>
                </div>
                ...
                <div class="form-group mb-0 d-flex align-items-center">
                    ...
                    <label for="installmentApprovalSwitch">{{ trans('lms/update.installment_approval') }}</label>
                </div>
                ...
                <div class="form-group mb-0 d-flex align-items-center">
                    ...
                    <label for="disableCashbackSwitch">{{ trans('lms/update.disable_cashback') }}</label>
                </div>
                ...
                <div class="form-group mb-0 d-flex align-items-center">
                    ...
                    <label for="enable_registration_bonusSwitch">{{ trans('lms/update.enable_registration_bonus') }}</label>
                </div>
                ...
                <div class="js-registration-bonus-field form-group {{ $user->enable_registration_bonus ? '' : 'd-none' }}">
                    ...
                    <input type="text" name="registration_bonus_amount"
                           ...
                           placeholder="{{ trans('lms/update.user_registration_bonus_amount_placeholder') }}"/>
                </div>
