<div class="tab-pane mt-3 fade @if(empty($becomeInstructor)) active show @endif" id="general" role="tabpanel" aria-labelledby="general-tab">
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="/lms{{ getAdminPanelUrl() }}/users/{{ $user->id .'/update' }}" method="Post">
                {{ csrf_field() }}

                <div class="form-group">
                    <label>{{ trans('lms//admin/main.full_name') }}</label>
                    <input type="text" name="full_name"
                           class="form-control  @error('full_name') is-invalid @enderror"
                           value="{{ !empty($user) ? $user->full_name : old('full_name') }}"
                           placeholder="{{ trans('lms/admin/main.create_field_full_name_placeholder') }}"/>
                    @error('full_name')
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('role_id') is-invalid @enderror" id="roleId" name="role_id">
                        <option disabled {{ empty($user) ? 'selected' : '' }}>{{ trans('lms/admin/main.select_role') }}</option>
                ...
                @if(!empty($currencies) and count($currencies))
                    ...
                    <div class="form-group">
                        <label class="input-label">{{ trans('lms/update.currency') }}</label>
                ...
                @if($user->isUser() || $user->isTeacher())
                    <div class="form-group">
                        ...
                        <select name="organ_id" data-search-option="just_organization_role" class="form-control search-user-select2"
                                data-placeholder="{{ trans('lms/admin/main.search') }} {{ trans('lms/admin/main.organization') }}">
                ...
                <div class="form-group">
                    <label for="username">{{ trans('lms/admin/main.email') }}:</label>
                ...
                <div class="form-group">
                    <label for="username">{{ trans('lms/admin/main.mobile') }}:</label>
                ...
                <div class="form-group">
                    <label>{{ trans('lms/admin/main.password') }}</label>
                ...
                <div class="form-group">
                    <label>{{ trans('lms/admin/main.bio') }}</label>
                ...
                <div class="form-group">
                    <label>{{ trans('lms/site.about') }}</label>
                ...
                <div class="form-group">
                    <label>{{ trans('lms/update.certificate_additional') }}</label>
                ...
                <div class="form-group">
                    <label>{{ trans('lms//admin/main.status') }}</label>
                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                        <option disabled {{ empty($user) ? 'selected' : '' }}>{{ trans('lms/admin/main.select_status') }}</option>

                        @foreach (\App\Models\LMS\User::$statuses as $status)
                ...
                <div class="form-group">
                    ...
                    <select name="language" class="form-control">
                        <option value="">{{ trans('lms/auth.language') }}</option>
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer" for="banSwitch">{{ trans('lms/admin/main.ban') }}</label>
                    </label>
                </div>
                ...
                <div class="form-group custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="verified">{{ trans('lms/admin/main.enable_blue_badge') }}</label>
                    </label>
                </div>
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="affiliateSwitch">{{ trans('lms/panel.affiliate') }}</label>
                    </label>
                </div>
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="canCreateStoreSwitch">{{ trans('lms/update.store') }}</label>
                    </label>
                    <div class="text-muted text-small">{{ trans('lms/update.admin_user_edit_can_create_store_hint') }}</div>
                </div>
                ...
                <div class="form-group custom-switches-stacked mt-2">
                    <label class="custom-switch pl-0">
                        ...
                        <span class="custom-switch-indicator"></span>
                        <label class="custom-switch-description mb-0 cursor-pointer" for="contentAccessLimitationSwitch">{{ trans('lms/update.content_access_limitation') }}</label>
                    </label>
                    <div class="text-muted text-small">{{ trans('lms/update.admin_user_edit_content_access_limitation_hint') }}</div>
                </div>
