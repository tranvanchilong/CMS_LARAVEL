                                ...
                                <div class="col-12 col-md-6">
                                    <form action="/lms{{ getAdminPanelUrl() }}/enrollments/store" method="Post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="user_id" class="form-control search-user-select2" data-placeholder="{{ trans('lms/public.search_user') }}">
                                        ...
                                        <div class=" mt-4">
                                            <button type="submit" class="btn btn-primary">{{ trans('lms/admin/main.add') }}</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
