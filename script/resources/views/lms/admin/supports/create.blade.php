...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('lms/admin/main.new_ticket') }}</h1>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    <form action="/lms{{ getAdminPanelUrl() }}/supports/{{ !empty($support) ? $support->id.'/update' : 'store' }}" method="Post">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            <label>{{ trans('lms/admin/main.department') }}</label>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12 col-md-4 mt-2 mt-md-0">
                                                <button class="btn btn-primary w-100">{{ trans('lms/admin/main.send') }}</button>
                                            </div>
                                        </div>
