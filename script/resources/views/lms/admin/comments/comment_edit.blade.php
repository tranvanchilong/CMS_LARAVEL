...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('lms/admin/main.edit_comment') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="/lms{{ getAdminPanelUrl() }}">{{trans('lms/admin/main.dashboard')}}</a>
                </div>
                <div class="breadcrumb-item">{{ trans('lms/admin/main.edit_comment') }}</div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <form action="/lms{{ getAdminPanelUrl() }}/comments/{{$page}}/{{ $comment->id }}/update" method="post">
                                {{ csrf_field() }}

                                <div class="form-group mt-15">
                                    <label class="input-label">{{ trans('lms/admin/main.edit_comment') }}</label>
