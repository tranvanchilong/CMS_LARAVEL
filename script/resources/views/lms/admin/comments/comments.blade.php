    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">{{ trans('lms/admin/main.comments') }}</div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('lms/admin/main.total_comments') }}</h4>
                        </div>
                        <div class="card-body">
                            {{ $totalComments }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('lms/admin/main.published_comments') }}</h4>
                        </div>
                        <div class="card-body">
                            {{ $publishedComments }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('lms/admin/main.pending_comments') }}</h4>
                        </div>
                        <div class="card-body">
                            {{ $pendingComments }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('lms/admin/main.comments_reports') }}</h4>
                        </div>
                        <div class="card-body">
                            {{ $commentReports }}
                        </div>
                    ...
                    <form method="get" class="mb-0">
                        ...
                        <div class="row">
                            ...
                            @elseif($page == 'blog')
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="input-label">{{ trans('lms/admin/main.blog') }}</label>
                            ...
                            @elseif($page == 'products')
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="input-label">{{ trans('lms/update.products') }}</label>
                                ...
                                <table class="table table-striped font-14">
                                    ...
                                    @foreach($comments as $comment)
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <a href="/lms{{ $comment->user->getProfileUrl() }}" target="_blank" class="">{{ $comment->user->full_name }}</a>
                                            </td>

                                            <td class="text-left">
                                                <a href="/lms{{ $comment->$itemRelation->getUrl() }}" target="_blank">
                                            ...
                                            <td width="150px" class="text-center">
                                                ...
                                                @if($authUser->can('admin_comments_status'))
                                                    <a href="/lms{{ getAdminPanelUrl() }}/comments/{{ $page }}/{{ $comment->id }}/toggle" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/admin/main.'.(($comment->status == 'pending') ? 'publish' : 'pending')) }}">
                                                ...
                                                @if($authUser->can('admin_comments_reply'))
                                                    <a href="/lms{{ getAdminPanelUrl() }}/comments/{{ $page }}/{{ !empty($comment->reply_id) ? $comment->reply_id : $comment->id }}/reply" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/admin/main.reply') }}">
                                                        <i class="fa fa-reply"></i>
                                                    </a>
                                                @endif

                                                @if($authUser->can('admin_comments_edit'))
                                                    <a href="/lms{{ getAdminPanelUrl() }}/comments/{{ $page }}/{{ $comment->id }}/edit" class="btn-transparent text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('lms/admin/main.edit') }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endif

                                                @if($authUser->can('admin_comments_delete'))
                                                    @include('lms.admin.includes.delete_button',['url' => '/lms'.getAdminPanelUrl().'/comments/'. $page .'/'.$comment->id.'/delete','btnClass' => ''])
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
