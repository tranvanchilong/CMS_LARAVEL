...
<header class="header--style-1">
   ...
   <!--====== Nav 1 ======-->
   <nav class="primary-nav-wrapper--border">
       <div class="container">
                        ...
                        @if(env('MULTILEVEL_CUSTOMER_REGISTER') == true)  
                           <li class="has-dropdown" data-tooltip="tooltip" data-placement="left" title="Account">
                               ...
                               <ul class="w-120">
                                 ...
                                 <form action="{{ url('/user/logout') }}" method="POST" class="d-none" id="logout-form">
                                    @csrf
                                  </form>
                                 @else
                                 <li>
       ...
       <div class="container">
           ...
           <div class="secondary-nav">
            ...
            <div class="menu-init" id="navigation1">
               <button class="btn btn--icon toggle-mega-text toggle-button" type="button"><i class="fa fa-bars"></i></button>
               <!--====== Menu ======-->
               <div class="ah-lg-mode">
                  ...
                  <ul class="ah-list">
                     <li class="has-dropdown">
                        <span class="mega-text"><i class="fa fa-bars"></i></span>
                        <!--====== Mega Menu ======-->
                        <span class="js-menu-toggle"></span>
                        <div class="mega-menu">
