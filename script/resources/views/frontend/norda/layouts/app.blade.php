...
<html class="no-js" lang="{{ App::getlocale() }}" >
    <head>
        ...
        <style type="text/css">
            :root {
                --main-theme-color: {{ Cache::get(domain_info('user_id').'theme_color') ?? '#3b97b7' }};
                --main-title-color: {{ Cache::get(domain_info('user_id').'title_color') ?? '#343F52' }};
                --main-text-color: {{ Cache::get(domain_info('user_id').'text_color') ?? '#60697B' }};
                --main-font: {{ Cache::get(domain_info('user_id').'font') ?? 'Manrope' }};
                ...
                --main-menu-size: {{ Cache::get(domain_info('user_id').'menu_size') ?? '16' }}px;
                --main-title-size: {{ Cache::get(domain_info('user_id').'title_size') ?? '30' }}px;
                --main-subtitle-size: {{ Cache::get(domain_info('user_id').'subtitle_size') ?? '22' }}px;
                --main-text-size: {{ Cache::get(domain_info('user_id').'text_size') ?? '16'}}px;
                --main-hero-title-size: {{ Cache::get(domain_info('user_id').'hero_title_size') ?? '34' }}px;
                --main-hero-subtitle-size: {{ Cache::get(domain_info('user_id').'hero_subtitle_size') ?? '26' }}px;
            }
        </style>
...
{{-- end load --}}
@if($status_contact->float_contact_status==1)
...
<script src="{{asset('frontend/norda/js/toc.js')}}"></script>
<script src="{{asset('frontend/norda/js/jquery.toc.js')}}"></script>
