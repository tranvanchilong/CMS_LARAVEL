      ...
      <div class="row">
        <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
          ...
          <div class="card card-primary">
            ...
            <form class="basicform"  method="post" action="{{ route('merchant.register-make') }}">
              @csrf
...
{{-- <input type="hidden" id="location_url" value="{{ url('/merchant/make-payment') }}"> --}}
<!-- General JS Scripts -->
  ...
  $(".basicform").on('submit', function(e){
    ...
    $.ajax({
      ...
      beforeSend: function() {
        ...
        $('.basicbtn').html("Creating website please wait....");
