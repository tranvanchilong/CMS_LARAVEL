...
<head>
  ...
  <title>{{ json_decode(\App\Option::where('key','seo')->first()->value)->title ?? config('app.name', 'Laravel')}}</title>
  <!-- General CSS Files -->
    ...
    <div class="main-wrapper">
     ...
     <footer class="main-footer">
      <div class="footer-left">
        Copyright &copy; {{ date('Y') }} <div class="bullet"></div> Powered By <a href="{{ url('/') }}">{{ \App\Useroption::where('user_id', Auth::user()->id)->where('key','shop_name')->first()->value ?? env('APP_NAME')}}</a>
      </div>
