    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <span class="text-white">{{ __('Get in Touch') }}</span>
        </div>
      </div>
    </div>
  </div>
                            ...
                            <div class="col-lg-12">
                                <div class="blog-item @if(!$loop->last) mb-40 @endif">
                                    <div class="entry-content pr-4">
                                        <div class="entry-meta">
                                            <ul>
                                                <li><span><i class="icofont-stylish-right"></i><a
                                                            href="">{{$blog->bcategory->name}}</a></span></li>
                                                <li>
                                                <span>
                                        ...
                                        <a href="{{route('blog-detail',$blog->slug)}}" class="read-btn">{{__('Read More')}}</a>
                                    </div>
                                    <a class="post-img d-block" href="{{route('blog-detail',$blog->slug)}}">
                                        <img src="{{ asset($blog->image ?? 'uploads/default.png') }}" style="width: 100%;max-height: 100%;object-fit: contain;" class="img-fluid lazy"
                                             alt="">
                                    </a>
                                </div>
                            </div>
