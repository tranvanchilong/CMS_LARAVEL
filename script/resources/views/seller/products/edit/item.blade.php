						...
						<div class="col-sm-9">
							...
							<div class="form-group">
								...
								<select class="form-control" name="featured">
									...
									<option value="3" @if($info->featured==3) selected="" @endif>{{ __('Top rate products') }}</option>									
								</select>
							</div>
							...
							<!-- <div class="form-group">
								...
								<select class="form-control" name="price_status">
									<option value="0" @if($info->price_status==0) selected="" @endif>{{ __('Single Product') }}</option>
									<option value="1" @if($info->price_status==1) selected="" @endif>{{ __('Variant Product') }}</option>
								</select>
							</div> -->
