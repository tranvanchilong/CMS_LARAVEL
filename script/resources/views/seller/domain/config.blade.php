...
@endpush
@section('head')
@include('layouts.partials.headersection',['title'=>__('Domain Settings')])
@endsection
@section('content')
<div class="row">
    <div class="col-12">
        ...
        <div class="modal-content">
            <form method="POST" class="basicform_with_reload"  action="{{ route('seller.customdomain.store') }}">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary basicbtn" ><span class="ladda-label">{{ __('Save') }}</span><span class="ladda-spinner"></span></button>
                </div>
            </form>
        </div>
    </div>
