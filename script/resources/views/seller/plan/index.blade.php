@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>__('Plans')])
@endsection
@section('content')
			...
			<div class="pricing-padding">
				...
				<div class="pricing-details">
				    <div class="pricing-item">
                        @if($row->is_trial == '1')
                          <div class="pricing-item-label">{{ __('Trial Expiry Date') }} {{ $row->trial_expiry_date }} Day</div>
                        @endif
                     </div>
					<div class="pricing-item">
...
<div class="d-flex justify-content-center align-items-center">
	<a class="text-center m-3" href="https://my.di4l.vn/subscription" target="_blank"><button class="btn btn-primary ">{{__('Subscription package')}}</button></a>
</div>
