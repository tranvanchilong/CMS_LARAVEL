				...
				<form method="post" class="basicform" action="{{ route('seller.payment.update',$info->active_getway->id) }}">
					...
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input class="form-control" required="" value="{{ $data->accessKey }}" name="accessKey" required="" type="text">
						</div>

						<div class="form-group">
							<label>MoMo SecretKey</label>
							<input class="form-control" required="" value="{{ $data->secretKey }}" name="secretKey" required="" type="text">
						</div>

						<div class="form-group">
							<label>MoMo PartnerCode</label>
							<input class="form-control" required="" value="{{ $data->partnerCode }}" name="partnerCode" required="" type="text">
						</div>
						<div class="form-group">
