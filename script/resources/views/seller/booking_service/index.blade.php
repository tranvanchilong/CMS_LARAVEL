@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>__('Booking Services')])
@endsection
@section('content')
<div class="card">
    <div class="card-body">
        ...
        <div class="card-action-filter">
            <form method="post" class="basicform_with_reload" action="{{ route('seller.booking-service.destroys') }}">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                        <div class="d-flex">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>@if($service->category_id !== null){{ $service->categories->name }} @else {{ __('') }} @endif</td>
                        <td>
                            <a class="btn btn-primary btn-sm editbtn" href="{{route('seller.booking-service.edit', $service->id)}}">
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <form id="ajaxFormLoad" class="modal-form" action="{{route('seller.booking-service.store')}}" method="post" enctype="multipart/form-data">
                @csrf
