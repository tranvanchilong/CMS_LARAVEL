@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>'Banner Brand'])
@endsection
@section('content')
		...
		<div class="table-responsive custom-table">
			<table class="table">
				...
				<tbody>
					...
					<tr>
						<td class="text-left"><img src="{{ asset($row->name) }}" style="height: 100%;object-fit: contain;max-width: 100px;"></td>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">{{ __('Add New Banner Brand') }}</h5>
