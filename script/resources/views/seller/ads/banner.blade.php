			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-left">
						    {{$row->type == 'banner_ads' ? 'Banner Ads 1' : ''}}
						    {{$row->type == 'banner_ads_2' ? 'Banner Ads 2' : ''}}
						    {{$row->type == 'banner_ads_3' ? 'Banner Ads 3' : ''}}
						</td>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel">{{ __('Add New Banner Ads') }}</h5>
			...
			<div class="modal-body">
				<form method="post" action="{{ route('seller.ads.store') }}" class="basicform_with_reload">
					...
					<div class="form-group">
						<label>{{ __('Type')}} 1</label>
						<select class="form-control" name="type">
						    <option value="banner_ads">Banner Ads 1</option>
						    <option value="banner_ads_2">Banner Ads 2</option>
						    <option value="banner_ads_3">Banner Ads 3</option>
						</select>
					</div>
					<div class="form-group">
