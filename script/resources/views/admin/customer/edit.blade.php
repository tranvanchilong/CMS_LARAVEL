    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group row mb-4">
          ...
          <div class="col-sm-12 col-md-7 custom-control custom-switch" style="padding-left:52px;">
            <input class="custom-control-input" @if($info->test_account==1) checked="" @endif type="checkbox" name="test_account" id="test_account" value="1">
            <label  class="custom-control-label" for="test_account">{{ __('Test Account') }}</label> 
          </div>
        </div>
