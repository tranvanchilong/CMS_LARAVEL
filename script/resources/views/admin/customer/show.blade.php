						...
						<div class="card-body">
							...
							<div class="row">
								<div class="form-group col-12">
									...
									<input class="form-control" required="" type="textarea" name="content" id="content">
								</div>
							</div>
							<button class="btn btn-primary basicbtn" id="send-mail" type="submit">{{ __('Send') }}</button>
						</div>
...
<script>
    var sendMail = CKEDITOR.replace( 'content' );
    $( "#send-mail" ).click(function() {
      document.getElementById('content').value = sendMail.getData();
    });
</script>
@endpush