...
<form method="post"  action="{{ route('admin.appearance.update',$type) }}" class="basicform">
	...
	<div class="form-group">
		...
		<textarea class="form-control" name="additional_css">{{ $additional_css ?? '' }}</textarea>
	</div>
	<div class="form-group">
		<label>{{ __('Additional JS') }}</label>
		<textarea class="form-control" name="additional_js">{{ $additional_js ?? '' }}</textarea>
	</div>
	<div class="form-group">
		<label>{{ __('Add Livechat js for support') }}</label>
		<textarea class="form-control" name="support_js">{{ $support ?? '' }}</textarea>
	</div>
