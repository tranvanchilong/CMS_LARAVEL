@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=>'Blog Categories'])
@endsection
@section('content')
<div class="row">
    ...
    <div class="card">
      <div class="card-body">
        ...
        @endphp
          ...
          <form method="post" action="{{ route('admin.bcategories.destroys') }}" class="basicform_with_reload">
            @csrf
            <div class="float-left mb-1">
              ...
              <a href="{{ route('admin.bcategory.create') }}" class="btn btn-primary">{{ __('Create Blog Category') }}</a>
            ...
            <table class="table table-striped table-hover text-center table-borderless">
              ...
              <tbody>
                ...
                <tr id="row{{ $row->id }}">
                  ...
                  <td>
                    <a href="{{ route('admin.bcategory.edit',$row->id) }}" class="btn btn-primary btn-sm text-center"><i class="far fa-edit"></i></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
