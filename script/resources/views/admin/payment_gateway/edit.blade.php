          ...
          <div class="row">
            <div class="col-sm-8">
             ...
             <div class="form-group">
               ...
               <input type="text" name="vnpTmnCode" class="form-control" required value="{{ $credentials->vnpTmnCode ?? '' }}"> 
             </div>

             <div class="form-group">
               <label>VNPay HashSecret</label>
               <input type="text" name="vnpHashSecret" class="form-control" required value="{{ $credentials->vnpHashSecret ?? '' }}"> 
             </div>

             @endif
             @if($info->slug=='momo')
             <div class="form-group">
               <label>MoMo AccessKey</label>
               <input type="text" name="accessKey" class="form-control" required value="{{ $credentials->accessKey ?? '' }}"> 
             </div>

             <div class="form-group">
               <label>MoMo SecretKey</label>
               <input type="text" name="secretKey" class="form-control" required value="{{ $credentials->secretKey ?? '' }}"> 
             </div>
             
             <div class="form-group">
               <label>MoMo PartnerCode</label>
               <input type="text" name="partnerCode" class="form-control" required value="{{ $credentials->partnerCode ?? '' }}"> 
             </div>
