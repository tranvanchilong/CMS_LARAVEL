				...
				<form method="post" action="{{ route('admin.plan.update',$info->id) }}" class="basicform">
					...
					<div class="row">
						<div class="col-sm-8">
							...
							<div class="form-group">
								<label>{{ __('Trial Expiry Date') }}</label>
								<input type="number" value="{{ $info->trial_expiry_date }}"  name="trial_expiry_date" class="form-control" required> 
							</div>
							<div class="form-group">
								<label>{{ __('Serial Number') }}</label>
								<input type="number" value="{{ $info->serial_number }}"  name="serial_number" class="form-control" required> 
							</div>
						...
						<div class="col-sm-4">
							...
							<div class="form-group">
								...
								<select class="form-control" name="days">
									...
									<option value="9999"@if($info->days==9999) selected="" @endif>{{ __('Lifetime') }}</option>
								</select>
							</div>
