            ...
            <table class="table table-striped table-hover text-center table-borderless">
              ...
              <tbody>
                ...
                <tr id="row{{ $row->id }}">
                  ...
                  <td>{{ $row->name  }}</td>
                  <td>{{ $row->price  }}</td>
                  <td>@if($row->days == 365) {{__('Yearly')}} @elseif($row->days == 30) {{__('Monthly')}} @elseif($row->days == 9999) {{__('Lifetime')}}  @else {{ $row->days }}  Days @endif</td>
